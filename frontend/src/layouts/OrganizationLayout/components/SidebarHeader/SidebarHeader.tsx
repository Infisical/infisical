...
export const SidebarHeader = () => {
  ...
  return (
    <div className="flex w-full items-center justify-center rounded-md border border-border-control p-1 transition-all duration-150 hover:bg-surface-hover">
      <div className="mr-2 flex h-8 w-8 items-center justify-center rounded-md bg-project">
        {currentOrg?.name.charAt(0)}
      </div>
      <div className="flex grow flex-col text-foreground-inverse">
