...
export const eventToNameMap: { [K in EventType]: string } = {
  ...
  [EventType.CMEK_IMPORT_KEY_MATERIAL_TOKEN_CREATED]: "Generate KMS key import parameters",
  [EventType.CMEK_KEY_MATERIAL_IMPORTED]: "Import KMS key material",
  ...
  [EventType.CMEK_LIST_KEY_VERSIONS]: "List KMS key versions",
