...
export const eventToNameMap: { [K in EventType]: string } = {
  ...
  [EventType.VIEW_INSIGHTS_SECRETS_MANAGEMENT_ORG_ACCESS_VOLUME]:
    "View Organization Secrets Management Access Volume Insights",
  ...
  [EventType.VIEW_INSIGHTS_SECRETS_MANAGEMENT_STATIC_SECRET_USAGE]:
    "View Organization Static Secret Usage Insights",
  ...
  [EventType.VIEW_INSIGHTS_SECRETS_MANAGEMENT_ORG_COUNTS]:
    "View Organization Secrets Management Resource Counts Insights",
  ...
  [EventType.PAM_FOLDER_MEMBER_ADD]: "Add PAM Folder Member",
  [EventType.PAM_FOLDER_MEMBER_UPDATE]: "Update PAM Folder Member",
  [EventType.PAM_FOLDER_MEMBER_REMOVE]: "Remove PAM Folder Member",
  [EventType.PAM_ACCOUNT_MEMBER_ADD]: "Add PAM Account Member",
  [EventType.PAM_ACCOUNT_MEMBER_UPDATE]: "Update PAM Account Member",
  [EventType.PAM_ACCOUNT_MEMBER_REMOVE]: "Remove PAM Account Member",
  ...
  [EventType.SIGN_AGENT_PROXY_INTERMEDIATE_CA]: "Sign Agent Proxy Intermediate CA",
...
export const projectToEventsMap: Partial<Record<ProjectType, EventType[]>> = {
  [ProjectType.PAM]: [
    ...
    EventType.PAM_FOLDER_MEMBER_ADD,
    EventType.PAM_FOLDER_MEMBER_UPDATE,
    EventType.PAM_FOLDER_MEMBER_REMOVE,
    EventType.PAM_ACCOUNT_MEMBER_ADD,
    EventType.PAM_ACCOUNT_MEMBER_UPDATE,
    EventType.PAM_ACCOUNT_MEMBER_REMOVE,
