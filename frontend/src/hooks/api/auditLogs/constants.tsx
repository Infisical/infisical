...
export const eventToNameMap: { [K in EventType]: string } = {
  ...
  [EventType.AGENT_VAULT_PRODUCT_MEMBER_ADD]: "Add member",
  [EventType.AGENT_VAULT_PRODUCT_MEMBER_UPDATE]: "Change member role",
  [EventType.AGENT_VAULT_PRODUCT_MEMBER_REMOVE]: "Remove member",
...
export const projectToEventsMap: Partial<Record<ProjectType, EventType[]>> = {
  ...
  [ProjectType.AgentVault]: [
    ...
    EventType.AGENT_VAULT_PRODUCT_MEMBER_ADD,
    EventType.AGENT_VAULT_PRODUCT_MEMBER_UPDATE,
    EventType.AGENT_VAULT_PRODUCT_MEMBER_REMOVE,
