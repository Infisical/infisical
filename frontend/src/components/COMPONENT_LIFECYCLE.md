...
| `FontAwesomeSymbol`, `HighlightText`, `Slider`                                                                                         | Retained                      | No supported V3 primitive replaces the distinct capability. `HighlightText` re-exports the shared utility.    |
