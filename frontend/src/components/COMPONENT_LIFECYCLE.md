...
| `Accordion`, `Alert`, `Blur`, `Breadcrumb`, `CopyButton`, `Dropdown`, `HoverCardv2`, `Skeleton`, `Spinner`, `Stepper`, `Table`, `Tabs` | Blocked                       | Composition, interaction, or state parity still needs verification.                                           |
...
| `ContentLoader`, `Divider`, `FormControl`, `GenericFieldLabel`, `Tag`                                                                  | Blocked                       | The V3 replacements require consumer-specific composition or accessibility changes.                           |
| `PageHeader`                                                                                                                           | Ready for focused deprecation | Parity verified (ENG-5637): the V3 replacement accepts the same props, renders a semantic `header`, and hides the decorative icon from assistive tech, so consumers migrate with an import swap. |
