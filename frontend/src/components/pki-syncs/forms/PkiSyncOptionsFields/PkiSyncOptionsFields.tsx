    ...
    <>
      {syncOption?.canRemoveCertificates && (
        <SyncSwitchField
          ...
          description={
            <>
              When enabled, Infisical deletes a certificate from the destination once it leaves this
              sync, whether it stopped being active, was deleted, was unlinked, or stopped matching
              the sync&apos;s filters. Disable this if you manage some certificates manually outside
              of Infisical.
