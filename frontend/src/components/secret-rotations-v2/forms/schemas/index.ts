...
import { DatabricksServiceAccountSecretRotationSchema } from "@app/components/secret-rotations-v2/forms/schemas/databricks-service-account-secret-rotation-schema";
