...
export const DatabricksServiceAccountSecretRotationParametersFields = () => {
    ...
    <Controller
      ...
      render={({ field: { value, onChange, onBlur }, fieldState: { error } }) => (
        <Field data-invalid={Boolean(error)}>
          <FieldLabelWithTooltip htmlFor="databricks-service-account-principal">
            Service Principal
          ...
          <FilterableSelect
            ...
            aria-describedby="databricks-service-account-principal-feedback"
          />
          <FieldFeedback
            id="databricks-service-account-principal-feedback"
            description={
              <Tooltip>
                ...
                <TooltipContent className="max-w-md">
                  Ensure that your connection has the necessary permissions to list and manage service
                  principals in your Databricks workspace.
                </TooltipContent>
              </Tooltip>
            }
            error={error?.message}
