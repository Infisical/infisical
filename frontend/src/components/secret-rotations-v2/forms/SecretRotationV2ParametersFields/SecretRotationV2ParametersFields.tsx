...
import { DatabricksServiceAccountSecretRotationParametersFields } from "./DatabricksServiceAccountSecretRotationParametersFields";
...
const COMPONENT_MAP: Record<SecretRotation, React.FC> = {
  ...
  [SecretRotation.DatabricksServiceAccountSecret]:
    DatabricksServiceAccountSecretRotationParametersFields
};
