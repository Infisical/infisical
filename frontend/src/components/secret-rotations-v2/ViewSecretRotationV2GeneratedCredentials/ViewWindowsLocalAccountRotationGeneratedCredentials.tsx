import { TWindowsLocalAccountRotationGeneratedCredentialsResponse } from "@app/hooks/api/secretRotationsV2/types/windows-local-account-rotation";

import { CredentialDisplay, ViewRotationGeneratedCredentialsDisplay } from "./shared";

type Props = {
  generatedCredentialsResponse: TWindowsLocalAccountRotationGeneratedCredentialsResponse;
};

export const ViewWindowsLocalAccountRotationGeneratedCredentials = ({
