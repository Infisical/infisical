import { THpIloRotationGeneratedCredentialsResponse } from "@app/hooks/api/secretRotationsV2/types/hp-ilo-rotation";

import { CredentialDisplay, ViewRotationGeneratedCredentialsDisplay } from "./shared";

type Props = {
  generatedCredentialsResponse: THpIloRotationGeneratedCredentialsResponse;
};

export const ViewHpIloRotationGeneratedCredentials = ({
