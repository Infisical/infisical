        ...
        {Array.from({ length: fields }, (_, index) => {
          ...
          return (
            <div
              aria-hidden
              className={cn(
                "relative flex h-[68px] min-w-0 items-center justify-center rounded-md border border-border bg-container font-mono text-xl text-foreground outline outline-1 outline-offset-4 outline-transparent transition-colors max-sm:aspect-square max-sm:h-auto",
