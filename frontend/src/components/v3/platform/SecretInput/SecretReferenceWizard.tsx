      ...
      switch (state.step) {
        ...
        case "env":
          if (filteredEnvs[highlightedIndex])
            handleSelectEnv(
              filteredEnvs[highlightedIndex].slug,
              filteredEnvs[highlightedIndex].name
            );
          break;
        case "browse": {
          ...
          {state.selectedProjectFolderGrant && (
            ...
            >
              ...
              <span className="truncate">
                {state.selectedProjectFolderGrant.sourceProjectName}
              </span>
            </button>
          )}
          <div className="px-2 py-1.5 text-[10px] font-semibold tracking-wider text-muted uppercase">
