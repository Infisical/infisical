...
const switchThumbVariants = cva(
  ...
  ),
  {
    variants: {
      variant: {
        outline:
          "data-[state=checked]:border-foreground/15 data-[state=checked]:bg-foreground/35 data-[state=checked]:group-hover/switch:bg-foreground/45",
        neutral:
          "data-[state=checked]:border-neutral/15 data-[state=checked]:bg-neutral/35 data-[state=checked]:group-hover/switch:bg-neutral/45",
        project:
          "data-[state=checked]:border-project/15 data-[state=checked]:bg-project/35 data-[state=checked]:group-hover/switch:bg-project/45",
        org: "data-[state=checked]:border-org/15 data-[state=checked]:bg-org/35 data-[state=checked]:group-hover/switch:bg-org/45",
        "sub-org":
          "data-[state=checked]:border-sub-org/15 data-[state=checked]:bg-sub-org/35 data-[state=checked]:group-hover/switch:bg-sub-org/45",
        success:
          "data-[state=checked]:border-success/15 data-[state=checked]:bg-success/35 data-[state=checked]:group-hover/switch:bg-success/45",
        info: "data-[state=checked]:border-info/15 data-[state=checked]:bg-info/35 data-[state=checked]:group-hover/switch:bg-info/45",
        warning:
          "data-[state=checked]:border-warning/15 data-[state=checked]:bg-warning/35 data-[state=checked]:group-hover/switch:bg-warning/45",
        danger:
          "data-[state=checked]:border-danger/15 data-[state=checked]:bg-danger/35 data-[state=checked]:group-hover/switch:bg-danger/45"
      }
    },
    defaultVariants: {
      variant: "outline"
