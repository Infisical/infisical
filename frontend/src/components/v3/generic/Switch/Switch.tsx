  ...
  ),
  {
    variants: {
      variant: {
        ...
        endpoint:
          "data-[state=checked]:border-product-endpoint/10 data-[state=checked]:bg-product-endpoint/25 data-[state=checked]:hover:border-product-endpoint/15 data-[state=checked]:hover:bg-product-endpoint/30"
      }
    },
    defaultVariants: {
      variant: "outline"
