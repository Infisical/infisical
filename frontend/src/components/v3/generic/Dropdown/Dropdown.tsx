    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          "z-[var(--z-index-dropdown)] thin-scrollbar overflow-x-hidden overflow-y-auto rounded-popover border border-border bg-popover p-1 text-sm text-foreground shadow-md",
          className
        )}
        {...props}
      />
