...
const badgeVariants = cva(
  "inline-flex items-center [a&]:cursor-pointer justify-center rounded-[3px] border px-2 pt-[2.5px] pb-[1.5px] text-xs font-medium w-fit whitespace-nowrap shrink-0 gap-1 [&>svg]:pointer-events-none [&>svg]:stroke-[2.5] [&>svg]:mb-0.5 [&>svg]:size-3 overflow-hidden",
  {
    variants: {
      variant: {
        default:
        ...
        accent:
          "border-accent/75 bg-accent/30 text-accent [a&]:hover:bg-accent/40 [a&]:hover:border-accent",
