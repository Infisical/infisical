...
export const LastLoginSection = ({ lastLoginTime, lastLoginAuthMethod }: Props) => (
  <div className="py-1">
    ...
    <div className="mb-2 flex items-center gap-2 text-sm">
      <div className="flex items-center justify-center rounded-sm bg-container p-2">
        <ShieldIcon className="size-5" />
      </div>
      <div className="flex flex-col">
        <div className="text-sm font-medium text-label">Authentication Method</div>
    ...
    <div className="flex items-center gap-2 text-sm">
      ...
      <div className="flex flex-col">
        <div className="text-sm font-medium text-label">Time</div>
