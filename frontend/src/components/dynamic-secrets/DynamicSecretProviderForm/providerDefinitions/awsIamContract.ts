...
const inputsSchema = z.discriminatedUnion("method", [
  z.object({
  ...
  z.object({ method: z.literal(DynamicSecretAwsIamAuth.IRSA), ...common })
]);
export type TAwsIamFormValues = TDynamicSecretProviderFormValues<z.infer<typeof inputsSchema>>;
export const awsIamCreateFormSchema = createDynamicSecretProviderFormSchema(
  inputsSchema
) as z.ZodType<TAwsIamFormValues>;
export const awsIamEditFormSchema = editDynamicSecretProviderFormSchema(inputsSchema, {
