...
import { VaultKubernetesImportModal } from "../../CreateDynamicSecretForm/VaultKubernetesImportModal";
...
const KubernetesFields = ({ mode }: { mode: TDynamicSecretProviderFormMode }) => {
  ...
  return (
    <>
              ...
              render={({ field, fieldState: { error } }) => {
                ...
                return (
                  <Field data-invalid={Boolean(error)} data-disabled={!isAllowed}>
                    <FieldLabel htmlFor="kubernetes-gateway">Gateway</FieldLabel>
                    <GatewayPicker
                      inputId="kubernetes-gateway"
                      triggerRef={field.ref}
                      onBlur={field.onBlur}
                      ariaDescribedBy={hasFeedback ? "kubernetes-gateway-feedback" : undefined}
      ...
      <DynamicSecretProviderGroup id="kubernetes-audiences" presentation="panel" surface title="Audiences">
