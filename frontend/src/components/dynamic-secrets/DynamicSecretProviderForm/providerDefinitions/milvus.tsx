      ...
      <DynamicSecretProviderGroup id="milvus-connection" presentation="panel">
        ...
        >
          {(isAllowed) => (
            <Field
              role="group"
              aria-labelledby="milvus-gateway-label"
              aria-describedby={isAllowed ? undefined : "milvus-gateway-description"}
              data-disabled={!isAllowed}
            >
              <FieldLabel id="milvus-gateway-label">Gateway</FieldLabel>
              <GatewayPicker
              ...
              />
              {!isAllowed && (
                <FieldDescription id="milvus-gateway-description">
