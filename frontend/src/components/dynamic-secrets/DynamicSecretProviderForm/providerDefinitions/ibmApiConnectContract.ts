...
export type TIbmApiConnectFormInputs = z.input<typeof ibmApiConnectCreateInputsSchema>;
export type TIbmApiConnectFormValues = TDynamicSecretProviderFormValues<TIbmApiConnectFormInputs>;
...
export const ibmApiConnectCreateFormSchema = z
  ...
  }) as z.ZodType<TIbmApiConnectFormValues>;
...
export const getIbmApiConnectEditDefaultValues = (
  ...
  inputs: { ...(context.dynamicSecret.inputs as TIbmApiConnectFormInputs) }
});

export const getIbmApiConnectCreatePayload = (
  values: TIbmApiConnectFormValues,
  context: TCreateDynamicSecretProviderFormContext
