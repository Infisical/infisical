...
const connectionFields = [
  ...
  { name: "inputs.ca", type: "textarea", label: "CA", isOptional: true, rows: 3 }
...
const ClickHouseMetadataFields = () => {
  ...
  return (
    <DynamicSecretProviderGroup id="clickhouse-metadata" presentation="panel" surface title="Metadata">
              ...
              render={({ field, fieldState: { error } }) => {
                ...
                return (
                  <Field data-invalid={Boolean(error)} data-disabled={!isAllowed}>
                    <FieldLabel htmlFor="clickhouse-gateway">Gateway</FieldLabel>
                    <GatewayPicker
                      inputId="clickhouse-gateway"
...
export const clickHouseDynamicSecretProvider = defineDynamicSecretProvider({
  ...
  label: "ClickHouse",
  customRenderer: {
    reasons: ["permission-aware-fields", "repeatable-fields", "non-scalar-value"],
