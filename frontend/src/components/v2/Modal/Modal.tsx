    ...
    <DialogPrimitive.Portal>
      ...
      >
        <Card
          isRounded
          className={twMerge(
            "animate-pop-in fixed top-1/2 left-1/2 z-[60] thin-scrollbar max-w-xl -translate-x-2/4 -translate-y-2/4 border border-border-control bg-surface-raised drop-shadow-2xl dark:scheme-dark",
            className
          )}
          style={{ maxHeight: "90%" }}
        >
