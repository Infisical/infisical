...
export const PopoverContent = ({
  ...
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      className={twMerge(
        [
          "relative z-100 w-64 rounded-md bg-surface-active fill-surface-active p-4 pt-6 font-inter text-foreground-cool shadow-md",
          // animation
      ...
      {!hideCloseBtn && (
        <PopoverPrimitive.Close aria-label="Close" asChild>
          <IconButton
            variant="plain"
            ariaLabel="close"
            className="absolute top-0 right-1 rounded-sm text-muted-secondary hover:text-foreground-emphasis"
          >
