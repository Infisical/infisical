...
const inputVariants = cva(
  "input w-full py-1.5 text-gray-400 placeholder:text-sm placeholder-gray-500/50  outline-hidden focus:ring-2 hover:ring-bunker-400/60 duration-100 disabled:opacity-50 disabled:cursor-not-allowed",
  {
    variants: {
      size: {
        xs: ["text-xs"],
