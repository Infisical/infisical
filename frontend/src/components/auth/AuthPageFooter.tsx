export const AuthPageFooter = () => (
  <footer className="mt-5 flex flex-col-reverse items-center justify-between gap-3 border-t border-border pt-5 text-center sm:flex-row sm:text-left">
    ...
    <nav aria-label="Infisical social links" className="flex items-center justify-center gap-3">
      <a
        href="https://x.com/infisical"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Infisical on X"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Infisical on LinkedIn"
        className="text-muted transition-colors hover:text-foreground"
      >
        <svg className="size-3.5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Infisical on YouTube"
        className="text-muted transition-colors hover:text-foreground"
      >
        <svg className="size-3.5" fill="currentColor" viewBox="0 0 24 24">
