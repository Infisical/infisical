...
export const AuthPageLayout = ({
  ...
  <div className="min-h-screen bg-linear-to-r from-card to-bunker-900 to-75% lg:grid lg:grid-cols-[minmax(440px,44%)_minmax(0,1fr)] xl:grid-cols-[minmax(520px,40%)_minmax(0,1fr)]">
    <section className="flex h-screen min-h-0 min-w-0 flex-col overflow-y-auto px-5 sm:px-8 lg:border-r lg:border-border lg:px-10 xl:px-14">
