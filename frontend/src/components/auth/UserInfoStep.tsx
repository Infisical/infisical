      ...
      <AuthPagePanel>
        <CardHeader className={isInvite ? "mb-6 gap-2" : "mb-4 gap-2"}>
          ...
          >
            {isInvite ? (
              <>
                <span className="shrink-0 bg-linear-to-b from-white to-foreground-soft bg-clip-text text-transparent opacity-70">
                  Join
                </span>
                <span
                  className="min-w-0 truncate bg-linear-to-b from-white to-foreground-soft bg-clip-text text-transparent"
              ...
              <span className="bg-linear-to-b from-white to-foreground-soft bg-clip-text text-transparent">
                {stepTitle}
              </span>
            )}
          </CardTitle>
