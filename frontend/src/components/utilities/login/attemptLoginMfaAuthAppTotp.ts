...
import { login1, verifyMfaAuthAppTotp } from "@app/hooks/api/auth/queries";
 ...
 * @param {String} obj.userTotp - two-factor TOTP code entered by the user from their authenticator app
 */
export const attemptLoginMfaAuthAppTotp = async ({
    email,
    password,
    providerAuthToken,
    userTotp,
