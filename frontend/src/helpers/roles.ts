import { ProjectMembershipRole, TOrgRoleSummary } from "@app/hooks/api/roles/types";
...
export const findOrgMembershipRole = (roles: TOrgRoleSummary[], roleIdOrSlug: string) =>
