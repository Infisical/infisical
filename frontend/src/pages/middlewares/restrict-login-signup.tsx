  ...
  return (
    <>
      ...
      {config.authConsentContent && !hasConsented && (
        <div className="bg-opacity-90 fixed inset-0 z-50 flex items-center justify-center bg-container-hover/80">
          <div className="max-h-[80vh] w-4/12 overflow-y-auto rounded-lg bg-background p-6 text-foreground">
