...
export const EnterPasswordStep = ({ verificationToken, onComplete, onBack }: Props) => {
  ...
  return (
    ...
    >
      <h1 className="bg-gradient-to-b from-foreground-inverse to-foreground-soft bg-clip-text text-center text-xl font-medium text-transparent">
        Enter new password
      </h1>
      <p className="w-max justify-center text-center text-sm text-muted-cool">
