...
export const SignUpPage = () => {
  ...
  return (
    <div className="flex max-h-screen min-h-screen flex-col items-center overflow-y-auto bg-gradient-to-tr from-mineshaft-600 via-mineshaft-800 to-bunker-700 px-6 pb-28">
      <Helmet>
