...
export const SignUpPage = () => {
  ...
  return (
    <div className="bg-linear-to-tr from-mineshaft-600 via-mineshaft-800 to-bunker-700 flex max-h-screen min-h-screen flex-col justify-center overflow-y-auto px-6 pb-28">
      <Helmet>
