    ...
    <AuthPageLayout variant="focused" contentClassName="max-w-xl">
      ...
      <AuthPagePanel>
        <CardHeader className="gap-0">
          <div className="relative mb-8 flex size-10 items-center justify-center bg-admin text-background">
            <KeyRound className="size-5" />
            <span aria-hidden="true" className="absolute -top-1.5 -right-1.5 size-2 bg-admin" />
          </div>
        ...
        <CardContent className="mt-8 space-y-8">
          <div className="grid gap-3">
            <button
              type="button"
              className="group grid min-h-18 cursor-pointer grid-cols-[minmax(0,1fr)_auto] items-center rounded-md border border-org/30 bg-org/25 p-4 text-left text-foreground transition-all select-none hover:border-org/35 hover:bg-org/30 focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-0 active:scale-[0.99] disabled:pointer-events-none disabled:opacity-50"
              onClick={() =>
                navigate({
