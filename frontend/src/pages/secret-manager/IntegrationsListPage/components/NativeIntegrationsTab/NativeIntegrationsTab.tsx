...
import { NativeIntegrationsCreationBlockedModal } from "./NativeIntegrationsCreationBlockedModal";
...
export const NativeIntegrationsTab = () => {
  ...
  const { data: integrations, isPending: isIntegrationLoading } =
  ...
  return (
    <>
      ...
      <NativeIntegrationsCreationBlockedModal
