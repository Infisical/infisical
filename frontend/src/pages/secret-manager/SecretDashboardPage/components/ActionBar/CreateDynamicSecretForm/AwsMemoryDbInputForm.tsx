...
export const AwsMemoryDbInputForm = ({
  onCompleted,
  onCancel,
  environments,
  secretPath,
  ...
  const handleCreateDynamicSecret = async ({
    ...
    await createDynamicSecret.mutateAsync({
      provider: { type: DynamicSecretProviders.AwsMemoryDb, inputs: provider },
      maxTTL,
      name,
      path: secretPath,
      defaultTTL,
          ...
          <div>
            ...
            <div className="flex flex-col">
                ...
                <Controller
                  ...
                  render={({ field, fieldState: { error } }) => (
                    <FormControl
                      ...
                      errorText={error?.message}
                    >
                      <Input {...field} placeholder="my-memorydb-cluster" />
                    </FormControl>
                  )}
                />
                <Controller
              ...
              <div className="flex w-full items-center space-x-2">
                <Controller
                  control={control}
                  name="provider.auth.accessKeyId"
                  defaultValue=""
                  render={({ field, fieldState: { error } }) => (
                    <FormControl
                      label="Access Key ID"
                ...
                <Controller
                  control={control}
                  name="provider.auth.secretAccessKey"
                  render={({ field, fieldState: { error } }) => (
                    <FormControl
