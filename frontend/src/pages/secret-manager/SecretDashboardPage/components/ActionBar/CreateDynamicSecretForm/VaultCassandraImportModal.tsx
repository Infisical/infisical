  ...
  return (
    <>
      <Alert variant="info" className="mb-4">
        <InfoIcon />
        <AlertDescription>
          Select a Cassandra database role from Vault to pre-fill the form with its configuration
          including connection details, creation/revocation statements, TTL settings, etc.
        </AlertDescription>
      </Alert>
