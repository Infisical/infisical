...
import { Button, ContentLoader, EmptyState, IconButton, Input, Tooltip } from "@app/components/v2";
    ...
    >
      <div className="flex gap-2 px-4 py-3 transition-colors duration-200 hover:bg-zinc-800">
        <div className="flex min-w-0 flex-1 flex-col items-start">
          ...
          <div className="flex items-center gap-2 text-left text-xs text-mineshaft-300">
            <p>
