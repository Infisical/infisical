        ...
        {({ activeIndex }) => (
          <>
            <div className="flex w-full items-center whitespace-nowrap">
              ...
              <div className="relative inline-flex w-full items-center rounded-md rounded-l-none border border-border bg-container font-inter text-muted">
                <Combobox.Input
                  ...
                  autoComplete="off"
                  className={twMerge(
                    "input text-md h-[2.3rem] w-full rounded-md rounded-l-none bg-container py-1.5 pl-2.5 text-muted outline-hidden duration-200 placeholder:text-sm placeholder:text-muted hover:ring-ring/60 focus:bg-container-hover focus:ring-1 focus:ring-ring",
            ...
            <Transition
              ...
              leaveTo="opacity-0"
            >
              <Combobox.Options className="absolute z-30 mt-2 w-full min-w-[220px] overflow-y-auto rounded-md border border-border bg-popover text-foreground shadow-sm focus:outline-hidden">
                <Combobox.Option
                ...
                >
                  <FontAwesomeIcon icon={faFolderTree} className="mt-1 mr-2 text-folder" />
                  {value.trim()
                    ? `Search for "${
