        ...
        <form onSubmit={handleSubmit(onFormSubmit)} className="px-6">
          ...
          >
            <div className="flex flex-row items-center">
              <div className="bg-mineshaft-200 flex items-center rounded-full">
                <img
                        ...
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            {integrationAuthApps.length > 0 ? (
                              <div className="border-mineshaft-600 bg-mineshaft-900 font-inter text-bunker-200 outline-hidden data-placeholder:text-mineshaft-200 inline-flex w-full cursor-pointer items-center justify-between rounded-md border px-3 py-2 text-sm font-normal">
                                {repoIds?.length === 1
                              ...
                              <div className="border-mineshaft-600 bg-mineshaft-900 font-inter text-bunker-200 outline-hidden data-placeholder:text-mineshaft-200 inline-flex w-full cursor-default items-center justify-between rounded-md border px-3 py-2 text-sm font-normal">
                          ...
                          <DropdownMenuContent
                            align="start"
                            className="z-100 thin-scrollbar max-h-80 overflow-y-scroll"
                          >
                            {integrationAuthApps.length > 0 ? (
                    ...
                    render={({ field: { onChange, ...field }, fieldState: { error } }) => (
                      ...
                      >
                        <Select
                          ...
                          isDisabled={!repoId}
                          className={twMerge(
                            "border-mineshaft-500 w-full border",
