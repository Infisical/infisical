...
export const QoveryConfigurePage = () => {
  ...
  return integrationAuth && selectedSourceEnvironment ? (
    <div className="flex h-full w-full flex-col items-center justify-center bg-linear-to-tr from-card to-background">
      <Helmet>
      ...
      <div className="flex flex-col bg-container border border-border w-full p-4 max-w-lg mt-6 rounded-md">
        <div className="flex flex-row items-center"><FontAwesomeIcon icon={faCircleInfo} className="text-foreground text-xl"/> <span className="ml-3 text-md text-foreground">Pro Tip</span></div>
