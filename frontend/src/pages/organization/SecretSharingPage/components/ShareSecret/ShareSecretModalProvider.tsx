...
export const HandleCreateSharedSecretPopupOpenContext = createContext<
...
export const ShareSecretModalProvider = ({ children }: Props) => {
  ...
  const { handlePopUpOpen, popUp, handlePopUpToggle } = usePopUp(["createSharedSecret"] as const);
  ...
  return (
    <HandleCreateSharedSecretPopupOpenContext.Provider value={openModalFunction}>
      <Modal
