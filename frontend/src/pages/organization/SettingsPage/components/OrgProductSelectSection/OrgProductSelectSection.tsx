...
export const OrgProductSelectSection = () => {
  ...
  return (
    <div className="border-mineshaft-600 bg-mineshaft-900 mb-6 rounded-lg border px-6 py-5">
      <h2 className="text-mineshaft-100 text-xl font-medium">Enabled Products</h2>
