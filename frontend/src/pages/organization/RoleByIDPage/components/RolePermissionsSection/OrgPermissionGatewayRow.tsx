...
import { OrgGatewayPermissionActions, OrgPermissionSubjects } from "@app/context/OrgPermissionContext/types";
    ...
    <>
      ...
      >
        ...
        <Td className="w-full select-none">
          <p>{ORG_PERMISSION_OBJECT[OrgPermissionSubjects.Gateway].title}</p>
