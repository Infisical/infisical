...
type Props = {
  ...
  relayId: string;
  currentMethod: TRelayAuthMethodView;
};
  ...
  const onSubmit = async (form: FormData) => {
    try {
      if (form.method === "aws") {
        ...
        await updateRelay({ relayId, authMethod: { method: "token" } });
      }
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg overflow-visible">
        <DialogHeader>
          ...
          <DialogDescription>
            Switch the relay&apos;s auth method or update the current method&apos;s config.
          </DialogDescription>
        </DialogHeader>
