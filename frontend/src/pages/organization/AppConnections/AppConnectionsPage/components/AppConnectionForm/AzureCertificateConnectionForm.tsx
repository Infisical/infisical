...
const baseSchema = genericAppConnectionFieldsSchema.extend({
  ...
  method: z.nativeEnum(AzureCertificateConnectionMethod)
});
...
const getDefaultValues = (appConnection?: TAzureCertificateConnection): Partial<FormData> => {
  if (!appConnection) {
    return {
...
export const AzureCertificateConnectionForm = ({ appConnection, onSubmit }: Props) => {
  ...
  const {
    ...
    isLoading
  } = useGetAppConnectionOption(AppConnection.AzureCertificate);
  ...
  const isMissingConfig =
    selectedMethod === AzureCertificateConnectionMethod.OAuth && !oauthClientId;
  ...
  return (
    <FormProvider {...form}>
      <form onSubmit={handleSubmit(onSubmitHandler)}>
          ...
          render={({ field: { value, onChange }, fieldState: { error } }) => (
            <FormControl
              tooltipText={`The method you would like to use to connect with ${
                APP_CONNECTION_MAP[AppConnection.AzureCertificate].name
            ...
            >
              ...
              >
                {Object.values(AzureCertificateConnectionMethod).map((method) => {
                  return (
        ...
        {selectedMethod === AzureCertificateConnectionMethod.ClientSecret && (
          <>
            <Controller
