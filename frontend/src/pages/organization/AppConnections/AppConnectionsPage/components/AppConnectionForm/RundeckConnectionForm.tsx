...
import { RundeckConnectionMethod, TRundeckConnection } from "@app/hooks/api/appConnections";
...
type Props = {
  appConnection?: TRundeckConnection;
...
export const RundeckConnectionForm = ({ appConnection, onSubmit }: Props) => {
    ...
    <FormProvider {...form}>
      <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Field className="mb-4">
              <FieldLabel htmlFor="method">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-sm">
                    ...
                    {APP_CONNECTION_MAP[AppConnection.Rundeck].name}. This field cannot be changed
                    after creation.
                  </TooltipContent>
                </Tooltip>
              </FieldLabel>
              <Select disabled={isUpdate} value={value} onValueChange={(val) => onChange(val)}>
                ...
                <SelectContent position="popper">
                  {Object.values(RundeckConnectionMethod).map((method) => {
                    return (
            ...
            <Field className="mb-4">
              <FieldLabel htmlFor="instance-url">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-sm">
                    The URL of the Rundeck instance to authenticate with.
                  </TooltipContent>
                </Tooltip>
              </FieldLabel>
              <Input
        ...
        <AppConnectionFormFooter
          submitLabel={isUpdate ? "Update Credentials" : "Connect to Rundeck"}
        />
      </form>
    </FormProvider>
  );
