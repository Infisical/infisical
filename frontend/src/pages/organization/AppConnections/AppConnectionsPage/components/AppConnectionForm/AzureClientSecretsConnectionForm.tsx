...
import { AzureClientSecretsFormData } from "@app/pages/organization/AppConnections/OauthCallbackPage/OauthCallbackPage";
...
export const AzureClientSecretsConnectionForm = ({
  appConnection,
  onSubmit,
  projectType,
  projectId
