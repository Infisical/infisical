...
export default function TravisCICreateIntegrationPage() {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center">
      <Head>
        <title>Authorize Travis CI Integration</title>
          ...
          >
            <div className="flex flex-row items-center">
              <div className="inline flex items-center pb-0.5">
                <Image
                  src="/images/integrations/Travis CI.png"
                  height={30}
                  width={30}
                  alt="Travis CI logo"
                />
              </div>
              <span className="ml-1.5">Travis CI Integration</span>
              <Link href="https://infisical.com/docs/integrations/cicd/travisci" passHref>
