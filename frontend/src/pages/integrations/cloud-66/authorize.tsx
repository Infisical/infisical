...
export default function Cloud66CreateIntegrationPage() {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center">
      <Head>
        <title>Authorize Cloud 66 Integration</title>
        <link rel='icon' href='/infisical.ico' />
      </Head>
      <Card className="max-w-lg rounded-md border border-mineshaft-600 mb-12">
        <CardTitle 
          className="text-left px-6 text-xl" 
          subTitle="After adding your Personal Access Token, you will be prompted to set up an integration for a particular Infisical project and environment."
        >
          <div className="flex flex-row items-center">
            <div className="inline flex items-center pb-0.5">
              <Image
                src="/images/integrations/Cloud 66.png"
                height={30}
                width={30}
                alt="Cloud66 logo"
              />
            </div>
            <span className="ml-1.5">Cloud 66 Integration</span>
            <Link href="https://infisical.com/docs/integrations/cloud/cloud-66" passHref>
