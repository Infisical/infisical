...
export default function NorthflankCreateIntegrationPage() {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center">
      <Head>
        <title>Authorize Northflank Integration</title>
          ...
          >
            <div className="flex flex-row items-center">
              <div className="inline flex items-center pb-0.5">
                <Image
                  src="/images/integrations/Northflank.png"
                  height={30}
                  width={30}
                  alt="Northflank logo"
                />
              </div>
              <span className="ml-1.5">Northflank Integration</span>
              <Link href="https://infisical.com/docs/integrations/cloud/northflank" passHref>
