...
export default function RailwayAuthorizeIntegrationPage() {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center">
      <Head>
        <title>Authorize Railway Integration</title>
        ...
        >
          <div className="flex flex-row items-center">
            <div className="inline flex items-center pb-0.5">
              <Image
                src="/images/integrations/Railway.png"
                height={30}
                width={30}
                alt="Railway logo"
              />
            </div>
            <span className="ml-1.5">Railway Integration</span>
            <Link href="https://infisical.com/docs/integrations/cloud/railway" passHref>
