...
export default function DigitalOceanAppPlatformCreateIntegrationPage() {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center">
      <Head>
        <title>Digital Ocean App Platform Integration</title>
        ...
        >
          <div className="flex flex-row items-center">
            <div className="inline flex items-center pb-0.5">
              <Image
                src="/images/integrations/Digital Ocean.png"
                height={30}
                width={30}
                alt="Digital Ocean logo"
              />
            </div>
            <span className="ml-1.5">Digital Ocean App Platform Integration</span>
            <Link href="https://infisical.com/docs/integrations/cloud/digital-ocean-app-platform" passHref>
