...
export default function CodefreshCreateIntegrationPage() {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center">
      <Head>
        <title>Authorize Codefresh Integration</title>
        <link rel='icon' href='/infisical.ico' />
      </Head>
      <Card className="max-w-lg rounded-md border border-mineshaft-600 mb-12">
        <CardTitle className="text-left px-6 text-xl" 
          ...
          <div className="flex flex-row items-center">
            <div className="inline flex items-center pb-0.5">
              <Image
                src="/images/integrations/Codefresh.png"
                height={30}
                width={30}
                alt="Codefresh logo"
              />
            </div>
            <span className="ml-1.5">Codefresh Integration</span>
            <Link href="https://infisical.com/docs/integrations/cicd/codefresh" passHref>
