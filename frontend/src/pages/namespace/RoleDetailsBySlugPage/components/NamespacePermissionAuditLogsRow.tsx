...
import { NamespacePermissionAuditLogsActions } from "@app/context/NamespacePermissionContext/types";
...
const PERMISSION_ACTIONS = [
  {
    action: NamespacePermissionAuditLogsActions.Read,
    label: "Read"
  }
] as const;

export const NamespacePermissionAuditLogsRow = ({ isEditable, control, setValue }: Props) => {
    ...
    switch (val) {
      ...
      default:
        setValue(
          ...
          {
            [NamespacePermissionAuditLogsActions.Read]: false
          },
          { shouldDirty: true }
        );
    }
