          ...
          <TooltipProvider>
            <div className="flex flex-col gap-5">
              <section>
                ...
                <div className="rounded-md border border-border bg-surface-base px-3 py-2 font-mono text-xs break-all text-foreground">
                  {data.serialNumber || "—"}
                </div>
              </section>
              ...
              <section>
                ...
                <pre className="max-h-72 thin-scrollbar overflow-y-auto rounded-md border border-border bg-surface-base px-3 py-2.5 font-mono text-[11px] leading-relaxed break-all whitespace-pre-wrap text-foreground-secondary">
                  {data.certificatePem}
                </pre>
              </section>
            </div>
