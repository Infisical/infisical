...
export const PolicyReviewStep = () => {
  ...
  const { name, conditions, maxRequestTtl, bypassForMachineIdentities, steps } = watch();
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <ReviewField
            ...
            value={
              conditions[0].profileNames.length ? conditions[0].profileNames.join(", ") : "Not set"
            }
          />
          <ReviewField
              ...
              >
                ...
                <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {userApprovers.map((approver, approverIndex) => (
                          <div
                            ...
                            className="flex items-center gap-1.5 rounded bg-surface-hover px-2 py-1 text-xs text-label"
                          >
                  ...
                  {step.approvers.length === 0 && (
                    <span className="text-xs text-surface-selected">No approvers defined</span>
                  )}
                </div>
              </div>
            );
