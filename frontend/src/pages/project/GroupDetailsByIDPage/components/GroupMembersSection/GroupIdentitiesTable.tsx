...
import { useListProjectGroupIdentities } from "@app/hooks/api/groups/queries";
import { TGroupMembership } from "@app/hooks/api/groups/types";
import { GroupIdentityRow } from "@app/pages/organization/GroupDetailsByIDPage/components/GroupMembersSection/GroupIdentityRow";
...
export const GroupIdentitiesTable = ({ groupMembership }: Props) => {
  ...
  const { data: groupIdentities, isPending } = useListProjectGroupIdentities({
    ...
    <div>
      ...
      <TableContainer className="mt-4">
        <Table>
          ...
          <TBody>
            {isPending && (
              <TableSkeleton columns={3} innerKey="project-group-identity-memberships" />
            )}
            {!isPending &&
