...
export const PamDomainCard = ({
  ...
  const { image } = PAM_RESOURCE_TYPE_MAP[resourceType];
    ...
    >
      <div className="flex items-center gap-3.5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 text-sm text-bunker-300">Active Directory Domain</p>
        </div>
      </div>
    </div>
  );
