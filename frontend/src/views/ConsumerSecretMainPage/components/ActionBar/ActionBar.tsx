...
export const ActionBar = ({
  ...
  const { handlePopUpOpen, handlePopUpToggle, handlePopUpClose, popUp } =
    usePopUp([
      "addFolder",
      "addDynamicSecret",
      "addSecretImport",
  ...
  const handleSecretBulkDelete = async () => {
    ...
    try {
      await deleteBatchSecretV3({
        ...
        workspaceId,
        environment,
        secrets: bulkDeletedSecrets.map(({ key }) => ({
          secretKey: key,
  ...
  const handleSecretsMove = async ({
    ...
    try {
      ...
      if (isDestinationUpdated && isSourceUpdated) {
        ...
        notificationMessage =
          "A secret approval request has been generated in the destination";
      } else {
        notificationMessage =
    ...
    <>
      <div className="mt-4 flex items-center space-x-2">
        <SecretSearchInput
          ...
          environments={[
            currentWorkspace?.environments.find(
          ...
          <DropdownMenu>
              ...
              <IconButton
                ...
                className={twMerge(
                  ...
                  (Object.keys(filter.tags).length ||
                    Object.values(filter.include).filter((include) => !include)
                      .length) &&
            ...
            <DropdownMenuContent align="end" className="p-0">
              ...
              <DropdownMenuItem
                ...
                icon={
                  filter?.include[RowType.DynamicSecret] && (
                    <FontAwesomeIcon icon={faCheckCircle} />
                  )
                }
                iconPos="right"
              ...
              <div className="flex flex-col space-y-1 p-1.5">
                ...
                >
                  {(isAllowed) => (
                    <Button
                      leftIcon={
                        <FontAwesomeIcon icon={faFolderPlus} className="pr-2" />
                      }
                      onClick={() => {
                ...
                >
                  {(isAllowed) => (
                    <Button
                      leftIcon={
                        <FontAwesomeIcon icon={faFileImport} className="pr-2" />
                      }
                      onClick={() => {
