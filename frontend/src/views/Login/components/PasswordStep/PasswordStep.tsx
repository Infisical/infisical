...
export const PasswordStep = ({
  ...
  const { callbackPort, isLinkingRequired, authMethod } = jwt_decode(providerAuthToken) as any;
  ...
  return (
    <form onSubmit={handleLogin} className="h-full mx-auto w-full max-w-md px-6 pt-8">
      <div className="mb-8">
      ...
      <div className="text-bunker-400 text-xs flex flex-col items-center w-max mx-auto mt-4">
        ...
        <Link href="/verify-email">
          <span className="hover:underline mt-2 hover:underline-offset-4 hover:decoration-primary-700 hover:text-bunker-200 duration-200 cursor-pointer">
