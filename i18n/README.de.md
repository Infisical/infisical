...
<p align="center">
  <p align="center">Open-Source-Tool mit End-to-End-Verschlüsselung zur Verwaltung von Privaten Schlüsseln (Secrets) und Konfigurationen in Ihrem Team, auf Geräten und in Ihrer Infrastruktur.</p>
</p>
...
<h4 align="center">
  ...
  <a href="https://infisical.com/docs/getting-started/introduction">Dokumentation (en)</a> |
  <a href="https://www.infisical.com">Website</a>
</h4>

<h4 align="center">
  <a href="https://github.com/medusajs/medusa/blob/master/LICENSE">
    <img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="Infisical wird unter der MIT Lizens veröffentlicht." />
  </a>
...
**In anderen Sprachen lesen**: <kbd>[<img title="Englisch" alt="Englisch" src="https://cdn.staticaly.com/gh/hjnilsson/country-flags/master/svg/us.svg" width="22">](i18n/README.en.md)</kbd>
<kbd>[<img title="Deutsch" alt="Deutsch" src="https://cdn.staticaly.com/gh/hjnilsson/country-flags/master/svg/de.svg" width="22">](i18n/README.de.md)</kbd>
<kbd>[<img title="Spanisch" alt="Spanisch" src="https://cdn.staticaly.com/gh/hjnilsson/country-flags/master/svg/es.svg" width="22">](i18n/README.es.md)</kbd>
<kbd>[<img title="Koreanisch" alt="Koreanisch" src="https://cdn.staticaly.com/gh/hjnilsson/country-flags/master/svg/kr.svg" width="22">](i18n/README.ko.md)</kbd>
...
-   **[Benutzerfreundliches Dashboard](https://infisical.com/docs/getting-started/dashboard/project)** um die Schlüssel und Konfigurationen deines Teams über verschiedene Projekte hinweg zu verwalten.
-   **[Sprachunabhängige CLI](https://infisical.com/docs/cli/overview)** um deine Schlüssel und Konfigurationen in deinem lokalen Workflow zu integrieren.
-   **[Volle Kontrolle über deine Daten](https://infisical.com/docs/self-hosting/overview)** - hoste Infisical auf deinem eigenen Server!
-   **Mehrere Entwicklungsumgebungen** pro Projekt (bspw. „development“, „staging“, „production“, etc.)
-   **Benutzerspezifisches Überschreiben** von Schlüsseln und Konfigurationen
-   **[Integrationen](https://infisical.com/docs/integrations/overview)** mit CI/CD und Produktions-Infrastruktur
-   **[Infisical API](https://infisical.com/docs/api-reference/overview/introduction)** - verwalte Schlüssel mit API-Anfragen
-   **[Geheime Versionierung](https://infisical.com/docs/getting-started/dashboard/versioning)** um Veränderungen zu beobachten
-   **[Aktivitätshistorien](https://infisical.com/docs/getting-started/dashboard/audit-logs)** um alle Veränderungen in einem Projekt zu prüfen
-   **[Wiederherstellung von Schlüsseln](https://infisical.com/docs/getting-started/dashboard/pit-recovery)** um zu bestimmten Zeitpunkten/Snapshots zurückzukehren
-   **Rechte-basierte Zugriffskontrolle** pro Entwicklungsumgebung
-   **2FA** (weitere Optionen folgen)
-   🔜 **1-Click Deploy** zu AWS
-   🔜 **Automatische Secret Rotation**
-   🔜 **Smarte Sicherheitshinweise**
-   🔜 **Secret Rotation**
...
Um schnell loszulegen, lies unseren „[get started guide](https://infisical.com/docs/getting-started/introduction)“.
...
## 🔥 Was macht Infisical so großartig?

Infisical erleichtert das Verwalten von privaten Schlüsseln und ist standardmäßig End-to-End-verschlüsselt. Unser Ziel ist es, das allen Entwicklern und <i>nicht nur Sicherheitsteams</i> zu erleichtern.

Einem [Bericht](https://www.ekransystem.com/en/blog/secrets-management) zufolge, nutzen nur 10% aller Unternehmen Lösungen zur Verwaltung von Sicherheitsschlüsseln, obwohl alle zu einem gewissen Maße digitale Schlüssel verwenden.

Wenn dir Effizienz und Sicherheit wichtig sind, ist Infisical genau richtig für dich!

Wir arbeiten hart daran, Infisical stetig zu erweitern. Vermisst du bestimmte Integrationen oder wünscht dir ein neues Feature? [Erstelle ein Ticket](https://github.com/Infisical/infisical/issues) oder [trage direkt zum Repository bei](https://infisical.com/docs/contributing/overview).

## 🔌 Integrationen

Wir setzen gerade das Fundament und [integrieren](https://infisical.com/docs/integrations/overview) Infisical wo es nur geht, sodass Schlüssel überall synchronisiert werden können. Jede Hilfe ist Willkommen! :)
...
-   [Slack](https://join.slack.com/t/infisical-users/shared_invite/zt-1kdbk07ro-RtoyEt_9E~fyzGo_xQYP6g) (Für Diskussionen und Gespräche mit der Community und dem Infisical Team)
-   [GitHub Discussions](https://github.com/Infisical/infisical/discussions) (Für Hilfe bei der Entwicklung und tiefergehenden Diskussionen zu bestimmten Features)
-   [GitHub Issues](https://github.com/Infisical/infisical-cli/issues) (Für jegliche Bugs und Fehler die dir beim Arbeiten mit Infisical auffallen)
-   [Twitter](https://twitter.com/infisical) (Bleib immer aktuell!)

## 🏘 Open-source vs. paid

Dieses Repository ist MIT lizensiert, mit Ausnahme des `ee` Ordners, der „Premium Enterprise Features“ enthält, welche zukünftig einer Infisical Lizens bedürfen. Wir sind dennoch darauf fokussiert, zuerst „Non-Enterprise“-Lösungen zu entwickeln, welche die meisten Anwendungsfälle abdecken.

## 🛡 Sicherheit

Sie möchten eine Sicherheitslücke melden? Bitte verwenden dafür nicht die „Github Issues“. Nutze stattdesen die [SECURITY.md](./SECURITY.md).

## 🚨 Bleibe immer auf dem Laufenden

Infisical wurde offiziell unter der Version 1.0 am 21. November 2022 veröffentlicht. Es erscheinen regelmäßig neue Features. Um bei zukünftigen **releases** von diesem Repository benachrichtigt zu werden, klicke auf Watch:

![infisical-star-github](https://github.com/Infisical/infisical/blob/main/.github/images/star-infisical.gif?raw=true)

## 🌱 Hilf uns

Egal wie groß oder klein deine Hilfe ist, wir freuen uns über Deine Beteiligung ❤️ Sieh dir unseren [Contributing-Guide](https://infisical.com/docs/contributing/overview) an.

Nicht sicher wo du anfangen sollst? Du kannst:

-   [Du kannst eine kostenlose Session mit einem unserer Teammitglieder starten](mailto:tony@infisical.com?subject=Pairing%20session&body=I'd%20like%20to%20do%20a%20pairing%20session!)!
-   Unserem <a href="https://join.slack.com/t/infisical-users/shared_invite/zt-1kdbk07ro-RtoyEt_9E~fyzGo_xQYP6g">Slack-Channel</a> beitreten, und uns dort jegliche Fragen stellen.
