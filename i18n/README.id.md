...
<p align="center">
  <p align="center">Sumber terbuka, enkripsi ujung ke ujung, alat sederhana untuk mengelola rahasia dan konfigurasi di seluruh tim dan infrastruktur Anda.</p>
</p>

<h4 align="center">
  <a href="https://join.slack.com/t/infisical-users/shared_invite/zt-1kdbk07ro-RtoyEt_9E~fyzGo_xQYP6g">Slack</a> |
  <a href="https://infisical.com/">Infisical Cloud</a> |
  <a href="https://infisical.com/docs/self-hosting/overview">Hosting Mandiri</a> |
  <a href="https://infisical.com/docs/getting-started/introduction">Dokumentasi</a> |
...
<h4 align="center">
  ...
  <a href="https://cloudsmith.io/~infisical/repos/">
    <img src="https://img.shields.io/badge/Downloads-22.6k-orange" alt="Cloudsmith downloads" />
  </a>
...
**Baca ini dalam bahasa lain**: <kbd>[<img title="English" alt="English language" src="https://cdn.staticaly.com/gh/hjnilsson/country-flags/master/svg/us.svg" width="22">](i18n/README.en.md)</kbd>
...
-   **[Dasbor User-friendly](https://infisical.com/docs/getting-started/dashboard/project)** untuk mengelola rahasia dan konfigurasi tim Anda dalam proyek
-   **[CLI Language-Agnostic](https://infisical.com/docs/cli/overview)** yang menarik dan menyuntikkan rahasia dan konfigurasi ke dalam alur kerja lokal Anda
-   **[Kontrol penuh atas data Anda](https://infisical.com/docs/self-hosting/overview)** - host sendiri di infrastruktur apa pun
-   **Menavigasi Banyak Lingkungan** per proyek (misalnya pengembangan, pementasan, produksi, dll.)
-   **Override personal** untuk rahasia dan konfigurasi
-   **[Integrasi](https://infisical.com/docs/integrations/overview)** dengan CI/CD dan infrastruktur produksi
-   **[API Infisical](https://infisical.com/docs/api-reference/overview/introduction)** - mengelola rahasia melalui permintaan HTTPS ke platform
-   **[Versioning Rahasia](https://infisical.com/docs/getting-started/dashboard/versioning)** untuk melihat riwayat perubahan rahasia apa pun
...
Untuk memulai dengan cepat, kunjungi [panduan memulai](https://infisical.com/docs/getting-started/introduction) kami.
...
Infisical membuat manajemen rahasia menjadi sederhana dan terenkripsi end-to-end secara default. Kami memiliki misi untuk membuatnya lebih mudah diakses oleh semua developer, <i>bukan hanya tim keamanan</i>.

Menurut [laporan](https://www.ekransystem.com/en/blog/secrets-management), hanya 10% organisasi yang menggunakan solusi manajemen rahasia meskipun semuanya menggunakan rahasia digital sampai batas tertentu.

Jika Anda peduli dengan efisiensi dan keamanan, maka Infisical tepat untuk Anda.

Kami sedang bekerja keras untuk membuat Infisical lebih luas. Butuh integrasi atau ingin fitur baru? Jangan ragu untuk [membuat masalah](https://github.com/Infisical/infisical/issues) atau [berkontribusi](https://infisical.com/docs/contributing/overview) langsung ke repositori.

## 🌱 Berkontribusi

Besar atau kecil, kami menyukai kontribusi ❤️ Lihat panduan kami untuk mengetahui cara [memulai](https://infisical.com/docs/contributing/overview).

Tidak yakin harus mulai dari mana? Kamu bisa:

-   [Pesan sesi berpasangan gratis tanpa tekanan dengan salah satu rekan tim kami](mailto:tony@infisical.com?subject=Pairing%20session&body=I'd%20like%20to%20do%20a%20pairing%20session!)!
-   Bergabunglah dengan <a href="https://join.slack.com/t/infisical-users/shared_invite/zt-1kdbk07ro-RtoyEt_9E~fyzGo_xQYP6g">Slack</a> kami, dan ajukan pertanyaan apa pun kepada kami di sana.

## 💚 Komunitas & Dukungan

-   [Slack](https://join.slack.com/t/infisical-users/shared_invite/zt-1kdbk07ro-RtoyEt_9E~fyzGo_xQYP6g) (Untuk diskusi langsung dengan komunitas dan tim Infisical)
-   [Diskusi GitHub](https://github.com/Infisical/infisical/discussions) (Untuk bantuan membangun dan percakapan yang lebih dalam tentang fitur)
-   [Masalah GitHub](https://github.com/Infisical/infisical-cli/issues) (Untuk bug dan kesalahan apa pun yang Anda temui menggunakan Infisical)
-   [Twitter](https://twitter.com/infisical) (Dapatkan berita dengan cepat)

## 🌄 Status

-   [x] Alfa Publik: Siapa pun dapat mendaftar di [infisical.com](https://infisical.com) tetapi ada beberapa kekusutan kecil.
-   [ ] Beta Publik: Cukup stabil untuk sebagian besar kasus penggunaan non-perusahaan.
-   [ ] Umum: Siap produksi.
...
## 🏘 Sumber terbuka vs. berbayar

Repo ini sepenuhnya berlisensi MIT, dengan pengecualian direktori `ee` yang akan berisi fitur perusahaan premium yang memerlukan lisensi Infisical di masa mendatang. Kami saat ini berfokus pada pengembangan penawaran non-perusahaan terlebih dahulu yang sesuai dengan sebagian besar kasus penggunaan.

## 🛡 Keamanan

Ingin melaporkan kerentanan keamanan? Tolong jangan posting tentang itu di masalah GitHub. Sebagai gantinya, lihat file [SECURITY.md](./SECURITY.md) kami.

## 🚨 Tetap Terkini

Infisical secara resmi diluncurkan sebagai v.1.0 pada tanggal 21 November 2022. Ada banyak fitur baru yang sangat sering hadir. Tonton **rilis** repositori ini untuk mendapatkan notifikasi tentang pembaruan di masa mendatang:
...
Infisical saat ini tersedia dalam bahasa Inggris, Korea, Prancis, Portugis (Brasil), dan Bahasa Indonesia. Bantu kami menerjemahkan Infisical ke bahasa Anda!

Anda dapat menemukan semua info di [masalah ini](https://github.com/Infisical/infisical/issues/181).
