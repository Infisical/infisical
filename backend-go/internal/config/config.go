...
func LoadConfig() (*Config, error) {
	...
	_ = k.Set("NODE_ENV", string(NodeEnvProduction))
	_ = k.Set("PORT", 4040)
	_ = k.Set("HOST", "0.0.0.0")
	_ = k.Set("LOG_LEVEL", "info")
	_ = k.Set("DB_PORT", "5432")
	_ = k.Set("SMTP_PORT", 587)
	_ = k.Set("SMTP_FROM_NAME", "Infisical")
	_ = k.Set("SMTP_REQUIRE_TLS", true)
	_ = k.Set("SMTP_TLS_REJECT_UNAUTHORIZED", true)
	_ = k.Set("TELEMETRY_ENABLED", true)
	_ = k.Set("POSTHOG_HOST", "https://app.posthog.com")
	_ = k.Set("POSTHOG_PROJECT_API_KEY", "phc_nSin8j5q2zdhpFDI1ETmFNUIuTG4DwKVyIigrY10XiE")
	_ = k.Set("SALT_ROUNDS", 10)
	_ = k.Set("MAX_LEASE_LIMIT", 10000)
	_ = k.Set("QUEUE_WORKERS_ENABLED", true)
	_ = k.Set("JWT_AUTH_LIFETIME", "10d")
	_ = k.Set("JWT_SIGNUP_LIFETIME", "15m")
	_ = k.Set("JWT_REFRESH_LIFETIME", "90d")
	_ = k.Set("JWT_INVITE_LIFETIME", "1d")
	_ = k.Set("JWT_MFA_LIFETIME", "5m")
	_ = k.Set("JWT_PROVIDER_AUTH_LIFETIME", "15m")
	_ = k.Set("REDIS_SENTINEL_MASTER_NAME", "mymaster")
	_ = k.Set("LICENSE_SERVER_URL", "https://portal.infisical.com")
	_ = k.Set("SECRET_SCANNING_GIT_APP_SLUG", "infisical-radar")
	_ = k.Set("URL_GITLAB_URL", "https://gitlab.com")
	_ = k.Set("OTEL_OTLP_PUSH_INTERVAL", 30000)
	_ = k.Set("SSL_CLIENT_CERTIFICATE_HEADER_KEY", "x-ssl-client-cert")
	_ = k.Set("IDENTITY_TLS_CERT_AUTH_CLIENT_CERTIFICATE_HEADER_KEY", "x-identity-tls-cert-auth-client-cert")
	_ = k.Set("ENABLE_MSSQL_SECRET_ROTATION_ENCRYPT", true)
	_ = k.Set("CLICKHOUSE_AUDIT_LOG_ENGINE", "ReplacingMergeTree")
	_ = k.Set("CLICKHOUSE_AUDIT_LOG_TABLE_NAME", "audit_logs")
	_ = k.Set("CLICKHOUSE_AUDIT_LOG_ENABLED", true)
	_ = k.Set("DATADOG_ENV", "prod")
	_ = k.Set("DATADOG_SERVICE", "infisical-core")
	_ = k.Set("PIT_CHECKPOINT_WINDOW", "100")
	_ = k.Set("PIT_TREE_CHECKPOINT_WINDOW", "200")
	_ = k.Set("PARAMS_FOLDER_SECRET_DETECTION_ENTROPY", 3.7)
	_ = k.Set("HSM_SLOT", 0)
	...
	if nodeEnv != string(NodeEnvProduction) {
		if err := k.Load(file.Provider(".env"), dotenv.Parser()); err != nil {
			if !os.IsNotExist(err) {
				slog.DebugContext(context.Background(), "could not load .env file", slog.Any("error", err))
			}
		}
	}
