...
// BuildListSecretsV3Payload builds the payload for the secrets listSecretsV3
// endpoint from CLI flags.
func BuildListSecretsV3Payload(secretsListSecretsV3ProjectID string, secretsListSecretsV3Environment string, secretsListSecretsV3SecretPath string, secretsListSecretsV3ViewSecretValue string, secretsListSecretsV3ExpandSecretReferences string, secretsListSecretsV3Recursive string, secretsListSecretsV3IncludeImports string, secretsListSecretsV3TagSlugs string, secretsListSecretsV3MetadataFilter string, secretsListSecretsV3Token string) (*secrets.ListSecretsV3Payload, error) {
	var err error
	var projectID string
	{
		projectID = secretsListSecretsV3ProjectID
	}
	var environment string
	{
		environment = secretsListSecretsV3Environment
	}
	var secretPath string
	{
		if secretsListSecretsV3SecretPath != "" {
			secretPath = secretsListSecretsV3SecretPath
		}
	}
	var viewSecretValue bool
	{
		if secretsListSecretsV3ViewSecretValue != "" {
			viewSecretValue, err = strconv.ParseBool(secretsListSecretsV3ViewSecretValue)
			if err != nil {
				return nil, fmt.Errorf("invalid value for viewSecretValue, must be BOOL")
			}
		}
	...
	var expandSecretReferences bool
	{
		if secretsListSecretsV3ExpandSecretReferences != "" {
			expandSecretReferences, err = strconv.ParseBool(secretsListSecretsV3ExpandSecretReferences)
			if err != nil {
				return nil, fmt.Errorf("invalid value for expandSecretReferences, must be BOOL")
			}
		}
	...
	var recursive bool
	{
		if secretsListSecretsV3Recursive != "" {
			recursive, err = strconv.ParseBool(secretsListSecretsV3Recursive)
			if err != nil {
				return nil, fmt.Errorf("invalid value for recursive, must be BOOL")
			}
		}
	...
	var includeImports bool
	{
		if secretsListSecretsV3IncludeImports != "" {
			includeImports, err = strconv.ParseBool(secretsListSecretsV3IncludeImports)
			if err != nil {
				return nil, fmt.Errorf("invalid value for includeImports, must be BOOL")
			}
		}
	...
	var tagSlugs *string
	{
		if secretsListSecretsV3TagSlugs != "" {
			tagSlugs = &secretsListSecretsV3TagSlugs
		}
	}
	var metadataFilter *string
	{
		if secretsListSecretsV3MetadataFilter != "" {
			metadataFilter = &secretsListSecretsV3MetadataFilter
		}
	}
	var token string
	{
		token = secretsListSecretsV3Token
	}
