...
func ParseEndpoint(
	...
	var (
		...
		secretsListSecretsV3ExpandSecretReferencesFlag = secretsListSecretsV3Flags.String("expand-secret-references", "true", "")
		secretsListSecretsV3RecursiveFlag              = secretsListSecretsV3Flags.String("recursive", "", "")
		secretsListSecretsV3IncludeImportsFlag         = secretsListSecretsV3Flags.String("include-imports", "true", "")
