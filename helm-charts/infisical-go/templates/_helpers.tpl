...
{{- define "infisical-go.backendGoLabels" -}}
{{ include "infisical.common.labels" . }}
component: "backend-go"
{{- end -}}

{{- define "infisical-go.kmsLabels" -}}
{{ include "infisical.common.labels" . }}
component: "kms"
{{- end -}}

{{- define "infisical-go.backendGoFullname" -}}
{{- printf "%s-backend-go" .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "infisical-go.kmsFullname" -}}
{{- printf "%s-kms" .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
