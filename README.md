...
- **[Web Access](https://infisical.com/docs/documentation/platform/pam/accounts/overview#web-access)**: Connect to SSH, PostgreSQL, Redis, and Windows RDP resources directly from the browser.
