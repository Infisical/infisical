...
import { SecretTableResourceCount } from "../overview/-components/SecretTableResourceCount";
import { SecretV2MigrationSection } from "../overview/-components/SecretV2MigrationSection";
...
import {
  ...
  useSelectedSecrets
} from "./-components/SecretMainPage.store";
import { Filter, RowType } from "./-components/SecretMainPage.types";
...
const SecretMainPageContent = () => {
  ...
  const navigate = useNavigate({
    from: "/secret-manager/$projectId/secrets/$envSlug"
  });
...
const DashboardPageQueryParamsSchema = z.object({
...
export const Route = createFileRoute(
  ...
  validateSearch: zodValidator(DashboardPageQueryParamsSchema)
});
