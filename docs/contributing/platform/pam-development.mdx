...
You're not locked into this stack — PAM works against anything reachable from the gateway, so you can also point it at your own containers or cloud-hosted databases (DigitalOcean, RDS, etc.) when you need to test against something closer to production.
