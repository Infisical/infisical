...
Each package directory has an `.npmrc` with a seven-day minimum release age for dependency
resolution. Keep that file when copying a package directory into a build environment.
