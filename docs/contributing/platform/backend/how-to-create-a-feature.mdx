...
description: "Step-by-step guide to adding a new feature to the Infisical backend."
---
...
4. Modify both the `up` and `down` functions to create or alter PostgreSQL fields on migration up and to revert these changes on migration down, ensuring idempotency as outlined [here](https://github.com/graphile/migrate/blob/main/docs/idempotent-examples.md).
