...
<CardGroup cols={2}>
	...
	<Card
		href="/contributing/sdk/developing"
		title="Infisical SDK"
		icon="code"
		color="#A1B659">
		The SDKs are the official Infisical client libraries, used by developers to
		easily interact with the Infisical platform.
	</Card>
	<Card
		href="/contributing/cli/developing"
		title="Infisical CLI"
		icon="code"
		color="#A1B659">
		The CLI is the official terminal client, used by developers and users to
		easily interact with the Infisical platform.
	</Card>
</CardGroup>
...
- Local development guide for CLI is [here](/contributing/cli/developing).
