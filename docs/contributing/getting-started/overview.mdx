---
title: "Contributing"
description: "How to propose, build, and submit changes to Infisical."
sidebarTitle: "Contributing"
icon: "git-pull-request"
---

Infisical is open source, and contributions are welcome. This section covers how we work together and how to get the platform running locally.

<CardGroup cols={2}>
  <Card title="Getting started" icon="handshake" href="/contributing/getting-started/code-of-conduct">
    The code of conduct we hold each other to, and how to open a pull request.
  </Card>
  <Card title="Platform" icon="code" href="/contributing/platform/developing">
    Run Infisical locally, and the guides for working on the backend.
  </Card>
</CardGroup>
...
We're building an inclusive community, and this means adhering to the [Code of Conduct](/contributing/getting-started/code-of-conduct).
...
Before code contributions can be merged, all contributors must have a signed Contributor License Agreement (CLA) on file.

- **Individual CLA**: When you open your pull request, follow the automated bot link or visit [the CLA signing portal](https://cla.infisical.com/sign) to review and accept the agreement with your GitHub account
- **Corporate CLA (CCLA)**: If you contribute code on behalf of your employer or company, your organization must execute a Corporate CLA. To request the agreement and Schedule A, email [contribute@infisical.com](mailto:contribute@infisical.com) or [security@infisical.com](mailto:security@infisical.com) with your organization name and authorized contributor GitHub handles. Once signed, the team allowlists your employees' handles so pull requests automatically pass the CLA verification check
