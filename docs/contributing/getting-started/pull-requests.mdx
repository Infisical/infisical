...
Once you're done making changes in local development, you can submit a pull request (PR) to the main repository branch.
...
One or two relevant members of the Infisical team should review and approve the PR before it's merged. You can ping someone from the team in our [Slack](https://infisical.com/slack) to review your PR.
...
<Note>
    ...
    reviewing PRs once they're fully complete and well-tested.
...
All pull requests require a signed Contributor License Agreement (CLA) before merge:

- **Individual contributors**: Accept the agreement digitally via the CLA bot link on your pull request or directly at [https://cla.infisical.com/sign](https://cla.infisical.com/sign)
- **Corporate contributors**: If contributing on behalf of an employer, your organization must sign a Corporate CLA (CCLA) and submit Schedule A listing authorized employee GitHub handles to [contribute@infisical.com](mailto:contribute@infisical.com) or [security@infisical.com](mailto:security@infisical.com). The Infisical team will allowlist your GitHub handles so PR checks pass automatically
