...
<Note>
  As of June 2023, Docker has deprecated Compose V1 and recommended that everyone switches to Compose V2.

Switching is easy. Type `docker compose` instead of `docker-compose` in your favorite terminal.

More information about this can be found [here](https://www.docker.com/blog/new-docker-compose-v2-and-v1-deprecation).
