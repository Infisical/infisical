...
<CardGroup cols={2}>
  ...
  <Card title="Machine Identities" icon="bot" href="/documentation/platform/identities/machine-identities">
    Understand how identities authenticate and what they can access.
  </Card>
  <Card title="GitHub Secret Syncs" icon="refresh-cw" href="/integrations/secret-syncs/github">
