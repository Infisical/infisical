...
The Terraform Bridge wraps the [Infisical Terraform provider](http://localhost:3000/integrations/frameworks/terraform) and exposes its resources (such as `infisical_secret`, `infisical_project`, and `infisical_service_token`) 
