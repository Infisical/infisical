...
<ParamField query="--polling-fallback-interval" type="duration" default="10m">
 How often to poll for secret changes when SSE is unavailable. Defaults to `10m`. Supports duration formats like `60s|5m|1h|1d|1w|1y`.
</ParamField>
# Caching Behavior
