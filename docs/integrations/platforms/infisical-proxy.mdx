...
<Accordion title="Using event subscriptions">
  ...
  You can create a machine identity in the [Infisical Dashboard](https://app.infisical.com/settings/machine-identities) or using the [Infisical CLI](/cli/commands/machine-identity).
