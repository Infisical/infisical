...
<Accordion title="infisical.auth.type">
  ...
  - For `ldap-auth`: LDAP credentials are used. See [LDAP Auth](/documentation/platform/identities/ldap-auth/general).
...
### Authentication
The Infisical Agent Injector supports Machine Identity [Kubernetes Auth](/documentation/platform/identities/kubernetes-auth), [LDAP Auth](/documentation/platform/identities/ldap-auth/general), and [AWS Auth](/documentation/platform/identities/aws-auth) authentication.
