...
The Infisical agent supports multiple authentication methods to renew access tokens. Below are the available authentication methods, with their respective configurations.
