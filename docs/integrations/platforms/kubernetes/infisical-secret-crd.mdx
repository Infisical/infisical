...
<Warning>
  The `InfisicalSecret` CRD (v1alpha1) is deprecated and will be removed in a future release.
  ...
  See the [migration guide](/integrations/platforms/kubernetes/overview#migrating-from-v1alpha1-to-v1beta1).
</Warning>
