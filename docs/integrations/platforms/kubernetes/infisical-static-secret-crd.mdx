...
<Accordion title="sources">
  ...
  To access a secret that was dropped by the merge (e.g. a duplicate key under a different path or source), use the `resolveSecretFromPath` template function to select it by its full path.
