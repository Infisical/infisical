---
sidebarTitle: "InfisicalPushSecret"
...
After applying the soruce-secret.yaml file, you're ready to apply the InfisicalPushSecret CRD.
...
<Accordion title="authentication">
  ...
  <Accordion title="universalAuth">
    The universal authentication method is one of the easiest ways to get started with Infisical. Universal Auth works anywhere and isn't tied to any specific cloud provider.
...
<Accordion title="push.secret.template.includeAllSecrets">
  This property controls what secrets are included in your push to Infisical.
...
<Accordion title="push.secret.template.data">
  ...
  For the full list of built-in template helper functions and usage examples, see [Kubernetes Operator templating](/integrations/platforms/kubernetes/overview#templating).
</Accordion>
