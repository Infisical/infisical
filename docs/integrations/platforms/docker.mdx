...
First, choose how Docker should receive your application secrets:
...
<Tabs>
  <Tab title="Fetch at startup (Recommended)">
    ...
    ## Step 6: Build and run your container
  ...
  <Tab title="Docker Run (CI/CD)">
    ...
    ## Step 2: Configure machine identity access
...
## Optional: Use with Docker Compose
...
[Configure each image](/integrations/platforms/docker#step-5-update-your-dockerfile) to start through `infisical run`, then configure your Compose file for your Infisical deployment:
