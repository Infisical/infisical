...
<Steps>
    ...
    <Step title="Get Connection Details">
        ...
        - `host` - The hostname or IP address of your Microsoft SQL Server instance
        - `port` - The port number your Microsoft SQL Server instance is listening on (default: 1433)
