...
<Steps>
    <Step title="Navigate to Profile Settings">
        Log in to the [Convex Dashboard](https://dashboard.convex.dev), select your profile avatar in the top right, and select **Profile Settings**.
...
<Steps>
    <Step title="Navigate to App Connections">
        Navigate to the **App Connections** tab in your organization and select **+ Add Connection**.
