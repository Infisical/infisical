...
You'll need the following information to establish an SSH connection:
        ...
        <Steps>
           <Step title="Navigate to App Connections">
            ...
            <Step title="Select SSH Connection">
                Select the **+ Add Connection** button and select **SSH Connection** from the available options.
