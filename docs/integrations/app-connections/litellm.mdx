...
- A **management-capable API key** for that proxy. Infisical uses this key to create, list, and delete keys on your behalf, so it must be the proxy **master key** or an admin/management key with key-management permissions. A standard virtual key limited to model completions won't work.
    ...
    <Tab title="Infisical UI">
        <Steps>
            ...
            <Step title="Select LiteLLM Connection">
                ...
                ![Select LiteLLM Connection](/images/app-connections/litellm/step-1.png)
            </Step>
            <Step title="Fill out Connection Form">
                ...
                ![LiteLLM Connection Form](/images/app-connections/litellm/step-2.png)
            </Step>
            <Step title="Connection Created">
                ...
                ![LiteLLM Connection Created](/images/app-connections/litellm/step-3.png)
            </Step>
        </Steps>
    </Tab>
    <Tab title="API">
