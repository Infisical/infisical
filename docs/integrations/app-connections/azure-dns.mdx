  ...
  **Prerequisites:**
  ...
  <Steps>
    <Step title="Navigate to your DNS Zone">
      In the Azure Portal, navigate to your DNS Zone that you want to use for ACME DNS validation. Select **Access control (IAM)** in the left sidebar, then select **Add** > **Add role assignment**.
