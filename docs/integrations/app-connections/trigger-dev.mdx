...
<Steps>
    <Step title="Open the account menu">
        In the [Trigger.dev dashboard](https://cloud.trigger.dev), click your account avatar in the top-right corner to open the account menu.
    </Step>
    <Step title="Navigate to 'Personal Access Tokens'">
        Select **Personal Access Tokens** from the menu.
    </Step>
    <Step title="Create a new token">
        Click **Create new token**, give the token a descriptive name, then create it.
    </Step>
