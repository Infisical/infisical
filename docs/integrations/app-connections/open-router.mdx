...
<Steps>
    <Step title="Navigate to Provisioning Keys">
        ...
        ![OpenRouter Provisioning Keys](/images/app-connections/open-router/step-1.png)
    </Step>
    <Step title="Create and Copy Key">
        ...
        ![OpenRouter Key Created](/images/app-connections/open-router/step-2.png)
    </Step>
</Steps>
    ...
    <Tab title="Infisical UI">
        <Steps>
            ...
            <Step title="Select OpenRouter Connection">
                ...
                ![Select OpenRouter Connection](/images/app-connections/open-router/open-router-app-connection-option.png)
            </Step>
            <Step title="Fill out Connection Form">
                ...
                ![OpenRouter Connection Form](/images/app-connections/open-router/open-router-app-connection-form.png)
            </Step>
            <Step title="Connection Created">
                After clicking **Create**, Infisical validates the key against OpenRouter's API. Your **OpenRouter Connection** is then ready to use for [OpenRouter API Key Secret Rotation](/documentation/platform/secret-rotation/open-router-api-key).

                ![OpenRouter Connection Created](/images/app-connections/open-router/open-router-app-connection-created.png)
            </Step>
        </Steps>
    </Tab>
    <Tab title="API">
        Create an OpenRouter connection via the [Create OpenRouter Connection](/api-reference/endpoints/app-connections/open-router/create) API endpoint.
...
- **OpenRouter API Key Secret Rotation**: Use this connection as the credential source for [automatically rotating OpenRouter API keys](/documentation/platform/secret-rotation/open-router-api-key), so your LLM-backed applications always use up-to-date keys with optional spending limits and reset schedules.
