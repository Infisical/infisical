...
Infisical supports connecting to Nutanix Prism Central using either a Basic Auth credentials or an API Key to manage SSL certificates on your clusters.
  ...
  <Tab title="Infisical UI">
    <Steps>
      ...
      <Step title="Fill in Connection Details">
        ...
        - **Reject Unauthorized SSL** (Optional): Disable this if your Prism Central instance uses a self-signed or untrusted TLS certificate.
