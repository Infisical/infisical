  ...
  <Tab title="Infisical UI">
    <Steps>
      <Step title="Gather Nutanix Credentials">
        You'll need the following from your Nutanix Prism Central instance:
      ...
      <Step title="Navigate to App Connections">
        In Certificate Manager, go to **Settings** > **App Connections** and select **Add Connection**.
...
<CardGroup cols={2}>
  <Card title="Nutanix Prism Central Sync" icon="refresh-cw" href="/documentation/platform/pki/applications/certificate-syncs/nutanix-prism-central">
