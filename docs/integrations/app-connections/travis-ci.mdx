...
<Steps>
  <Step title="Sign in to Travis CI and open your profile">
    Navigate to [https://app.travis-ci.com](https://app.travis-ci.com) and select your profile avatar in the top-right corner, then select **Settings**.
  </Step>
  <Step title="Copy your API Token">
    In the **Settings** tab, locate the **API authentication** section. Select **Copy Token** to reveal and copy your personal API token.
