  ...
  <Tab title="Infisical UI">
    <Steps>
      <Step title="Navigate to App Connections">
        Navigate to the **Organization Settings** page, then select **App Connections**. Select the **Add Connection** button.
...
<Steps>
    <Step title="Locate the Key ID of your Client Secret">
        Before enabling rotation, you'll need the **Key ID** of the Client Secret you're using to authenticate. Navigate to your App Registration in the Azure Portal, then go to **Certificates & secrets**. Copy the **Secret ID** (Key ID) of the secret you're providing to Infisical.
