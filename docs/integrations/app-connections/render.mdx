...
<Steps>
  <Step title="Access Account Settings">
    Navigate to your Render dashboard and select **Account Settings** in the
  ...
  <Step title="Generate API Key">
    ...
    select **Create API Key**. ![Create API
  ...
  <Step title="Name Your API Key">
    ...
    and select **Create API Key**. ![Name API
  ...
  <Step title="Save Your API Key">
    ...
    store this key as it won't be shown again.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Input API Key">
    Enter your Render API key in the provided field and select **Connect to
