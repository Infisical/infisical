...
<Note>
  This connection is for the DigiCert **CertCentral Services API**. If you're using DigiCert's
...
<Steps>
  <Step title="Navigate to API Keys">
    In your CertCentral account, go to **Automation** → **API Keys** and select **Add API Key**.
