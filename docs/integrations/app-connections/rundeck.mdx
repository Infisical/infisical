...
<Steps>
    <Step title="Open your Rundeck profile menu">
        Log in to your Rundeck instance and select the user icon in the top-right corner.
    ...
    <Step title="Add a new User API Token">
        In the **User API Tokens** section, select the **+** button.
    ...
    <Tab title="Infisical UI">
        <Steps>
            <Step title="Add a Rundeck Connection">
                ...
                select **App Connections**, and select **+ Add Connection**. Search for and select the
                **Rundeck** option.
