...
<Steps>
      ...
      <Tab title="Secret Rotation">
        <AccordionGroup>
          ...
          <Accordion title="Cloudflare R2 Access Key">
            ...
            ![Configure Token](/images/app-connections/cloudflare/cloudflare-r2-access-configure-permissions.png)
  ...
  <Step title="Save Your API Token">
    After creation, copy and securely store your API token as it won't be shown again.
  ...
  <Step title="Get Account ID">
    From your Cloudflare Account Home page, select the account information dropdown and select **Copy account ID**.
...
<Steps>
  ...
  <Step title="Input Credentials">
    ...
    select **Connect to Cloudflare** to establish the connection. ![Connect to
