...
<Steps>
  ...
  <Step title="Copy the generated key and save it">
    ...
    <Step title="Select and save the Checkly Account ID">
    ![Create Token](/images/app-connections/checkly/checkly-app-connection-copy-account-id.png)
  </Step>
</Steps>
  ...
  <Tab title="Infisical UI">
    <Steps>
      ...
      <Step title="Fill out the Checkly Connection form">
        ...
        - The Account ID from the previous step
