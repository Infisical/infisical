...
<Steps>
    <Step title="Navigate to 'Developer' and select 'Other'">
    ...
    <Step title="Configure Connect Server">
        ...
        2. Select "Choose Vaults" and select the vaults you want to connect
        3. For each selected vault, select **Edit Access** and **Enable All**
