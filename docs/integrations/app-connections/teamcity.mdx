...
<Steps>
    <Step title="Navigate to your profile on TeamCity">
        Navigate to the TeamCity **Profile** page by selecting your profile icon in the bottom-left corner.
    ...
    <Step title="Create the Access Token">
        Select the **Create access token** button and provide a name for your token (e.g., "Infisical Integration"). You may set an expiration date or leave it blank for no expiry.
        ...
        <Tabs>
            <Tab title="Infisical UI">
                ...
                4. Connection Created
                    ...
                    After you select **Connect to TeamCity**, your **TeamCity Connection** is established and ready to use with your Infisical project.
