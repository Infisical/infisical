        ...
        <Steps>
            ...
            <Step title="Configure Access Token Scopes">
                ...
                <Note>
                    ...
                    If you are plan to use this connection for [Datadog API Key Secret Rotation](/documentation/platform/secret-rotation/datadog-api-key), the token needs scopes to delete and read API Keys. Set `api_keys_delete` and `api_key_write` under **API and Application Keys**
                </Note>
