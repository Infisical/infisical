    ...
    <Tab title="Service Access Token (Recommended)">
        <Steps>
            ...
            <Step title="Configure Access Token Scopes">
                ...
                <Note>
                    If you plan to use this connection for [Datadog Application Key Secret Rotation](/documentation/platform/secret-rotation/datadog-application-key-secret), the token needs scopes to read users and manage Service Account Application Keys. Set `user_app_keys` under **API and Application Keys** and `service_account_write`, `user_access_manage`, and `user_access_read` under **Access Management**.

                    If you are plan to use this connection for [Datadog API Key Secret Rotation](/documentation/platform/secret-rotation/datadog-api-key), the token needs scopes to delete and read API Keys. Set `api_keys_delete` and `api_keys_write` under **API and Application Keys**
                </Note>


                ![Access Token Scopes](/images/app-connections/datadog/access-token-scopes.png)
            </Step>
