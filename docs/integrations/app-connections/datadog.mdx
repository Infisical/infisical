    ...
    <Tab title="Application Keys">
        <Steps>
            ...
            <Step title="Name the API Key">
                Provide a descriptive name for the API Key (e.g. `infisical-connection`) and select **Create Key**.
    ...
    <Tab title="Infisical UI">
        <Steps>
            ...
            <Step title="Select Datadog Connection">
                Select **Add Connection**, then select **Datadog** from the list of available connections.
