...
You need a **Provisioning API key** from OpenRouter. Provisioning keys are used only for key management (create, list, delete keys)—they can't be used for model completion requests.

## Create an OpenRouter provisioning API key

<Steps>
    <Step title="Navigate to Provisioning Keys">
        In [OpenRouter Settings](https://openrouter.ai/settings/provisioning-keys), go to **Provisioning API Keys** and select **Create New Key**.
    ...
    <Tab title="Infisical UI">
        <Steps>
            <Step title="Navigate to App Connections">
                In your Infisical dashboard, go to **Integrations** → **App Connections**, either in your organization or in a project.
