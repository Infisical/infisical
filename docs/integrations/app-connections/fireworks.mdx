...
<Steps>
    <Step title="Navigate to Settings">
        In your [Fireworks AI account](https://app.fireworks.ai/), select **Settings** in the left sidebar.
...
<Steps>
    <Step title="Navigate to App Connections">
        Navigate to the **App Connections** tab in your organization and select **+ Add Connection**. Select the **Fireworks** option.
