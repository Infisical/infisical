...
<Tabs>
    ...
    <Tab title="Personal Access Token">
        ...
        <Note>
            A **fine-grained** Personal Access Token is required. Classic tokens are not supported.
        </Note>

        ## Create a Fine-Grained Personal Access Token
            <Steps>
                <Step title="Create a Fine-Grained Personal Access Token in GitHub">
                    Navigate to your user Settings > Developer settings > Personal Access Tokens > **Fine-grained tokens** to create a new token.
                ...
                <Step title="Fill in the Personal Access Token details">
                    Fill in the fine-grained Personal Access Token details:
                    ...
                    <Warning>
                        For **private repositories**, the token owner must have **admin access** to the repository. Without admin access, the repository will not appear in the sync destination list.
                    </Warning>
