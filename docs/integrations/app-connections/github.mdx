    ...
    <Tab title="GitHub App (Recommended)">
        ...
        <Steps>
            ...
            <Step title="Authorize Connection">
                ...
                - **Shared app** — the instance-default GitHub App configured by your Infisical admin.
                - **Org-managed app** — a GitHub App registered under your GitHub organization. Select an existing one from the list, or click **Create new GitHub App** to register a new app directly from Infisical via GitHub's app manifest flow. The new app will be automatically configured with the correct permissions and callback URLs.
