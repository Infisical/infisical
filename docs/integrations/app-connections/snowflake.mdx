...
<Steps>
    ...
    <Step title="Configure user details and role">
        Provide a **Username** and assign a role. The role must have permission to create and manage secrets in the target database.

        ![Configure User](/images/app-connections/snowflake/step-3.png)

        If you decide to go with a custom role, you just need to run the following snippet, which grants the minimum privileges required for operations on specific tables and schemas. To do this, select the **Projects** tab and click on **Workspaces** to open the query editor.
    ...
    <Step title="Generate a Programmatic Access Token">
        ...
        ![Fill up PAT info](/images/app-connections/snowflake/step-6.png)
    </Step>
