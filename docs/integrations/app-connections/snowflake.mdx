    ...
    <Step title="Configure user details and role">
        ...
        <Tabs>
            ...
            <Tab title="Secret Rotations">
                For [Snowflake User Key Pair rotation](/documentation/platform/secret-rotation/snowflake-user-key-pair), the connection's role must be able to alter the target user whose key pair will be rotated. Grant a role that can manage the user and assign it to your connection user:
