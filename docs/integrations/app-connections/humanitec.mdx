...
<Steps>
    ...
    <Step title="Create the API Token for the Service User">
        ...
        <Note>
            If you configure an expiry date for your API token you'll need to manually rotate to a new token prior to expiration to avoid integration downtime.
        </Note>
    ...
    <Step title="Add Service User to Application">
        ...
        Selecting the App Title will open the App details page.
    ...
    <Step title="Fill the Humanitec Connection Modal">
        Fill the Humanitec Connection modal, here you'll need to provide the User Service API Token generated in the previous step.
