...
<Steps>
    ...
    <Step title="Access Administration API">
        From the Organization Management tabs, select **Administration API** to manage your API credentials and select the **Create client credentials** button.
