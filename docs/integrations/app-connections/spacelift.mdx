...
<Steps>
  ...
  <Step title="Configure Roles, Space, and Create">
    Select the roles **Space reader** and **Space writer**, choose the Space that will be managed by this credential, then click **Add** and **Create API Key**. A file will be downloaded containing your credentials.
