                    ...
                    <Tab title="External Certificate Authority">
                        <AccordionGroup>
                            <Accordion title="AWS Private CA">
                                ...
                                <Note>
                                    If you further restrict `IssueCertificate` with an `acm-pca:TemplateArn` condition, include every template Infisical uses, or issuance fails with a permission error:

                                    - `arn:aws:acm-pca:::template/BlankEndEntityCertificate_APICSRPassthrough/V1` for end-entity certificates
                                    - `arn:aws:acm-pca:::template/SubordinateCACertificate_PathLen{0,1,2,3}_APICSRPassthrough/V1` for [CA certificates](/documentation/platform/pki/ca/aws-pca#issuing-ca-certificates)
                                </Note>
                            </Accordion>
                ...
                <Tabs>
                    <Tab title="Infisical UI">
                        ...
                        <Note>
                            ...
                            or region-pinned STS endpoint) when the default `https://sts.amazonaws.com` is not reachable or desired.
                            Leave it blank to use AWS's default endpoint resolution.
                        </Note>
