...
import AzureOAuthAppConfigurationServicePrincipal from "/snippets/app-connections/azure/oauth-app-configuration-service-principal.mdx";
  ...
  **Prerequisites:**
  ...
  <Steps>
    <Step title="Create an application in Azure">
      Navigate to Entra ID > App registrations to create a new application.
        ...
        <Tabs>
            ...
            <Steps>
                <Step title="Fill in Connection Details">
                    ...
                    <AzureOAuthAppConfigurationServicePrincipal />
                </Step>
...
<Steps>
    <Step title="Locate the Key ID of your Client Secret">
        ...
        ![Azure Client Secret Key ID](/images/app-connections/azure/devops/credential-rotation-key-id.png)
    </Step>
    <Step title="Enable Automatic Credential Rotation">
        ...
        ![Enable Automatic Credential Rotation](/images/app-connections/azure/devops/credential-rotation-toggle.png)
    </Step>
    <Step title="Provide the Client Secret Key ID">
        ...
        ![Client Secret Key ID Field](/images/app-connections/azure/devops/credential-rotation-key-id-field.png)
    </Step>
    <Step title="Configure the Rotation Schedule">
        ...
        ![Rotation Schedule](/images/app-connections/azure/devops/credential-rotation-schedule.png)
    </Step>
</Steps>
