...
<Steps>
    ...
    <Step title="Click 'Create Policy'">
        ![Select Create Policy](/images/app-connections/oci/click-create-policy.png)
    </Step>
    <Step title="Create policy">
        The name and description can be anything. Select 'Show manual editor' and paste in the policy rules relevant to your task:
