...
<Note>
  DigitalOcean requires the token to have **read and write** permissions to manage resources programmatically.
</Note>
...
<Steps>
  ...
  <Step title="Provide a name and select appropriate scopes">
    Give your token a descriptive name and ensure required scope (full-access) is selected.
