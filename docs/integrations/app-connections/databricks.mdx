...
<Steps>
    ...
    <Step title="Manage Service Principals">
        Under the **Identity & Access** tab, select the **Manage** button in the **Service Principals** section.
...
<Steps>
  ...
  <Step title="Authorize Connection">
    Select the **Service Principal** method, add your **workspace URL** and **service principal credentials**, then select **Connect to
