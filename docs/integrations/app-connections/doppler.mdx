...
<Steps>
  ...
  <Step title="Navigate to the Service Accounts section">
    In the User Tokens page, select in **Manage service accounts** .

    ![Doppler Service Accounts](/images/app-connections/doppler/manage-service-accounts.png)
  </Step>
  <Step title="Create Service Account">
    Select in the "+" icon, provide a descriptive name, and confirm creation.
  ...
  <Step title="Assign permissions to the service account">
    Select the pencil icon next to your service account role to modify the role of the service account.
    ![Doppler Service Account Role](/images/app-connections/doppler/doppler-service-account-select-role.png)
  ...
  <Step title="Click in create service account token">
    Select in the "+" icon in the Service Account API Tokens container
  ...
  <Step title="Add a name for the API Token">
    Add a name for the API Token and select in Create API Token

    ![Doppler Token Created](/images/app-connections/doppler/create-api-token.png)
  </Step>
  <Step title="Copy the generated token">
    Copy the generated token and save it, you'll need it in the next steps
