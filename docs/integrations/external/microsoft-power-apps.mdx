...
<Note>
Windows-based Azure Functions have broader tooling support than Linux. For example, Linux-based functions can't be edited from within the Azure Management Portal.
</Note>
