...
<Tabs>
    <Tab title="Infisical UI">
        ...
        ![Configure Destination](/images/secret-syncs/external-infisical/external-infisical-destination.png)
            ...
            - **Project**: The Secrets Manager project on the remote Infisical instance to sync secrets to.
    ...
    <Tab title="API">
        To create an **Infisical Sync**, make an API request to the [Create Infisical Sync](/api-reference/endpoints/secret-syncs/external-infisical/create) API endpoint.
