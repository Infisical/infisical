...
<Steps>
    ...
    <Step title="Configure the app connection" titleSize="h3">
        The sync needs an [app connection](/integrations/app-connections) to authenticate to Databricks.
        
        Under **Databricks Connection**, select an existing app connection, or select **Create Connection** and choose **Databricks Connection**. Select the **Service Principal** method, then fill in:
