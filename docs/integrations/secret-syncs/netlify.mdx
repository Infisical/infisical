    ...
    <Steps>
      ...
      <Step title="Configure Sync Options">
        ...
        - **Initial Sync Behavior**: Determines how Infisical should resolve the initial sync.
            - **Import - Prefer values from Infisical**: Import secrets from Netlify to Infisical; if a secret with the same name already exists in Infisical, do nothing. Afterwards, sync secrets to Netlify.
            - **Import - Prefer values from Netlify**: Import secrets from Netlify to Infisical; if a secret with the same name already exists in Infisical, replace its value with the one from Netlify. Afterwards, sync secrets to Netlify.
