  ...
  <Tab title="Infisical UI">
    <Steps>
      ...
      <Step title="Configure destination">
        ...
        - **Account ID**: The Netlify Account to be used.
        - **Site ID**: The Netlify site where secrets should be synced.
      ...
      <Step title="Configure Sync Options">
        ...
        <Note>
          Netlify does not support importing existing secrets.
        </Note>
  ...
  <Tab title="API">
    ...
    curl    --request POST \
            ...
            --data '{
                ...
                "destinationConfig": {
                    "siteId": "site-abc123",
                    "siteName": "netlify-marketing-site",
                    "context": "dev"
                }
            }'
    ```
