...
secret in the destination that doesn't match the schema is left alone, so a sync can share a
...
[Gateway](/documentation/platform/gateways/overview), a lightweight service you deploy inside your
...
Some destinations can read secrets back; GitHub can't. For those, **Initial Sync Behavior** lets you
...
<Note>
  If you need help planning a migration, or the service you use isn't yet
  available as a Secret Sync, contact us at support@infisical.com.
</Note>
