...
**Private networks.** Native Integrations could only reach destinations Infisical
could contact directly. Secret Syncs can route through an Infisical
[Gateway](/documentation/platform/gateways/overview): a lightweight service you
deploy inside your network that opens an outbound tunnel. Syncs can
then reach self-hosted or private destinations—such as GitHub Enterprise Server,
HashiCorp Vault, or a private Azure Key Vault endpoint—without opening inbound
firewall rules.
