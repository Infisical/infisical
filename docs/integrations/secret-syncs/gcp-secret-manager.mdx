...
**Prerequisites:**
        ...
        - Enable **Cloud Resource Manager API**, **Secrets Manager API**, and **Service Usage API** on your GCP project
...
<Tabs>
    <Tab title="Infisical UI">
        ...
        8. Review your Secrets Manager Sync configuration, then click **Create Sync**.
        ![Confirm Configuration](/images/secret-syncs/gcp-secret-manager/step-7.png)

    </Tab>
    <Tab title="API">
        To create a **GCP Secrets Manager Sync**, make an API request to the [Create GCP
        Secrets Manager Sync](/api-reference/endpoints/secret-syncs/gcp-secret-manager/create) API endpoint.
