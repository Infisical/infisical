---
title: "Changelog"
description: "Monthly summary of new Infisical product developments and updates."
---
...
- Added support for [OIDC group mapping](https://infisical.com/docs/documentation/platform/sso/general-oidc/overview) to automatically map groups to Infisical for role-based access control.
...
- Added [Hardware Security Module (HSM) Encryption](https://infisical.com/docs/self-hosting/guides/hsm-integration) support.
...
- Added Dynamic Secrets for [Elasticsearch](https://infisical.com/docs/documentation/platform/dynamic-secrets/elastic-search) and [MongoDB](https://infisical.com/docs/documentation/platform/dynamic-secrets/mongo-db). 
...
- Released [Linux installer for Infisical](https://infisical.com/docs/self-hosting/deployment-options/native/linux-package/installation).
...
- Released universal [Audit Log Streaming](https://infisical.com/docs/documentation/platform/audit-log-streams/audit-log-streams). 
...
- Released [PostgreSQL-based Infisical helm chart](https://cloudsmith.io/~infisical/repos/helm-charts/packages/detail/helm/infisical-standalone/).
...
## Jan 2024
- Completed PostgreSQL migration initiative with restructured Fastify-based backend.
- Reduced size of Infisical Node.js SDK by ≈90%.
- Added secret fallback support to all SDKs.
...
- Added symmetric encryption support to all SDKs.
...
- Released first version of the [Infisical Agent](https://infisical.com/docs/integrations/platforms/infisical-agent)
...
- Improved password requirements including check against [Have I Been Pwned Password API](https://haveibeenpwned.com/Passwords).
...
- Released customer / license service to manage customer billing information, cloud plans, and self-hosted enterprise licenses; all Infisical instances now fetch/relay information from this service.
- Completed penetration test.
- Released new landing page.
- Started SOC 2 (Type II) compliance certification preparation.
- Released new deployment options for Fly.io, DigitalOcean and Render.
