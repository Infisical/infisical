...
- Improved password requirements incl. a secure check against >700 mln breached passwords via the [Have I Been Pwnd Password API](https://haveibeenpwned.com/Passwords).
