...
<Update label="January 2026" description="Monthly Update">
- Released [PKI approval workflows](https://infisical.com/docs/documentation/platform/pki/overview) for certificate request management.
- Added [MCP server gateway support](https://infisical.com/docs/documentation/platform/gateways/overview) for agent-based deployments.
- Implemented user account recovery functionality.
- Added show/hide password toggle to login page for improved UX.
- Released organization role API for identity and external use.
- Added support for Azure SAML "Sign assertion only" configuration.
- Improved MFA unlock email handling with keystore lockout mechanism.
- Added validation for disposable emails in organization invites.
- Enabled URL sharing for secret approval change requests.
- Added machine identities and groups to [project templates](https://infisical.com/docs/documentation/platform/project-templates).
</Update>

<Update label="December 2025" description="Monthly Update">
- Added [sub-organization scope support](https://infisical.com/docs/documentation/platform/organization/overview) for enterprise deployments.
- Improved certificate request endpoints and workflows.
- Fixed project templates role editing and creation issues.
- Enhanced gateway helm permissions handling.
</Update>

<Update label="November 2025" description="Monthly Update">
- Released [PKI V3](https://infisical.com/docs/documentation/platform/pki/overview) with comprehensive documentation updates.
- Added support for exporting certificates in PKCS12 format.
- Launched [project identities](https://infisical.com/docs/documentation/platform/identities/overview) feature for improved access management.
- Added [LDAP gateway support](https://infisical.com/docs/documentation/platform/gateways/overview) for enterprise directory integration.
- Released [ACME external CA support](https://infisical.com/docs/documentation/platform/pki/acme-ca) with DigiCert integration.
- Added PKI template presets for common certificate configurations.
- Implemented user login and organization selection audit logs.
- Enabled mobile view support for the Infisical dashboard.
- Added systemd interactive deployment option for Gateway and Relay.
- Released compliance documentation for regulated industries.
</Update>

<Update label="October 2025" description="Monthly Update">
- Released [PAM Platform V1](https://infisical.com/docs/documentation/platform/pam/overview) for privileged access management.
- Launched [Gateway V2](https://infisical.com/docs/documentation/platform/gateways/overview) with relay deployment CLI command helper.
- Added [Certificate Syncs](https://infisical.com/docs/documentation/platform/pki/overview) with Azure Key Vault sync support.
- Released [Redis app connection](https://infisical.com/docs/integrations/app-connections/overview) and secret rotation.
- Added [Azure SQL Database dynamic secret](https://infisical.com/docs/documentation/platform/dynamic-secrets/azure-sql) support.
- Implemented [SAML group mapping](https://infisical.com/docs/documentation/platform/sso/saml) for automatic group synchronization.
- Released [Infisical Version Upgrade Tool](https://infisical.com/docs/self-hosting/overview) for easier self-hosted upgrades.
- Added certificate auto-renewal and manual renewal workflows.
- Released [PKI sync for AWS Certificate Manager](https://infisical.com/docs/documentation/platform/pki/overview).
- Added health check alerts for relays and gateways.
- Improved secret replication and folder discovery UX.
</Update>

<Update label="September 2025" description="Monthly Update">
- Released [User Notifications](https://infisical.com/docs/documentation/platform/notifications) system for in-app alerts.
- Added [Cribl](https://infisical.com/docs/documentation/platform/audit-log-streams) support for audit log streaming.
- Implemented [Google SSO enforcement](https://infisical.com/docs/documentation/platform/sso/google) at the organization level.
- Released [Microsoft ADCS PKI Connector](https://infisical.com/docs/documentation/platform/pki/overview) for enterprise certificate management.
- Added [Universal Auth Login Lockout](https://infisical.com/docs/documentation/platform/identities/universal-auth) for enhanced security.
- Released [External CA EAB Support](https://infisical.com/docs/documentation/platform/pki/external-ca) with DigiCert documentation.
- Added [Vault migration](https://infisical.com/docs/documentation/platform/secret-migration) gateway support and KV v1 compatibility.
- Implemented [GitHub Bulk Team Sync](https://infisical.com/docs/integrations/platforms/github) for organization-wide team management.
- Revamped secret dashboard with improved overview and environment views.
- Added `InstantUpdates` support in [Kubernetes operator](https://infisical.com/docs/integrations/platforms/kubernetes/overview).
- Released [Render environment groups](https://infisical.com/docs/integrations/cloud/render) and [Checkly group variables](https://infisical.com/docs/integrations/cloud/checkly) support.
</Update>

<Update label="August 2025" description="Monthly Update">
- Introduced formal [release channels](https://infisical.com/docs/self-hosting/guides/releases) with nightly builds for self-hosted deployments.
- Improved secret sidebar and table row UX with better design and interactions.
- Removed organization admin console in favor of streamlined admin workflows.
- Docker tags no longer contain the `-postgres` suffix for simplified deployment.
- Enhanced audit log display to show all integration events.
- Improved error notifications for dynamic secret operations.
</Update>
