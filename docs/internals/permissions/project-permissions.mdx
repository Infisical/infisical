...
| `grant-privileges` | Legacy: Change permission levels of project members | `email`, `role`, `subject`, `action` |
| `assign-role`      | Assign or update roles for project members  | `email`, `role` |
| `assign-additional-privileges` | Grant additional privileges to project members | `email`, `subject`, `action` |
...
| `grant-privileges` | Legacy: Change permission levels of project groups | `groupName`, `role` |
| `assign-role`      | Assign or update roles for project groups  | `groupName`, `role` |
...
| `grant-privileges` | Legacy: Change permission levels of project identities | `identityId`, `role`, `subject`, `action` |
| `assign-role`      | Assign or update roles for project identities  | `identityId`, `role` |
| `assign-additional-privileges` | Grant additional privileges to project identities | `identityId`, `subject`, `action` |
...
| `email` | User email - The email address of the user whose roles are being updated | `string` |
| `groupName` | Group name - The name of the group whose roles are being updated | `string` |
| `role` | Assignable roles - The roles that can be assigned to other members | `string` |
| `subject` | Assignable subjects - The permission subjects that can be granted in additional privileges | `string` |
| `action` | Assignable actions - The permission actions that can be granted in additional privileges. Format: `subject:action` (e.g., `secrets:read`) | `string` |
