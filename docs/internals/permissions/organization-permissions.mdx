...
| `edit-auth`        | Modify authentication methods for identities        |
...
| Action                     | Description                                                                                   |
| -------------------------- | --------------------------------------------------------------------------------------------- |
| `read`                     | View secrets management insights                                                              |
| `generate-report`          | Generate new secrets management insight reports                                               |
| `delete-report`            | Delete secrets management insight reports                                                     |
| `search-all-secret-values` | Find secrets that share a value in any project, including projects the user isn't a member of |
