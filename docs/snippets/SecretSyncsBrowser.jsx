...
export const SecretSyncsBrowser = () => {
  ...
  const syncs = [
    ...
    {"name": "Spacelift", "slug": "spacelift", "path": "/integrations/secret-syncs/spacelift", "description": "Learn how to sync secrets from Infisical to Spacelift.", "category": "DevOps Tools"},
