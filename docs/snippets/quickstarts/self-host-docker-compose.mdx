...
<div style={{ position: "relative", paddingBottom: "56.25%", height: 0, overflow: "hidden", maxWidth: "100%" }}>
  <iframe
    src="https://www.youtube.com/embed/cr-e7Zp9UtE"
...
<Warning>
  This Docker Compose configuration isn't designed for high-availability production scenarios. 
...
<Steps>
  ...
  <Step title="Configure environment variables">
    Infisical requires a set of credentials used for connecting to dependent services such as PostgreSQL, Redis, etc. The default credentials can be downloaded using one of the commands listed below.
