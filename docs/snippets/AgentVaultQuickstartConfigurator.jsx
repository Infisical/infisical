...
const KNOWN_SERVICE_IDS = new Set([...Object.keys(SERVICE_ICONS), "custom"]);
const KNOWN_AGENT_IDS = new Set(Object.keys(AGENT_ICONS));

const normalizeSelection = (raw, known) =>
  raw && known.has(raw) ? raw : null;
...
export const AgentVaultQuickstartPicker = () => {
  ...
  useEffect(() => {
    const sync = () => {
      ...
      setSelection({
        service: normalizeSelection(params.get("service"), KNOWN_SERVICE_IDS),
        agent: normalizeSelection(params.get("agent"), KNOWN_AGENT_IDS),
      });
    };
    sync();
