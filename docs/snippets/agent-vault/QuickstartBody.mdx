...
<AccordionGroup>
  ...
  <Accordion title="403 from the proxy">
    ...
    - The service covers the host, but doesn't allow the request's method or path (check the service's [methods and paths](/documentation/platform/agent-vault/services#methods-and-paths))
  </Accordion>
</AccordionGroup>
