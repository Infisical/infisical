...
export const UserAuthenticationBrowser = () => {
  ...
  const authMethods = [
    ...
    {"name": "General OIDC", "slug": "general-oidc-sso", "path": "/documentation/platform/sso/general-oidc/overview", "description": "Learn how to configure generic OIDC providers for SSO in Infisical.", "category": "SSO"},
