...
<Tabs>
  <Tab title="Create secrets manually">
    ...
    <Steps>
      ...
      <Step>
        ...
        <Frame>
          ![Create Secret panel](/snippets/documentation/platform/secrets-mgmt/assets/key-value-fields.png)
        </Frame>
      </Step>
      <Step>
  ...
  <Tab title="Import secrets from an existing file">
    ...
    <Steps>
      ...
      <Step>
        In the **Target Environments** field, select the environments to upload the secrets to.
      </Step>
      <Step>
