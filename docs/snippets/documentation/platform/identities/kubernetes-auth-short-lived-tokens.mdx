  ...
  <Step title="Add the identity to a project">
    To allow the operator to use the given identity to access secrets, you'll need to add the identity to project(s) that you would like to grant it access to.
