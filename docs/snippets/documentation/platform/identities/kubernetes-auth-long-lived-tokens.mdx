<Accordion title="Manual long-lived service account tokens">
      Manual long-lived service account tokens are created as Kubernetes secrets and remain valid until deleted or rotated. In most cases, use short-lived service account tokens instead because they're easier to operate and reduce the lifetime of exposed credentials.
