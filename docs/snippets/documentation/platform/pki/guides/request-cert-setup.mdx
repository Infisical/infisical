...
<Step title="Create a certificate template">
    Next, follow the guide [here](/documentation/platform/pki/certificates/templates#guide-to-creating-a-certificate-template) to create a [certificate template](http://localhost:3000/documentation/platform/pki/certificates/templates).
