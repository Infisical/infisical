<Step title="Configure a Certificate Authority">
    <Note>
      **Platform Admin** — This step sets up organizational PKI infrastructure.
    </Note>
    ...
    <Tip>
        If you're looking to issue self-signed certificates, you can skip this step and proceed to Step 3.
    </Tip>

</Step>
<Step title="Create a certificate policy">
    <Note>
      **Platform Admin** — Policies define rules for certificate content.
    </Note>
    
    Next, follow the guide [here](/documentation/platform/pki/settings/policies) to create a [certificate policy](/documentation/platform/pki/settings/policies).
