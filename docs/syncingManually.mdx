...
Once you've done that, return here to connect the workspace to your local project.

### Step 1: Pull your .env file from Infisical

Navigate to your root project folder containing your .env file. Now run the command below. If it's your first time, then follow the prompt to log in and connect the project to your workspace:
