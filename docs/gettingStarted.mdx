...
Head to [https://infisical.com](https://infisical.com/) to make an account and create a workspace for your project. Once you've made an account, you'll be prompted to a dashboard with some placeholder environment variables. Go ahead and replace the placeholder environment variables with your environment variables from your .env file.

Note: The dashboard allows you to view one workspace at a time, and each workspace has a unique identifier that's important to connect it to your project in subsequent steps.

### Step 2 (Optional): Invite your dev team

Navigate to the “Team” tab in the left sidebar and invite your teammates to the workspace by submitting their emails. They'll each receive an email invitation to join the workspace and get access to the environment variables. A few things to note about invitations due to how our public-key cryptography works:
...
Infisical offers two approaches for you to sync and connect your environment variables from a workspace to your project:
...
Refer to the sections corresponding to the two approaches to continue connecting the workspace to your project.
