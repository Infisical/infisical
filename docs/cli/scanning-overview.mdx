...
To customize the scan, such as specifying your own rules or establishing exceptions for certain files or paths that shouldn't be flagged as risks, you can define these specifications in the configuration file.
