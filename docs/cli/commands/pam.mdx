---
title: "infisical pam"
description: "Access databases, SSH servers, Kubernetes clusters, AWS IAM roles, GCP service accounts, and Windows servers through Infisical's Privileged Access Management"
---
...
The `infisical pam` command provides privileged access management capabilities for securely accessing databases, SSH servers, Kubernetes clusters, AWS IAM roles, GCP service accounts, and Windows/RDP servers through Infisical's Gateway.
...
Access PAM-managed resources through Infisical's Gateway. This unified command handles all resource types — databases, SSH servers, Kubernetes clusters, AWS IAM roles, GCP service accounts, and Windows/RDP servers. The account type is determined by the template assigned to the account.
