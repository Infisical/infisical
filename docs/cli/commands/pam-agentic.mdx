...
<Note>
  For the full picture, including what the agent is told, what the sandbox does and doesn't protect, and how gated accounts behave mid-run, see [AI Agents](/documentation/platform/pam/ai-agents/overview). To open a single account for yourself instead, use [`infisical pam access`](/cli/commands/pam).
</Note>
