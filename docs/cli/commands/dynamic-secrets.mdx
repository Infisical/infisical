...
<Accordion title="--projectSlug">
  The project slug to fetch dynamic secrets from.

```bash
# Example
infisical dynamic-secrets --projectSlug=<project-slug>
```
...
```bash
# Example
infisical dynamic-secrets lease create <dynamic-secret-name> --projectSlug=<project-slug>
```
...
```bash
# Example
infisical dynamic-secrets lease list <dynamic-secret-name> --projectSlug=<project-slug>
```
...
```bash
# Example
infisical dynamic-secrets lease renew <lease-id> --projectSlug=<project-slug>
```
...
```bash
# Example
infisical dynamic-secrets lease delete <lease-id> --projectSlug=<project-slug>
```
