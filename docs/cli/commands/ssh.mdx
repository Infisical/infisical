...
[Infisical SSH](/documentation/platform/pam/getting-started/resources/ssh) lets you issue SSH credentials to clients to provide short-lived, secure SSH access to infrastructure.
