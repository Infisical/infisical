...
<ParamField query="Flags">
  <Expandable title="properties">
    ...
    <ParamField query="organization-id" type="string" optional>
      ...
      and `--email`. This flag also accepts a sub-organization ID if you want to
      authenticate directly into a [sub-organization](/documentation/platform/sub-organizations).
    </ParamField>
...
<AccordionGroup>
  ...
  <Accordion title="--password">
    ...
    This flag also accepts a sub-organization ID if you want to authenticate directly into a [sub-organization](/documentation/platform/sub-organizations).
...
<Accordion title="infisical login status" defaultOpen="true">
  ...
  - **User session**: the active login stored in your system keyring (or the configured [vault](./vault)).
