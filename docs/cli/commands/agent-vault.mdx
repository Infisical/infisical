...
```bash
# Example
infisical agent-vault run --access-bundle coding-agent --proxy 10.0.1.5:17323 -- claude
```
...
```bash
# Example
infisical agent-vault run --access-bundle coding-agent --ttl 8h --proxy 10.0.1.5:17323 -- claude
```
...
```bash
# Example
infisical agent-vault run --access-bundle coding-agent --keep-session --proxy 10.0.1.5:17323 -- claude
```
...
```bash
# Example
infisical agent-vault run --access-bundle coding-agent --proxy 10.0.1.5:17323 --ca-file /tmp/agent-vault-ca.pem -- claude
```
...
```bash
# Example
infisical agent-vault run --access-bundle coding-agent --proxy 10.0.1.5:17323 --no-proxy internal.corp.com -- claude
```
...
```bash
# Example
infisical agent-vault run --access-bundle coding-agent --client-id <client-id> --client-secret <client-secret> --proxy 10.0.1.5:17323 -- claude
```
