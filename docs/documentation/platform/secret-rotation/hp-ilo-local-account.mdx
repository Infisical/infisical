...
<Note>
  **Rotation Type: [Single-Phase](/documentation/platform/secret-rotation/overview#single-phase-rotation)**
  ...
  This is a limitation of the iLO provider and can't be rectified by Infisical.
</Note>

<Warning>
  **iLO Password Constraints**

  HP iLO has a maximum password length of **39 characters**. Infisical uses iLO-specific defaults (39 characters, no symbols) to ensure compatibility. If you customize password requirements, ensure the total length doesn't exceed 39 characters.
</Warning>
