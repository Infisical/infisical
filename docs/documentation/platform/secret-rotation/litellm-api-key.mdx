...
<Tabs>
    <Tab title="Infisical UI">
        ...
        ![Select LiteLLM API Key](/images/secret-rotations-v2/litellm-api-key/select-litellm-api-key.png)

        3. Configure the rotation behavior, then click **Next**.

        ![Rotation Configuration](/images/secret-rotations-v2/litellm-api-key/configuration.png)

        - **LiteLLM Connection** – The connection (with a management-capable API key) that will create and delete API keys during rotation.
        ...
        ![Rotation Parameters](/images/secret-rotations-v2/litellm-api-key/parameters.png)
        ...
        **Advanced**
        ...
        ![Rotation Secrets Mapping](/images/secret-rotations-v2/litellm-api-key/secrets-mapping.png)

        - **API Key** – The name of the secret in Infisical where the rotated API key value will be stored.

        6. Give your rotation a name and description (optional). Then click **Next**.

        ![Rotation Details](/images/secret-rotations-v2/litellm-api-key/details.png)
        ...
        ![Rotation Review](/images/secret-rotations-v2/litellm-api-key/review.png)
        ...
        ![Rotation Created](/images/secret-rotations-v2/litellm-api-key/created.png)
    </Tab>
    <Tab title="API">
