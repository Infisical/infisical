...
<CardGroup cols={2}>
  <Card title="Zero downtime" icon="clock">
    Applications always have valid credentials via the dual-user strategy.
  </Card>
  <Card title="Grace period" icon="hourglass">
    Overlapping validity gives apps time to update without breaking.
  </Card>
  <Card title="Reduced risk" icon="shield-check">
    Regular cycling limits the window of opportunity for attackers.
  </Card>
  <Card title="Predictable schedule" icon="calendar">
    Systematic rotation makes automation reliable and audit-friendly.
  </Card>
</CardGroup>

## Set up rotation

To get started with Secret Rotation, refer to the list of [supported integrations](/integrations/secret-rotations) and follow the instructions for your specific service.
