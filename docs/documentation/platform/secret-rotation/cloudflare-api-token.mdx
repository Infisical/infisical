...
<Tabs>
    <Tab title="Infisical UI">
        ...
        ![Rotation Configuration](/images/secret-rotations-v2/cloudflare-api-token/step-1.png)
        ...
        ![Rotation Parameters](/images/secret-rotations-v2/cloudflare-api-token/step-2.png)
        ...
        ![Restrictions](/images/secret-rotations-v2/cloudflare-api-token/restrictions-api-token.png)
        ...
        ![Rotation Secrets Mapping](/images/secret-rotations-v2/cloudflare-api-token/step-3.png)
        ...
        ![Rotation Details](/images/secret-rotations-v2/cloudflare-api-token/step-4.png)

        7. Review your configuration, then click **Create Secret Rotation**.

        ![Rotation Review](/images/secret-rotations-v2/cloudflare-api-token/step-5.png)
        ...
        ![Rotation Created](/images/secret-rotations-v2/cloudflare-api-token/step-6.png)
