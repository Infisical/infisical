...
<Tabs>
  <Tab title="Infisical Cloud">
    ...
    <Steps>
      <Step title="Open Integrations in your organization">
        In order to use Slack integration in your projects, you'll first have to
        configure a Slack workflow integration in your organization. Go to **Integrations** and select the **Workflow Integrations** tab.
      ...
      <Step title="Install Slack app to workspace">
        Select **Add integration**, then select **Slack**.
        ![org-slack-initial-add](/images/platform/workflow-integrations/slack-integration/org-slack-integration-initial-add.png)

        Give your Slack integration a descriptive alias. You'll use this to select the Slack integration for your project.
        ![org-slack-add-form](/images/platform/workflow-integrations/slack-integration/org-slack-integration-add-form.png)

        Select **Connect Slack**. This opens up the Slack app installation flow. Select the Slack workspace you want to install the custom Slack app to and select **Install Infisical**.
    ...
    <Steps>
      <Step title="Open Workflow Integrations in the project settings">
        Go to the project's **Settings**, select **Workflow Integrations**, select **Add integration**, then select **Slack**.
      ...
      <Step title="Configure the Slack notification settings for the project and select Save">
  ...
  <Tab title="Self-hosted setup">
    ...
    <Steps>
      <Step title="Open Integrations in the Server Console">
        Before anything else, you need to setup the Slack app to be used by
        your Infisical instance. Because you're self-hosting, you'll need to
        create this Slack application as demonstrated in the preceding step.

        Select **Server Console**, go to **Integrations**, and expand **Slack**. Select
        **Create Slack app**. This will open up a new window with the custom app
        creation flow on Slack.
      ...
      <Step title="Create Slack app">
        ...
        The configuration values of your custom Slack app will be pre-filled for you. You can view or edit the app manifest by selecting **Edit Configurations**.
        ![admin-slack-app-summary](/images/platform/workflow-integrations/slack-integration/admin-slack-integration-app-summary.png)

        Once everything's confirmed, select **Create**.
      ...
      <Step title="Input app credentials from Slack">
        ...
        Complete the admin setup by selecting **Save**.
      </Step>
...
<Steps>
  ...
  <Step title="Find the private channel you want to set up notifications for and select Add">
    ![private slack setup
