  ...
  <Tab title="Self-hosted setup">
    ...
    <Steps>
      <Step title="Open Integrations in the Server Console">
        Select **Server Console**, then go to **Integrations**.
...
<Accordion title="Workflow Integration is stuck on 'Pending' status">
  ...
  You can manually recheck the installation status by selecting **Check Installation Status** on the workflow integration in your organization.
