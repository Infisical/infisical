...
| ------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Requests never appear in ServiceNow         | The policy isn't set to the ServiceNow approver type, or the environment and secret path on the policy don't match the request. Check the Infisical audit log for the delivery attempt. |
...
| Callback Failed with HTTP 401 or 403        | The machine identity is missing the **Review** permission on **External Approvals** for the organization, or it isn't the approver identity configured on the policy.        |
