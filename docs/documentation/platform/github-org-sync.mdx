...
<Steps>
    <Step title="Set up GitHub organization configuration">
        ...
        2. Select the **Configure** button and provide the name of your GitHub Organization.
...
When a user logs in via the GitHub OAuth flow and selects the configured organization, the system will then automatically synchronize the teams they're a part of in GitHub with corresponding groups in Infisical.
