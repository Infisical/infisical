...
The Projects tab lists all the projects within your organization, including those which you aren't a member of. You can easily filter projects by name or slug using the search bar.

![Projects Section](/images/platform/admin-panels/org-admin-console-projects.png)

### Accessing a project in your organization

You can access a project that you aren't a member of by selecting on the options menu of the project row and pressing the **Access** button.
