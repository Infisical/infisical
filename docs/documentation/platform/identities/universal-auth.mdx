...
<AccordionGroup>
  ...
  <Accordion title="How do I reset a lockout?">
      You can reset (remove) all lockouts for an identity auth method by opening the auth method and pressing **Reset All Lockouts**.
