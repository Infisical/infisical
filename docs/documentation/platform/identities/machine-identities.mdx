...
Open the machine identity you want to monitor and find the **Alert** row in its details. Select the bell icon to create one.
...
With **Daily Reminder** off, each credential triggers the alert once. Turn it on for credentials you can't afford to miss, and you'll get one notification per day until the credential expires or is rotated.
