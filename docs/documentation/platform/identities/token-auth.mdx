...
<Steps>
  <Step title="Creating an identity">
    ...
    - Access Token Max TTL (default is `2592000`  equivalent to 30 days): The maximum lifetime for an access token in seconds. This value will be referenced at renewal time. A [credential expiry alert](/documentation/platform/identities/machine-identities#credential-expiration) notifies your team before a token reaches it.
