...
<Steps>
  <Step title="Creating an identity">
    ...
    When creating an identity, you specify an organization level role for it to assume; you can configure roles in **Access Control** > **Roles**.
  ...
  <Step title="Configuring LDAP auth for your identity">
    ...
    **Advanced Tab**
    ...
    Once you've filled out the form, select **Add** to save your changes.
