...
<Steps>
  ...
  <Step title="Scope Agent Injector or Operator access">
    When using the [Infisical Agent Injector](/integrations/platforms/kubernetes-injector) or [Operator](/integrations/platforms/kubernetes), configure namespace-scoped access rather than cluster-wide permissions.
  </Step>
</Steps>
