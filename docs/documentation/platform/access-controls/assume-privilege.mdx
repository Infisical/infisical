...
<Steps>
   ...
   Select the user or identity you want to assume.
   ...
   Select **Assume Privilege**, then type `assume` to confirm and start your session.
   ...
   You'll see a yellow banner indicating that your assume privilege session is active. You can exit at any time by selecting **Exit**.
