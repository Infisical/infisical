...
Removes a suffix from a string. The suffix can be a whole word or a glob pattern. If the
end of the string does not match the pattern, the string is returned unchanged.
