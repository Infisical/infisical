...
The Project Access Request feature allows users to view all projects within an organization, including those they don't currently have access to.
...
1. Select **Request Access** next to the project name
