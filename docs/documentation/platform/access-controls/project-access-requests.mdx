...
1. Click on **Request Access** button next to the project name
...
This action can be only be performed by Organization Admins or users with the permission `Access all organization projects`.
...
1. Click on **Gain Access** button next to the project name
   ![all-project-view](/images/platform/project-access-requests/gain-access.png)

2. Type **access** to confirm your action
