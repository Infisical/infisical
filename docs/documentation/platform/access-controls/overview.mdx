...
To make sure that users and machine identities are only accessing the resources and performing actions they're authorized to, Infisical supports a wide range of access control tools. 
