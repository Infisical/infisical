...
- **Member**: Can access projects they're added to and perform day-to-day actions, but is restricted from removing organization members, modifying billing information, updating organization-level access controls, and performing other administrative actions. This is the default role assigned to new members.
...
- **Viewer**: Read-only access to all resources within the project. Viewers can't create, edit, or delete any resources.
...
<Info>
Custom roles are available on the **Enterprise plan**. Built-in roles (Admin, Member, Viewer, No Access) are available on all plans, including free self-hosted.
</Info>
...
To create a custom role, navigate to the **Access Control** page for your organization or project, open the **Roles** tab, and select **Create** for an organization role or **Add Project Role** for a project role.
