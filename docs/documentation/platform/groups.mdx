...
<Steps>
   ...
   <Step title="Adding identities to the group">
        Next, you'll want to assign identities (users and/or machine identities) to the group. To do this, select the group row to open the group details page and select the **+** button.
