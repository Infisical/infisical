...
Infisical requires an AWS IAM user with the necessary permissions. This will be the managing user who will create new users, new access keys, attach policies and remove all on clean up.
...
To minimise managing user access you can attach a resource in format 
