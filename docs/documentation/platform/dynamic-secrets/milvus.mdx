...
<Steps>
  ...
  <Step title="Select Milvus">
    ...
    ![Milvus Option](../../../images/platform/dynamic-secrets/milvus/milvus_option.png)
  </Step>
  <Step title="Provide the inputs for dynamic secret parameters">
    ![Milvus form](../../../images/platform/dynamic-secrets/milvus/milvus_form.png)
  ...
  <Step title="Click `Submit`">
    After submitting the form, you'll see the Milvus dynamic secret created in the dashboard.
  ...
  <Step title="Generate dynamic secrets">
    Once configured, select `Generate` (or `New Lease`) on the dynamic secret to issue an on-demand credential.
...
Once you have created one or more leases, you can access them by selecting the dynamic secret item on the dashboard. From there you can view the expiration time or revoke a lease early.

![Provision Lease](/images/platform/dynamic-secrets/lease-data.png)

## Renew leases

To extend the life of a generated lease, select the **Renew** button.
