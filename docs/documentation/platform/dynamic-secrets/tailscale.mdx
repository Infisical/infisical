...
<Steps>
  ...
  <Step title="Generate dynamic secrets">
    ...
    <Warning>
      Copy these values right away. For security reasons, secret values (auth keys and client secrets) are only shown once at creation time and cannot be retrieved again afterwards.
    </Warning>
  </Step>
</Steps>
