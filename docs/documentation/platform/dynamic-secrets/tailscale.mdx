...
<Steps>
  ...
  <Step title="Click `Submit`">
    After submitting the form, you'll see a dynamic secret created in the dashboard.
  </Step>
...
<Note>
  Tailscale credentials are immutable once created and can't be renewed. To obtain a fresh credential, generate a new lease instead.
</Note>
