...
<Steps>
  ...
  <Step title="Provide the inputs for dynamic secret parameters">
    ...
    <Note>
    All credentials are created with `ephemeral` set to `false` because they are managed by Infisical. This ensures that only one system is responsible for revoking the credentials, avoiding concurrency issues.
    </Note>
  </Step>
  ...
  <Step title="Generate dynamic secrets">
    ...
    {/* TODO: capture Infisical UI screenshot — lease.png does not exist yet */}
