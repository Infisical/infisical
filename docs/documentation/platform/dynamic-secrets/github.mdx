...
<Steps>
    <Step title="Create an application on GitHub">
        Navigate to [GitHub App settings](https://github.com/settings/apps) and select **New GitHub App**.
...
<Warning>
    GitHub App tokens can't be revoked. As such, revoking a token on Infisical doesn't invalidate the GitHub token; it remains active until it expires.
</Warning>

## Renew leases

<Note>
    GitHub App tokens can't be renewed because they're fixed to a lifetime of 1 hour.
</Note>
