...
<Steps>
  <Step title="Open user settings">
   Select the **Governance & Security** tab and select **Users & roles**.
    ![Snowflake User
    Dashboard](/images/app-connections/snowflake/step-1.png)
  </Step>


  <Step title="Create a new User">
  In the top right, select **Create user**
    ![Snowflake User
Dashboard](/images/platform/dynamic-secrets/snowflake/dynamic-secret-create-user-button.png)
  </Step>
  ...
  <Step title="Generate a Programmatic Access Token">
    Select the **Governance & Security** tab and select **Users & roles**. Then select the user you created in the previous step.

    ![Select User](/images/platform/dynamic-secrets/snowflake/select-user-for-pat.png)
    ...
    ![Add Programmatic Access Token name](/images/app-connections/snowflake/step-6.png)
  </Step>

    <Step title="Copy the Token">
        Copy the generated token. Snowflake only displays it once, so store it somewhere secure for the next step.

        ![Copy Programmatic Access Token](/images/app-connections/snowflake/step-7.png)
    </Step>

  <Step title="Save the Account and Organization identifiers">
    Select the Account Menu in the bottom left and take note of your Account and Organization identifiers
