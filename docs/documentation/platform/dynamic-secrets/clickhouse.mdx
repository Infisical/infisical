...
<Steps>
  ...
  <Step title="Provide the inputs for dynamic secret parameters">
    ...
    <ParamField path="Port" type="number" required>
      ClickHouse HTTP interface port. Defaults to `8123` (HTTP) or `8443` (HTTPS).
    </ParamField>
    ...
    <ParamField path="CA (SSL)" type="string">
      A CA certificate may be required if your ClickHouse instance uses TLS with a self-signed or private certificate. Providing a CA also enables HTTPS automatically.
    </ParamField>
