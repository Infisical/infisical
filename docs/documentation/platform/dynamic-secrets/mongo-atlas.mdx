---
title: "MongoDB Atlas"
description: "Learn how to dynamically generate MongoDB Atlas Database user credentials."
---
...
The Infisical MongoDB Atlas dynamic secret allows you to generate MongoDB Atlas Database credentials on demand based on configured role.

## Prerequisite

Create a project scoped API Key with the required permission in your MongoDB Atlas following the [official doc](https://www.mongodb.com/docs/atlas/configure-api-access/#grant-programmatic-access-to-a-project).

<Info>The API Key must have permission to manage users in the project.</Info>

## Set up dynamic secrets with MongoDB Atlas
