...
<Warning>
Due to SAP ASE limitations, the attached SQL statements aren't executed as a transaction.
</Warning>
</ParamField>
...
To extend the life of the generated dynamic secret lease past its initial time to live, simply select the **Renew** as illustrated below.
