...
<Note>
  Kubernetes service account tokens can't be revoked once issued. This is why
...
<Note>
  ...
  expiration time. Once a token is generated, its lifetime can't be extended.
...
<Steps>
  ...
  <Step title="Provide the inputs for dynamic secret parameters">
    ...
    <ParamField path="Default TTL" type="string" required>
      Default time-to-live for a generated secret (it's possible to modify this value after a secret is generated)
    </ParamField>
    ...
    <ParamField path="SSL Reject Unauthorized" type="boolean" default="true">
      If enabled, the server certificate will be verified against the list of supplied CAs. Disable this option if you're using a self-signed certificate.
    </ParamField>
...
Once you select the `Submit` button, a new secret lease will be generated and the service account token will be shown to you.
...
<Note>
  ...
  account token can't be revoked. The token will remain valid until its TTL
