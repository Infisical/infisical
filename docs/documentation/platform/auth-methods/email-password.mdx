...
**Email and Password** is the most common authentication method that can be used by user identities for authentication into Web Dashboard and Infisical CLI. It's recommended to utilize [Multi-factor Authentication](/documentation/platform/mfa) in addition to it.

It's currently possible to use the **Email and Password** auth method to authenticate into the Web Dashboard and Infisical CLI.
...
4. Select `Save` to save your new password.
...
4. Select `Send Verification Code` to receive an 6-digit verification code at your new email address.
...
6. Select `Confirm Email Change` to complete the process.
7. You'll be logged out and need to sign in again with your new email address.
