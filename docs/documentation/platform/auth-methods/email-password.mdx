...
4. Click `Change Email` and confirm the action by typing `confirm`.
![change email confirmation](../../../images/auth-methods/personal-settings-authentication-change-email-confirmation.png)
5. You will be logged out and need to verify your new email address before signing in again.
