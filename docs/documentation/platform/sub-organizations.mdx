...
1. Select the **Organization** tab in the header
2. Select **+ New Sub-Organization**
3. Enter a name (this becomes the slug used in API calls)
4. You're automatically assigned as Admin of the new sub-organization
...
3. Select **Add from Organization** and select the resources to include
