...
3. Select the add button for that tab, then choose **Assign Existing** (except on **Users**, which goes straight to the invite form). Pick the users, groups, or machine identities to bring in from the root organization, and confirm with the button for that tab:
    - **Users** → **Add Member**
    - **Groups** → **Link**
