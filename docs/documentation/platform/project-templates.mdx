...
Project Templates streamline project setup by providing customizable templates with predefined environments and roles.

<Note>
    Project Templates are a paid feature.
    If you're using Infisical Cloud, then they are available under the **Enterprise Tier**. If you're self-hosting Infisical,
    then you should contact sales@infisical.com to purchase an enterprise license to use them.
</Note>
...
1. <strong>Creating a project template:</strong> As part of this step, you will configure a set of environments and roles to be created when this template is applied to a project.
2. <strong>Using a project template:</strong> When creating new projects, optionally specify a project template to provision the project with configured roles and environments.

<Note>
  This workflow can be completed via the Infisical UI or through the API.
</Note>

## Guide to Creating a Project Template

The following steps show how to set up a project template.

<Tabs>
    <Tab title="Infisical UI">
        <Steps>
            <Step title="Creating a Project Template">
                Navigate to the **Project Templates** tab on the Feature Settings page for the project type, then select the **Add Template** button.
            ...
            <Step title="Configuring a Project Template">
                ...
                Customize the environments and roles for your needs.
...
The following steps show how to use a project template when creating a project.
...
<Tabs>
    ...
    <Tab title="API">
        ...
        If omitted, `template` defaults to `default`.
        ...
        <Note>
            Configured roles are not included in the project response.
        </Note>
    </Tab>
