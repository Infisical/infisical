---
title: "Inject a secret into a local application"
sidebarTitle: "Inject a secret locally"
description: "Store a secret in Infisical and deliver it to a local application without a `.env` file."
---

This quickstart guide walks you through the recommended secrets management workflow for local applications. You'll create a [project](/documentation/platform/secrets-mgmt/project), add a secret to one of its environments, and inject the secret into your local application using the [Infisical CLI](/cli/overview), all without needing a `.env` file.
...
Now that you've set up a project that holds your secret in Infisical, you can connect your application and give it access to that secret at runtime.
...
## Step 3: Inject the secret into your app

Now that your Infisical project is configured within your application, Infisical can provide the secret.
