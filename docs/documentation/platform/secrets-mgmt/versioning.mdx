...
<CardGroup cols={2}>
  <Card title="Secret versioning" icon="history" href="/documentation/platform/secret-versioning">
    The history behind a single secret, and how to restore an earlier value.
  </Card>
  <Card title="Point-in-time recovery" icon="undo-2" href="/documentation/platform/pit-recovery">
