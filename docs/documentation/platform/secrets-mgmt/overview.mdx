...
<CardGroup cols={2}>
  ...
  <Card title="Versioning" icon="history" href="/documentation/platform/secrets-mgmt/versioning">
    Secret history, and rolling a secret or an environment back to an earlier state.
  </Card>
  <Card title="Access control" icon="shield-half" href="/documentation/platform/secrets-mgmt/access-control">
...
<CardGroup cols={2}>
  <Card title="Overview" icon="refresh-cw" href="/documentation/platform/secret-rotation/overview">
    Replace a credential on a schedule, with no gap where the old one stops working.
  </Card>
  <Card title="Search providers" icon="search" href="/integrations/secret-rotations">
...
<CardGroup cols={2}>
  ...
  <Card title="Search services" icon="search" href="/integrations/dynamic-secrets">
...
<CardGroup cols={2}>
  <Card title="Overview" icon="package" href="/documentation/platform/honey-tokens/overview">
    Plant a decoy credential that alerts you the moment someone uses it.
  </Card>
  <Card title="AWS" icon="aws" iconType="brands" href="/documentation/platform/honey-tokens/aws/setup">
