...
To add a secret, select the **Add Secret** button at the top of the dashboard.
...
To delete a secret, hover over it and select the three dots on the right side, then select **Delete secret** from the dropdown.
...
and select the **Delete** button that appears at the top.
...
To download/export secrets back into a `.env` file, select the download button.
...
To provide more context about a given secret, especially for your team, hover over it and select the comment button.
