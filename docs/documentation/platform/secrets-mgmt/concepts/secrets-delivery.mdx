---
title: "Secrets delivery"
sidebarTitle: "Secrets delivery"
...
<CardGroup cols={2}>
  <Card title="Deliver Your First Secret" icon="rocket" href="/documentation/platform/secrets-mgmt/quick-starts/deliver-first-secret">
    Inject secrets into an application with the CLI in under 10 minutes.
  </Card>
  <Card title="Secret Syncs" icon="arrow-right-left" href="/integrations/secret-syncs/overview">
    Push secrets to platforms that can't fetch them directly.
  </Card>
</CardGroup>
