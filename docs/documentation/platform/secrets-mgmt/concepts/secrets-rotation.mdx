...
<CardGroup cols={2}>
  <Card title="Set Up Secret Rotation" icon="refresh-cw" href="/documentation/platform/secret-rotation/overview">
    Configure automatic rotation for your credentials.
  </Card>
  <Card title="Browse Supported Rotations" icon="layout-grid" href="/integrations/secret-rotations">
