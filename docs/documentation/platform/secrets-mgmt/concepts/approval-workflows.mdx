...
After a change request is merged, the updated secrets are automatically synced to connected applications — for example, through the [Infisical Kubernetes Operator](/integrations/platforms/kubernetes/overview) — removing the manual propagation step.
