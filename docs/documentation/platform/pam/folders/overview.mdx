...
<Steps>
  <Step title="Navigate to Accounts">
    Go to **Privileged Access Management → Accounts**, select the arrow next to **Add Account**, and select **Add Folder**. Only [Product Admins](/documentation/platform/pam/concepts/access-control#product-membership) can create folders.
  </Step>
...
<CardGroup cols={2}>
  <Card title="Templates" icon="layers" href="/documentation/platform/pam/templates/overview">
