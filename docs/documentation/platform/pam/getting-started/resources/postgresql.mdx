...
PostgreSQL resources can be accessed directly from the browser using the **Data Explorer** — a visual interface for browsing and editing tables — or the **SQL Terminal** for running ad-hoc queries.
...
For details, see [Credential Rotation](/documentation/platform/pam/product-reference/credential-rotation/overview).
