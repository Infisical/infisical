...
PostgreSQL resources can also be accessed directly from the browser using Infisical's web-based SQL console. This provides a convenient way to run queries without installing any local tools.
