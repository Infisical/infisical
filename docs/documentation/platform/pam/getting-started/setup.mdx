...
<Steps>
  ...
  <Step title="Connect">
    Users navigate to a resource in the UI, select an account within it, and connect via the Infisical CLI.

    Connection instructions vary by resource type. See:
    - [PostgreSQL](/documentation/platform/pam/getting-started/resources/postgresql)
    - [MySQL](/documentation/platform/pam/getting-started/resources/mysql)
    - [Redis](/documentation/platform/pam/getting-started/resources/redis)
    - [Kubernetes](/documentation/platform/pam/getting-started/resources/kubernetes)
    - [SSH](/documentation/platform/pam/getting-started/resources/ssh)
  </Step>
</Steps>
