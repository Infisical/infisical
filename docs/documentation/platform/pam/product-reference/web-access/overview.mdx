...
Infisical PAM Web Access provides a browser-based terminal for interacting with your infrastructure directly from your browser via the Infisical dashboard — no client tools or CLI required.
