...
<Info>
  Web Access currently supports **PostgreSQL** databases (with a visual Data Explorer and SQL query runner), **Redis** servers, and **SSH** servers.
</Info>
...
<CardGroup cols={2}>
  <Card title="PostgreSQL" icon="database" href="/documentation/platform/pam/product-reference/web-access/postgresql">
    Visual Data Explorer for browsing and editing tables, plus an integrated SQL query runner.
  </Card>
