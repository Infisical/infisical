...
<Warning>
Changing the bucket or key prefix on a project that already has recordings makes those recordings inaccessible unless you manually migrate each object. When rotating credentials, keep the same bucket and key prefix.
</Warning>
