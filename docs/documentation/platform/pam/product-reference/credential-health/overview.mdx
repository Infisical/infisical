...
<Note>
  Checking an Oracle credential needs a gateway running v0.43.133 or later, and a password of 30 characters or fewer. An Oracle account that doesn't meet both shows as **Unreachable**.
</Note>
