...
- **Access duration constraints**: Set minimum and maximum access durations for requests matching this policy.
...
<Steps>
  <Step title="Configuration">
    ...
    - **Access Duration**: Configure the minimum and maximum access duration allowed for requests matching this policy.
