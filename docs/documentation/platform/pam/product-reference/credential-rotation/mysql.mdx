...
This page covers what is specific to rotating a MySQL account. For how rotation is configured and scheduled, see the [overview](/documentation/platform/pam/product-reference/credential-rotation/overview).
