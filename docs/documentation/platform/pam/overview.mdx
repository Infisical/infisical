...
1.  **Discovery**: A user logs into Infisical and sees a catalog of resources (databases, servers) and the accounts under each resource they are allowed to access. Access is **resource-centric**: users navigate to a resource first, then select an account within that resource.
2.  **Connection**: The user selects a resource and an account (e.g., `production-db` and `read-only`). They initiate the connection via the Infisical CLI.
...
<CardGroup cols={3}>
  ...
  <Card title="Resource" icon="database" href="/documentation/platform/pam/getting-started/resources">
    The specific target you are protecting (e.g., a PostgreSQL database or a Linux server).
  </Card>
...
<CardGroup cols={3}>
  <Card title="PostgreSQL" icon="database" href="/documentation/platform/pam/resources/postgresql">
    Secure access to PostgreSQL databases with session recording.
  </Card>
  <Card title="MySQL" icon="database" href="/documentation/platform/pam/resources/mysql">
    Secure access to MySQL databases.
  </Card>
  <Card title="Microsoft SQL Server" icon="database" href="/documentation/platform/pam/resources/mssql">
    Secure access to MSSQL databases.
  </Card>
  <Card title="MongoDB" icon="database" href="/documentation/platform/pam/resources/mongodb">
    Secure access to MongoDB databases.
  </Card>
  <Card title="Oracle" icon="database" href="/documentation/platform/pam/resources/oracle">
    Secure access to Oracle databases.
  </Card>
  <Card title="Redis" icon="database" href="/documentation/platform/pam/resources/redis">
    Secure access to Redis instances.
  </Card>
  <Card title="SSH Servers" icon="terminal" href="/documentation/platform/pam/resources/ssh">
    Secure access to Linux servers via SSH with session recording.
  </Card>
  <Card title="Kubernetes" icon="dharmachakra" href="/documentation/platform/pam/resources/kubernetes">
    Manage access to Kubernetes clusters.
  </Card>
  <Card title="AWS IAM" icon="aws" href="/documentation/platform/pam/resources/aws-iam">
    Broker access to AWS resources via IAM credentials.
  </Card>
  <Card title="Active Directory" icon="windows" href="/documentation/platform/pam/resources/active-directory">
    Manage Active Directory domain controllers and domain accounts.
  </Card>
  <Card title="Windows Server" icon="desktop" href="/documentation/platform/pam/resources/windows-server">
    Secure access to Windows servers via RDP.
  </Card>
</CardGroup>

## Core Capabilities

- **[Discovery](/documentation/platform/pam/discovery/overview)**: Automatically discover resources, accounts, and service dependencies across your infrastructure.
- **[Approval Policies](/documentation/platform/pam/product-reference/approval-policies)**: Configure approval workflows for PAM account access using resource and account name matching.
