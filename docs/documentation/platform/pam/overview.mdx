...
- **[Automated Credential Rotation](/documentation/platform/pam/product-reference/credential-rotation/overview)**: Automatically rotate credentials for supported resources to minimize the risk of compromised credentials.
