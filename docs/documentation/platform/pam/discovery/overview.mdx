...
<CardGroup cols={2}>
  ...
  <Card title="Unix" icon="terminal" href="/documentation/platform/pam/discovery/unix">
    Scan Unix hosts over SSH for local accounts.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Unix" icon="terminal" href="/documentation/platform/pam/discovery/unix">
    Configure a Unix discovery source.
  </Card>
