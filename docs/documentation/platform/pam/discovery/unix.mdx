---
title: "Linux/Unix discovery"
sidebarTitle: "Linux/Unix"
description: "Scan Linux and Unix hosts over SSH for local accounts and import them into PAM."
---
...
<Steps>
  <Step title="Start adding a source">
    Go to **Privileged Access Manager → Discovery** and select **Add Source**, then choose **Linux/Unix**.
  </Step>
