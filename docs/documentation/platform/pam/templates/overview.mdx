...
<Steps>
  ...
  <Step title="Configure policies">
    | Option | What it does |
    |--------|--------------|
    | **Require Approval** | Users must request and be granted [access](/documentation/platform/pam/access-requests/overview) before connecting |
    ...
    <Note>
      **Allow Break-Glass** needs **Require Approval** on the same template, and it stays off until a Folder Admin names the responders on the folder's **Approvals** tab. See [break-glass access](/documentation/platform/pam/access-requests/overview#break-glass-access).
    </Note>
