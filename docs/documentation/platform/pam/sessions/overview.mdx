...
- Logs update in near real-time (every 10 seconds)
...
- **Recording playback** — if recording was enabled

### Searching Logs

Use the search bar within a session to find specific content — a particular query, command, or output.

You can also search across all sessions from the main Sessions page to find when something specific was run.
