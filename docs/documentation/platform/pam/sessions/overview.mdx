...
Click on any session to see its details and recording. A [machine identity](/documentation/platform/identities/machine-identities) has no email address, so its sessions show **Machine Identity** wherever a person's email would appear.
