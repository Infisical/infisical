...
<Steps>
  ...
  <Step title="Add account and select a template">
    Click **Add Account** and select a PostgreSQL template (e.g., the default `postgres` or a custom one). The template determines session rules like duration, MFA, and recording.
  </Step>
