...
<Steps>
  <Step title="Start adding an account">
    Go to **Privileged Access Management → Accounts** and click **Add Account**. The button only appears if you have permission to create accounts in at least one folder.
  </Step>
...
Once an account exists, users with access can connect from the **Accounts** page:

### Web Access

Go to **Privileged Access Management → Accounts**, find the account, and click the rocket icon, then select **Connect in Browser**. This opens:
