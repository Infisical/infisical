...
<Tabs>
  <Tab title="Web Access">
    ...
    Web Access is built for interactive use. Very long replies are shortened, and commands that stream results, such as `SUBSCRIBE` and `MONITOR`, are available through the CLI.
