...
<Note>
AWS IAM accounts don't require a Gateway. Infisical communicates directly with the AWS STS API.
</Note>
...
<Info>
  AWS Console sessions can't be terminated early. Once a federated URL is generated, the session remains valid until it expires. You can [revoke active sessions](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_use_revoke-sessions.html) by modifying the role's trust policy.
</Info>
...
<Tabs>
  <Tab title="AWS Console">
    ...
    4. You'll be taken directly to the AWS console, logged in with the role
  </Tab>
  <Tab title="CLI">
...
<CardGroup cols={2}>
  <Card title="Kubernetes Accounts" icon="settings" href="/documentation/platform/pam/accounts/kubernetes">
