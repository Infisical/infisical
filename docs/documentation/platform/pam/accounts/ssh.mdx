...
<Steps>
  ...
  <Step title="Add account and select a template">
    Click **Add Account** and select an SSH template (e.g., the default `ssh` or a custom one). The template determines session rules like duration, MFA, and recording.
  </Step>
