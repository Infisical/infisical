...
All sessions are tracked with full metadata, including all Redis commands executed. For details on what is captured and how to review recordings, see [Session Recording](/documentation/platform/pam/product-reference/session-recording).
