...
When creating or editing a [Windows Server](/documentation/platform/pam/resources/windows-server) resource, you can select an **Active Directory Domain** from the dropdown. This associates the Windows server with the AD domain controller, indicating that it is a domain-joined machine.
