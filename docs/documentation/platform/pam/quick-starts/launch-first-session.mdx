...
<Steps>
  ...
  <Step title="Launch a Session">
    1. Go to **Privileged Access Management → Accounts**
    2. Find the account you created and select the rocket icon (or select **Launch Session** from the menu)
...
<CardGroup cols={2}>
  ...
  <Card title="AI Agents" icon="robot" href="/documentation/platform/pam/ai-agents/overview">
    Point an AI agent at the same account, sandboxed and recorded.
  </Card>
</CardGroup>
