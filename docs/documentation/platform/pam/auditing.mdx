...
| **Target** | Actions affecting a specific account, folder, or template |

Use the search bar to find events by user email, account name, or folder name.
...
| Role | Access |
|------|--------|
| **Product Admin** | All audit logs |
| **Admin** (on a folder) | Logs for accounts in that folder |
| **Auditor** (on a folder) | Logs for accounts in that folder |
| **Connector** | Can only see their own session events |
