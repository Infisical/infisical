...
<Steps>
  <Step title="Create a Folder">
    ...
    2. Click the arrow next to **Add Account** and select **Add Folder**
  ...
  <Step title="Connect">
    Your team can now connect from the **Accounts** page — either in the browser or using the CLI proxy.
...
To add another database, open the folder and select **Add Account**. Your team will automatically have access since they already have folder permissions.
...
<CardGroup cols={2}>
  ...
  <Card title="AI Agents" icon="bot" href="/documentation/platform/pam/ai-agents/overview">
    Grant the same folder access to an AI agent.
  </Card>
</CardGroup>
