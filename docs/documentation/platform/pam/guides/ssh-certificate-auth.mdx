...
<Steps>
  <Step title="Create the SSH Account">
    ...
    2. Click **Add Account**
    3. Select an SSH template
    4. Fill in the connection details (host, port, username)
  ...
  <Step title="Configure the Server">
    ...
    <Tabs>
      <Tab title="Automated Setup (Recommended)">
        ...
        The script downloads the CA public key, configures sshd to trust it, and restarts the service.
      </Tab>
