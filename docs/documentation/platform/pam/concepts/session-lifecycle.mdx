...
An [AI agent](/documentation/platform/pam/ai-agents/overview) cannot be prompted, so it supplies its reason up front, and it cannot use an account that requires MFA yet.
