...
1. **User requests access** — clicks Access in the browser or runs the CLI command
...
4. Every 10 seconds, new events upload to Infisical
...
For deployment instructions, see the [Gateway documentation](/documentation/platform/gateways/overview).
