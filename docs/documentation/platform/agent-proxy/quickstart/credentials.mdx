...
<CardGroup cols={2}>
  <Card title="Local proxy" icon="laptop-code" href="/documentation/platform/agent-proxy/quickstart/local-proxy">
    You are the one running the agent, in your terminal: Claude Code, Codex, or a script you are iterating on.
  </Card>
  <Card title="Standalone proxy" icon="server" href="/documentation/platform/agent-proxy/quickstart/standalone-proxy">
    The agent runs unattended in your own infrastructure, or one proxy serves your whole team.
  </Card>
</CardGroup>
