...
<CardGroup cols={2}>
  <Card title="Learn more" icon="book-open" href="/documentation/platform/agent-proxy/local-agent-proxy">
    The Local Agent Proxy reference: what the sandbox allows and denies, how certificates work, and every flag `run` takes.
  </Card>
  <Card title="Standalone Proxy" icon="server" href="/documentation/platform/agent-proxy/quickstart/standalone-proxy">
    The quickstart for agents that run unattended in your own infrastructure, on a host of their own.
  </Card>
</CardGroup>
