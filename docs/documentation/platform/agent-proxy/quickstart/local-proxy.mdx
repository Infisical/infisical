...
<Info>
  To serve agents that run unattended in your own infrastructure, follow the [Standalone Proxy](/documentation/platform/agent-proxy/quickstart/standalone-proxy) quickstart instead.
</Info>
