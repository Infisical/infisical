...
<Info>
  To broker credentials to an agent on your own computer, follow the [Local Proxy](/documentation/platform/agent-proxy/quickstart/local-proxy) quickstart instead.
</Info>
