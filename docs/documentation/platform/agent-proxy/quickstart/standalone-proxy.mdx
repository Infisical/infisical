...
<CardGroup cols={2}>
  <Card title="Learn more" icon="book-open" href="/documentation/platform/agent-proxy/standalone-agent-proxy">
    The Standalone Agent Proxy reference: deployment, network placement, high availability, and how agents are authorized on every request.
  </Card>
  <Card title="Local Proxy" icon="laptop-code" href="/documentation/platform/agent-proxy/quickstart/local-proxy">
    The quickstart for an agent you run yourself, on your own computer, in one command.
  </Card>
</CardGroup>
