...
To set one up, follow the **Dedicated proxy** tab of the [Quickstart](/documentation/platform/agent-proxy/quickstart). This page is what comes after.
