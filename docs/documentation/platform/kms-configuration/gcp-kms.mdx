  ...
  <Steps>
    <Step title="Create a GCP Service Account">
      ...
      **Cloud KMS Viewer** and **Cloud KMS CryptoKey Encrypter/Decrypter*** roles, then click **Continue**.
      ...
      7. You'll be prompted to download a JSON file that we will need later on.
      <Info>
    ...
    <Step title="Add a GCP KMS Key">
      ...
      <Info>
        If you haven't used GCP KMS before, you'll be redirected to the **Cloud Key Management Service (KMS) API** page.
...
<Steps>
  <Step title="Open the Encryption settings">
    Go to **Settings**, select **Encryption**, then select **Add KMS**.
...
<Steps>
  <Step title="Open the project's Encryption settings">
    Open the project, go to **Settings**, and select **Encryption**.
    ![Open encryption project
    settings](../../../images/platform/kms/gcp/project-settings.png)
  </Step>
  <Step title="Select the key under Key Management">
