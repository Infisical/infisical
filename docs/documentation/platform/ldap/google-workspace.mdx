...
<Steps>
    ...
    <Step title="Prepare the LDAP configuration in Infisical">
            ...
            - Client Certificate: Paste the contents of the `.crt` file downloaded from Google.
            - Client Private Key: Paste the contents of the `.key` file downloaded from Google.
