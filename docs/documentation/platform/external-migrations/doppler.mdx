...
<Warning>
  Importing from Doppler requires the **Connect** action on **App Connections** (project- or organization-scoped) and the **Create** action on **Secrets** at the target environment and folder path.
</Warning>
