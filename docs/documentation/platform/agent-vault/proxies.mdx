...
Use **Deny** when the proxy sits somewhere it could reach more than you intend, such as a network with internal services on it. Under **Deny**, a pass-through connection is how an access bundle makes a host reachable without giving it a credential.
