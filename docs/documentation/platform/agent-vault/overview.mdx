...
<CardGroup cols={2}>
  <Card title="Why use Agent Vault?" icon="shield-keyhole" href="/documentation/platform/agent-vault/why-agent-vault">
...
<CardGroup cols={2}>
  ...
  <Card title="Access control" icon="shield-halved" href="/documentation/platform/agent-vault/access-control">
