...
<CardGroup cols={2}>
  ...
  <Card title="Activity logs" icon="list" href="/documentation/platform/agent-vault/activity-logs">
    Recording what agents reached, storing it in your own bucket, and reading it back.
  </Card>
  <Card title="Integrations" icon="plug" href="/documentation/platform/agent-vault/integrations">
    The third-party services Agent Vault connects to, and which credentials it shares with the rest of your organization.
  </Card>
