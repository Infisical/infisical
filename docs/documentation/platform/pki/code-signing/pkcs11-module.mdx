...
<Info>
  Before using the PKCS#11 module, ensure your Product Admin has created a [Signer](/documentation/platform/pki/code-signing/signers) and assigned you to it. If a signing policy is attached, you'll also need an approved [grant](/documentation/platform/pki/code-signing/grants).
</Info>
...
<CardGroup cols={3}>
  <Card title="Sign JARs" icon="java" href="/documentation/platform/pki/code-signing/guides/pkcs11-jarsigner">
  ...
  <Card title="Sign with GPG" icon="key" href="/documentation/platform/pki/code-signing/guides/pkcs11-gpg">
