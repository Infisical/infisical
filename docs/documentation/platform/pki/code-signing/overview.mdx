...
2. The Admin adds [members](/documentation/platform/pki/code-signing/signers#signer-roles) (users, machine identities, or groups) and picks a role for each.
...
| **Operator** | Sign artifacts and submit signing requests. Can't change settings or members. |
| **Auditor** | Read-only: view members, activity, and the audit log. Can't sign. |
...
<CardGroup cols={2}>
  <Card title="Create a Signer" icon="pen-tool" href="/documentation/platform/pki/code-signing/signers#create-a-signer">
    The 4-step wizard.
  </Card>
  <Card title="Add an approval policy" icon="check-check" href="/documentation/platform/pki/code-signing/approvals#configure-the-approval-policy">
  ...
  <Card title="Sign your first JAR" icon="java" iconType="brands" href="/documentation/platform/pki/guides/code-signing/jarsigner">
