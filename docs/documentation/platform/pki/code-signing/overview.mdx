...
<Info>
  Code Signing uses **Signers** as the organizing concept, similar to how [Applications](/documentation/platform/pki/applications/overview) work for certificates. Platform Admins create Signers and assign team members who can then request signing access.
</Info>
