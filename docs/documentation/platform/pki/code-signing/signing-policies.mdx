...
description: "Configure approval workflows for code signing operations."
---

Signing policies add a human review step before signing operations can be performed, helping enforce separation of duties and maintain compliance for software supply chain security.

<Info>
  Signing policies are created by Platform Admins and attached to Signers. When a policy is attached, team members must request and receive approval before signing.
</Info>
...
To create a signing policy, go to **Certificate Manager → Code Signing → Signing Policies** and click **Create Policy**.
