...
Use GnuPG with the Infisical PKCS#11 module via `gnupg-pkcs11-scd` to sign git commits and tags, RPM/DEB packages, and any other artifact that uses GPG signatures — all backed by keys stored securely in Infisical.
...
<CardGroup cols={2}>
  <Card title="Sign Containers" icon="docker" href="/documentation/platform/pki/code-signing/guides/pkcs11-cosign">
    Sign container images with Cosign
  </Card>
  <Card title="Sign Windows Binaries" icon="windows" href="/documentation/platform/pki/code-signing/guides/pkcs11-osslsigncode">
