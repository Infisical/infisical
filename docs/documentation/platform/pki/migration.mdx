...
<Steps>
  <Step title="Designate the active project">
    Navigate to **Organization Settings → Products → Certificate Manager**. In the projects table, mark the project you intend to consolidate into as **Active**. All members and integrations across the organization will subsequently resolve to this project.
  </Step>
