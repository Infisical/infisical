...
<AccordionGroup>
  ...
  <Accordion title="What happens to my CA after using the export tool?">
    The export operation produces an independent copy of the CA in the active project. Certificates issued and revocations performed after the export aren't synchronized between the original and the copy. The active project should be treated as the system of record going forward.
  </Accordion>
