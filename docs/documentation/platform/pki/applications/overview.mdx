...
<CardGroup cols={2}>
  ...
  <Card title="Enrollment Methods" icon="log-in">
  ...
  <Card title="Approval Policies" icon="check-check">
    Optional review workflows before certificates are issued.
  </Card>
  <Card title="Certificate Syncs" icon="refresh-cw">
...
<Steps>
  <Step title="Navigate to Applications">
    In Certificate Manager, go to **Applications** and select **Create Application**.
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Approval Policies" icon="check-check" href="/documentation/platform/pki/applications/approvals">
