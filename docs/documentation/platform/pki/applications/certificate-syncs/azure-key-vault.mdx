...
<Note>
  ...
  automatically deployed as they're issued or renewed.
</Note>
...
<Accordion title="Can I import certificates from Azure Key Vault back into Infisical?">
  Azure Key Vault doesn't support importing certificates back into Infisical
  due to security limitations where private keys can't be extracted from Azure
  Key Vault.
</Accordion>
