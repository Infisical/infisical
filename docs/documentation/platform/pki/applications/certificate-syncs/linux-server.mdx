...
A check is limited to 2048 characters, counted after the variables are substituted. For anything longer, put the logic in a script on the server and call that script.
...
A command is limited to 2048 characters, counted after the variables are substituted. For anything longer, put the logic in a script on the server and call that script.
