...
The **Target Host** field offers machines read from the directory. The list isn't closed, because the name a domain controller advertises isn't always the address you can reach, so you can enter a host that isn't listed. The value must be a host name or an IPv4 address.
