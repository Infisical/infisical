...
<Note>
  Your [Infisical Gateway](/documentation/platform/gateways/overview) runs both commands, never Infisical. The sync's SSH Connection must therefore use a gateway, otherwise the command is rejected when you save the sync.
