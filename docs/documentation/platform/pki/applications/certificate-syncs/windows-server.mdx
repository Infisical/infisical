...
A command is limited to 8192 characters, counted after the placeholders are substituted. For anything longer, put the logic in a script on the server and call that script.
