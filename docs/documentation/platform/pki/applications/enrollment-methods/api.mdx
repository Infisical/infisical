...
<CardGroup cols={2}>
  ...
  <Card title="CI/CD Pipelines" icon="settings-2">
    Issue certificates as part of deployment workflows.
  </Card>
  <Card title="Server-Driven Renewal" icon="rotate-cw">
    Let Infisical automatically renew certificates before expiration.
  </Card>
  <Card title="One-Off Requests" icon="pointer">
...
<Steps>
  ...
  <Step title="Configure enrollment on an attached profile">
    Go to the **Settings** tab and find the **Certificate Profiles** section. Select **Configure** on the profile you want to enable API enrollment for.
  ...
  <Step title="Add API enrollment">
    In the modal, select **Add enrollment method** and select **API**.
  </Step>
  ...
  <Tab title="Infisical UI">
    <Steps>
      <Step title="Open certificate requests">
        In your Application, go to the **Certificate Requests** tab and select **Request**.
      </Step>
...
<CardGroup cols={2}>
  <Card title="ACME Enrollment" icon="bot" href="/documentation/platform/pki/applications/enrollment-methods/acme">
