...
<Info>
  API enrollment is configured per [Application](/documentation/platform/pki/applications/overview). Your platform admin sets up the [certificate profile](/documentation/platform/pki/settings/profiles), and you configure API enrollment within your Application.
</Info>
...
<Steps>
  ...
  <Step title="Select a certificate profile">
    ...
    <Note>
      Profiles are created by platform admins. If you don't see any profiles, contact your platform admin.
    </Note>
  </Step>
