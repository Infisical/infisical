...
<Info>
  SCEP enrollment is configured per [Application](/documentation/platform/pki/applications/overview). Your platform admin sets up the [certificate profile](/documentation/platform/pki/settings/profiles), and you configure SCEP enrollment within your Application.
</Info>
...
<Steps>
  ...
  <Step title="Add SCEP enrollment">
    In the **Enrollment Methods** section, click **Add Enrollment Method** and select **SCEP**.
    
    {/* SCREENSHOT: Add SCEP enrollment method modal */}
    <Frame caption="Adding SCEP enrollment to an Application">
      ![Adding SCEP enrollment](/images/pki/placeholder-screenshot.svg)
    </Frame>
  </Step>
  <Step title="Select a certificate profile">
    ...
    <Note>
      The certificate profile must use a **CA-issued** issuer type for SCEP enrollment.
    </Note>
  </Step>
