...
<Info>
  SCEP enrollment is configured per Application. Your product admin sets up the certificate profile, and you configure SCEP enrollment within your Application.
</Info>
    ...
    <Tabs>
      ...
      <Tab title="Dynamic Challenge">
        ...
        **2. Use the challenge in your SCEP enrollment:**
        ...
        For MDM integrations (Jamf Pro, Ivanti, etc.), the MDM tool handles this automatically via webhook. See the [Jamf Pro integration guide](/documentation/platform/pki/applications/guides/jamf-pro-scep) for details.
      </Tab>
    </Tabs>
...
<CardGroup cols={2}>
  <Card title="Jamf Pro Guide" icon="mobile" href="/documentation/platform/pki/applications/guides/jamf-pro-scep">
