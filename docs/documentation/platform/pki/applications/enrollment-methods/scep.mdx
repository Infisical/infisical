...
<Info>
  SCEP enrollment is configured on profiles attached to your [Application](/documentation/platform/pki/applications/overview). Platform Admins attach [profiles](/documentation/platform/pki/settings/profiles), and Application Admins configure enrollment methods on those profiles.
</Info>
...
<Steps>
  ...
  <Step title="Configure enrollment on an attached profile">
    ...
    <Note>
      Profiles are attached by Platform Admins. If you don't see any profiles, ask your Platform Admin to attach one. The profile must use a **CA-issued** issuer type for SCEP enrollment.
    </Note>
  </Step>
