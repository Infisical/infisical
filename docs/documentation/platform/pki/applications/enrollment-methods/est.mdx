...
<Steps>
  ...
  <Step title="Configure enrollment on an attached profile">
    Go to the **Settings** tab and find the **Certificate Profiles** section. Select **Configure** on the profile you want to enable EST enrollment for.
  ...
  <Step title="Add EST enrollment">
    In the modal, select **Add enrollment method** and select **EST**.
  </Step>
...
<CardGroup cols={2}>
  <Card title="SCEP Enrollment" icon="smartphone" href="/documentation/platform/pki/applications/enrollment-methods/scep">
