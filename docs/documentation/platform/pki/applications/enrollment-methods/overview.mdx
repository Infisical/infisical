...
<Steps>
  <Step title="Platform Admin attaches a profile">
    A Platform Admin attaches a [Certificate Profile](/documentation/platform/pki/settings/profiles) to the Application. The profile defines certificate parameters (CA, validity, constraints).
  </Step>
