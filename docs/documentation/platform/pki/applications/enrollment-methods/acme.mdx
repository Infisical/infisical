...
<Info>
  ACME enrollment is configured per Application. Your product admin sets up the certificate profile, and you configure ACME enrollment within your Application.
</Info>
...
<Steps>
  ...
  <Step title="Add ACME enrollment">
    In the **Enrollment Methods** section, click **Add Enrollment Method** and select **ACME**.
    
    {/* SCREENSHOT: Add ACME enrollment method modal */}
    <Frame caption="Adding ACME enrollment to an Application">
      ![Adding ACME enrollment](/images/pki/placeholder-screenshot.svg)
    </Frame>
  </Step>
  ...
  <Step title="Get ACME credentials">
    ...
    {/* SCREENSHOT: ACME EAB credentials modal */}
    <Frame caption="ACME credentials for your client">
      ![ACME EAB credentials](/images/pki/placeholder-screenshot.svg)
    </Frame>
  </Step>
</Steps>
...
<Tabs>
  <Tab title="Certbot">
    ...
    - [Nginx with Certbot](/documentation/platform/pki/applications/guides/nginx-certbot)
    - [Apache with Certbot](/documentation/platform/pki/applications/guides/apache-certbot)
    - [Tomcat with Certbot](/documentation/platform/pki/applications/guides/tomcat-certbot)
  </Tab>
  <Tab title="cert-manager (Kubernetes)">
    ...
    For full setup, see [Kubernetes cert-manager guide](/documentation/platform/pki/applications/guides/k8s-cert-manager).
  </Tab>
...
<CardGroup cols={2}>
  <Card title="Nginx Guide" icon="n" href="/documentation/platform/pki/applications/guides/nginx-certbot">
    Set up HTTPS on Nginx with Certbot.
  </Card>
  <Card title="Kubernetes Guide" icon="dharmachakra" href="/documentation/platform/pki/applications/guides/k8s-cert-manager">
