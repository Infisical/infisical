...
Server-driven renewal requires [API enrollment](/documentation/platform/pki/applications/enrollment-methods/api) with Infisical-managed keys. Enable it on the [certificate profile](/documentation/platform/pki/settings/profiles) or toggle it per-certificate.
