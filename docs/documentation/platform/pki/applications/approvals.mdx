...
An approval policy defines the workflow that must be completed before certificates are issued from specific profiles. When a certificate request is made:
...
In your Application, navigate to **Approvals → Policies** and click **Create Policy**.

![Approval policies list](/images/platform/pki/approvals/approval-policies.png)

<Steps>
  <Step title="Configure basic settings">
    ![Approval policy configuration](/images/platform/pki/approvals/approval-policy-configuration.png)
  ...
  <Step title="Configure approval steps">
    ![Approval sequence](/images/platform/pki/approvals/approval-policy-sequence.png)
  ...
  <Step title="Review and create">
    ...
    ![Approval policy review](/images/platform/pki/approvals/approval-policy-review.png)
  </Step>
</Steps>
...
Navigate to **Approvals → Requests** to see all approval requests:

![Approval requests](/images/platform/pki/approvals/approval-requests.png)
...
<Steps>
  <Step title="Open the request">
    ...
    ![Open request](/images/platform/pki/approvals/approval-request-open.png)
  </Step>
  <Step title="Review certificate details">
    ...
    ![Request details](/images/platform/pki/approvals/approval-request-detail.png)
  </Step>
  <Step title="Approve">
    If you're an eligible approver for the current step, click **Approve**.
    
    ![Approve modal](/images/platform/pki/approvals/approval-request-approve-modal.png)
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Reject with reason">
    ...
    ![Rejected request](/images/platform/pki/approvals/approval-request-rejected.png)
  </Step>
</Steps>
