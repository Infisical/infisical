...
<Steps>
  <Step title="Get ACME Credentials from Infisical">
    In your Application's **Enrollment Methods** section, locate your ACME enrollment and click **Reveal ACME EAB** to get:
...
<CardGroup cols={2}>
  <Card title="Nginx with Certbot" icon="n" href="/documentation/platform/pki/applications/guides/nginx-certbot">
