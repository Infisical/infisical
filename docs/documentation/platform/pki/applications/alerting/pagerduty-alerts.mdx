...
<Steps>
  ...
  <Step title="Add a PagerDuty channel">
    ...
    {/* SCREENSHOT: Add PagerDuty channel to alert */}
    <Frame caption="Adding a PagerDuty notification channel">
      ![PagerDuty notification channel](/images/pki/placeholder-screenshot.svg)
    </Frame>
  </Step>
</Steps>
