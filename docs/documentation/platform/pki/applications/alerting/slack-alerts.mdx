...
<Steps>
  ...
  <Step title="Add a Slack channel">
    ...
    {/* SCREENSHOT: Add Slack channel to alert */}
    <Frame caption="Adding a Slack notification channel">
      ![Slack notification channel](/images/pki/placeholder-screenshot.svg)
    </Frame>
  </Step>
</Steps>
