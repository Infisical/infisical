...
Profiles are consumed through [Applications](/documentation/platform/pki/applications/overview). The workflow separates responsibilities between platform and application administrators:

<Steps>
  <Step title="Platform Admin creates a profile">
    Combines a CA + policy + defaults into a reusable template that defines what certificates will look like.
  </Step>
  <Step title="Platform Admin creates an Application">
