...
<Info>
  Certificate policies are created by platform admins and shared across the organization. Teams consume policies through [Certificate Profiles](/documentation/platform/pki/settings/profiles).
</Info>
...
![Certificate policy list](/images/platform/pki/certificate/cert-policy.png)

![Certificate policy modal](/images/platform/pki/certificate/cert-policy-modal.png)
