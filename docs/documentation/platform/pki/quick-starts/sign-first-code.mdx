...
<Steps>
  <Step title="Issue a Code Signing Certificate">
    First, issue a certificate for code signing. Go to **Certificate Manager → Certificate Policies** and select **Create**.
  ...
  <Step title="Create a Signer">
    Go to **Code Signing → Signers** and select **Create**.
