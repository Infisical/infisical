...
- Platform Admin permissions (to create CAs, policies, and profiles)
...
- Add [Signing Policies](/documentation/platform/pki/code-signing/signing-policies) for approval workflows
- Request signing access with [Grants](/documentation/platform/pki/code-signing/grants)
