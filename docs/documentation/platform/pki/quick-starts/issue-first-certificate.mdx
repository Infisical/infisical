...
<Steps>
  <Step title="Create a Certificate Authority">
    Go to **Certificate Manager → Certificate Authorities** and select **Create**.
  ...
  <Step title="Create a Certificate Policy">
    Go to **Certificate Policies** and select **Create**.
  ...
  <Step title="Create a Certificate Profile">
    Go to **Certificate Profiles** and select **Create**.
  ...
  <Step title="Create an Application">
    Go to **Certificate Manager → Applications** and select **Create**.
  ...
  <Step title="Configure Enrollment">
    In your Application, go to the **Settings** tab and find the **Certificate Profiles** section. Select **Configure** on the `web-servers` profile, then select **Add enrollment method** and select **API**.
  ...
  <Step title="Issue Certificate">
    In your Application, go to the **Certificate Requests** tab and select **Request Certificate**.
