...
2. **[Approval policies](/documentation/platform/pki/code-signing/approval-policies)** optionally add a human review step before signing is allowed, enforcing separation of duties.
