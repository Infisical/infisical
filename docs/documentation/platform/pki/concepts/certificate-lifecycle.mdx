...
[Learn more about Certificate Renewal →](/documentation/platform/pki/applications/certificate-renewal)
...
Remove a certificate from the inventory once it has expired. Discovered and imported certificates can be removed at any time. Certificate Cleanup can automate the removal of expired certificates to keep your inventory clean.
