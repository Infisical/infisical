...
<Tabs>
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl --request POST \
        --url https://app.infisical.com/api/v1/cert-manager/syncs/aws-elastic-load-balancer/{pkiSyncId}/certificates/{certificateId}/set-default \
        --header 'Authorization: Bearer <access-token>'
        ```
        ...
        ```bash Request
        curl --request DELETE \
        --url https://app.infisical.com/api/v1/cert-manager/syncs/aws-elastic-load-balancer/{pkiSyncId}/default-certificate \
        --header 'Authorization: Bearer <access-token>'
        ```
    </Tab>
</Tabs>
