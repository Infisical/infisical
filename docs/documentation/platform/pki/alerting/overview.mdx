...
<Warning>
  For certificates that cannot be renewed through Infisical, daily alerts will continue sending notifications every day until the original expiry date, as Infisical has no way to track external renewals.
</Warning>
