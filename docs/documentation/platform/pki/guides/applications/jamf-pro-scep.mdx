...
sidebarTitle: "Enroll Devices with Jamf Pro"
...
<Steps>
    <Step title="Gather SCEP details from Infisical">
        In your Application's **Enrollment Methods** section, locate your SCEP enrollment and gather the following values:
    ...
    <Step title="Verify certificate installation">
        ...
        You can also verify the certificate was issued by checking the **Certificates** section in your Application. The certificate enrolled via Jamf Pro will appear in the list.
    </Step>
</Steps>
