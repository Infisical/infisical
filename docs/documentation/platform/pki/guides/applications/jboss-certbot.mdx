...
<Steps>
    <Step title="Get ACME Credentials from Infisical">
        In your Application, go to the **Settings** tab and find the **Certificate Profiles** section. Select **Configure** on the profile with ACME enrollment, then select **Reveal ACME EAB** to view the credentials:
