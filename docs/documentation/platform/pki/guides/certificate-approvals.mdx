...
This guide walks through setting up [approval workflows](/documentation/platform/pki/certificates/approvals) for certificate issuance. Approval workflows add a human review step before certificates are issued, helping enforce separation of duties and meet compliance requirements.
...
<Steps>
  ...
  <Step title="Create an approval policy">
    Navigate to your Certificate Management Project > Certificate Manager > Approvals > Policies and click **Create Policy**. See the [guide to creating an approval policy](/documentation/platform/pki/certificates/approvals#guide-to-creating-an-approval-policy) for detailed instructions.
