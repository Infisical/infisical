...
<Info>
  This guide assumes your Platform Admin has already created a [Signer](/documentation/platform/pki/code-signing/signers) and assigned you to it. If the signer has a signing policy, you'll also need an approved [grant](/documentation/platform/pki/code-signing/grants) before signing.
</Info>
...
- A [Signer](/documentation/platform/pki/code-signing/signers) created by your Platform Admin (RSA keys recommended for GPG compatibility)
