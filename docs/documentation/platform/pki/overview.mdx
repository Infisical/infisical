...
sidebarTitle: "Certificate Management"
...
<CardGroup cols={2}>
  ...
  <Card title="Reference Architecture" icon="sitemap" href="/documentation/platform/pki/concepts/reference-architecture">
    Planning a rollout? See a reference layout for running your PKI across teams and environments.
  </Card>
</CardGroup>
