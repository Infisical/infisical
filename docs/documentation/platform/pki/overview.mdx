...
<CardGroup cols={2}>
  ...
  <Card title="Plan Your Rollout" icon="sitemap" href="/documentation/platform/pki/concepts/reference-architecture">
    Setting this up for multiple teams or environments? See a reference layout you can adapt.
  </Card>
</CardGroup>
