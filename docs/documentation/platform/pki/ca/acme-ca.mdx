    ...
    <Step title="Register an ACME-compatible CA">
        <Tabs>
          <Tab title="Infisical UI">
              ...
              Great! You’ve successfully registered an external ACME-compatible CA with Infisical. Now check out the [Applications](/documentation/platform/pki/applications/overview) section to learn more about how to issue X.509 certificates using the ACME-compatible CA.
          </Tab>
          <Tab title="API">
