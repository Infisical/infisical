...
Sectigo Certificate Manager (SCM) supports the ACME protocol and requires **External Account Binding (EAB)** for all ACME registrations. You'll need to obtain the ACME Directory URL, a Key Identifier (KID), and an HMAC Key from your Sectigo account before registering the ACME CA in Infisical.

## Guide to connecting Infisical to Sectigo

<Steps>
  <Step title="Retrieve ACME credentials from Sectigo">
    Log in to your Sectigo Certificate Manager (SCM) portal and navigate to **Manage > ACME Accounts** in the left sidebar. Select **Manage** on the ACME account you want to use.
