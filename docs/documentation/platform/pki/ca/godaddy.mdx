...
- An available **DV SSL** product in your GoDaddy account. The API consumes a product you already own; it doesn't purchase one (see the [FAQ](#faq)).
  ...
  <Tab title="Infisical UI">
    <Steps>
      ...
      <Step title="Create the External CA">
        In **Certificate Manager**, go to **Certificate Authorities**, select **Create CA** in the External Certificate Authorities section, choose **GoDaddy** as the type, and fill out the form:
...
| **Failed** | If GoDaddy doesn't issue within 24 hours. Complete validation and submit a new request. |
...
<AccordionGroup>
  <Accordion title='Why does issuance fail with "You do not have an available product"?'>
    GoDaddy's Certificates API consumes a certificate product you already own; it doesn't purchase
  ...
  <Accordion title="What happens when I revoke a GoDaddy-issued certificate in Infisical?">
    ...
    one-directional, though: a certificate revoked **directly on GoDaddy** isn't reflected back into
