  ...
  <Tab title="External CA">
    ...
    <Steps>
      <Step title="Navigate to External Certificate Authorities">
        In your Infisical project, go to **Certificate Manager → Settings → Certificate Authorities** and scroll to the **External Certificate Authorities** section.
      </Step>
      ...
      <Step title="Issue a Certificate">
        Within your Application, go to **Certificates** and click **Request**:
