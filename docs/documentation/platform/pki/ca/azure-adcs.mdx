...
## Signing Internal Intermediate CAs with AD CS
...
3. AD CS signs the certificate (immediately or after approval, depending on template config).
  ...
  <Tab title="Infisical UI">
    <Steps>
      ...
      <Step title="Open the Install Certificate Modal">
        Press **Install Certificate** on the intermediate CA. Select **External CA (Automated)** and press **Choose Integration**.
      </Step>
      <Step title="Select Azure AD CS">
        Choose **Azure AD CS** as the integration provider and press **Continue**.
      </Step>
