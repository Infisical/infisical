---
title: "Azure ADCS (Web Enrollment)"
description: "Learn how to issue and manage certificates using Microsoft Active Directory Certificate Services (AD CS) over HTTPS web enrollment."
---
  ...
  <Tab title="External CA">
    ...
    <Steps>
      ...
      <Step title="Create New Azure ADCS Certificate Authority">
        ...
        - **Type**: Choose **Azure ADCS (Web Enrollment)**
  ...
  <Tab title="Signing Internal Intermediate CAs">
    ...
    <Tabs>
      <Tab title="Infisical UI">
        <Steps>
          ...
          <Step title="Select Azure ADCS (Web Enrollment)">
            Choose **Azure ADCS (Web Enrollment)** as the integration provider.
          </Step>
    ...
    <Tabs>
      <Tab title="Infisical UI">
        ...
        The renewal modal will confirm that this CA is configured to use Azure ADCS for signing. Press **Renew via ADCS** to submit a new CSR to ADCS and install the renewed certificate.
      </Tab>
      <Tab title="API">
