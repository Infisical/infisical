...
<Steps>
    ...
    <Step title="Creating an intermediate CA">
        ...
        Next, press the **Install Certificate** option on the intermediate CA.
        ...
        <Tabs>
          <Tab title="Infisical CA">
            ...
            Set the **Parent CA** to the root CA created in step 1 and configure the intended **Valid Until** and **Path Length** fields on the intermediate CA; feel free to use the prefilled values.
