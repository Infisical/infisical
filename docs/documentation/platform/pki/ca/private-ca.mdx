...
<AccordionGroup>
  ...
  <Accordion title="Does Infisical support chaining an Intermediate CA to an external CA?">
    ...
    like [Venafi TLS Protect Cloud](/documentation/platform/pki/ca/venafi) or [Azure AD CS](/documentation/platform/pki/ca/azure-adcs#signing-internal-intermediate-cas-with-ad-cs) to automate the signing process.
  </Accordion>
</AccordionGroup>
