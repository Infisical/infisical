...
| **External Private CAs** | AWS Private CA, Venafi, Microsoft ADCS | Internal services, cloud-hosted or on-prem |
...
<CardGroup cols={2}>
  <Card title="ACME CA (Generic)" icon="bot" href="/documentation/platform/pki/ca/acme-ca">
  ...
  <Card title="AWS ACM Public CA" icon="aws" iconType="brands" href="/documentation/platform/pki/ca/aws-acm-public-ca">
  ...
  <Card title="DigiCert Direct" icon="shield-half" href="/documentation/platform/pki/ca/digicert-direct">
    Direct integration with DigiCert infrastructure.
  </Card>
  <Card title="Sectigo" icon="award" href="/documentation/platform/pki/ca/sectigo">
...
<CardGroup cols={2}>
  <Card title="AWS Private CA" icon="aws" iconType="brands" href="/documentation/platform/pki/ca/aws-pca">
    Cloud-native private certificate management via AWS PCA.
  </Card>
  <Card title="Microsoft ADCS" icon="microsoft" iconType="brands" href="/documentation/platform/pki/ca/adcs">
    Microsoft AD CS over MS-WCCE through an Infisical Gateway.
  </Card>
  <Card title="Azure ADCS (Web Enrollment)" icon="microsoft" iconType="brands" href="/documentation/platform/pki/ca/azure-adcs">
    Microsoft AD CS over HTTPS web enrollment.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Internal CA" icon="landmark" href="/documentation/platform/pki/ca/private-ca">
  ...
  <Card title="Certificate Profiles" icon="file-badge" href="/documentation/platform/pki/settings/profiles">
