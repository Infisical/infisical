...
<AccordionGroup>
  <Accordion title="Can I use both Private CAs and External CAs in the same product?">
    Yes. You can have both Private and External CAs in the same Certificate Manager product.
  </Accordion>
</AccordionGroup>
