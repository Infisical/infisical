  ...
  <Tab title="Infisical UI">
    <Steps>
      ...
      <Step title="Start renewal">
        Select **Renew CA** on the left side of the CA detail page.
      </Step>
      <Step title="Set new validity">
        Input a new **Valid Until** date for the renewed CA certificate and select **Renew**.
...
<CardGroup cols={2}>
  ...
  <Card title="Create CA Hierarchy" icon="network" href="/documentation/platform/pki/ca/private-ca">
