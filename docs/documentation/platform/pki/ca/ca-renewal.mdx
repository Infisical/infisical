...
<Info>
  This page is for platform admins managing PKI infrastructure. If you're looking to renew end-entity certificates, see [Applications](/documentation/platform/pki/applications/overview).
</Info>
  ...
  <Tab title="Infisical UI">
    <Steps>
      ...
      <Step title="Start renewal">
        ...
        ![pki ca renewal page](/images/platform/pki/ca-renewal-page.png)
      </Step>
      <Step title="Set new validity">
        Input a new **Valid Until** date for the renewed CA certificate and click **Renew**.
        
        ![pki ca renewal modal](/images/platform/pki/ca-renewal-modal.png)
