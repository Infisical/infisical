...
<CardGroup cols={2}>
  ...
  <Card title="External CA" icon="landmark" href="/documentation/platform/pki/ca/external-ca">
...
<CardGroup cols={3}>
  ...
  <Card title="AWS PCA" icon="aws" iconType="brands" href="/documentation/platform/pki/ca/aws-pca">
  ...
  <Card title="Azure ADCS (Web Enrollment)" icon="microsoft" iconType="brands" href="/documentation/platform/pki/ca/azure-adcs">
    Active Directory Certificate Services over HTTPS web enrollment.
  </Card>
  <Card title="Venafi" icon="building" href="/documentation/platform/pki/ca/venafi">
    Enterprise certificate lifecycle management.
  </Card>
  <Card title="ACME CAs" icon="bot" href="/documentation/platform/pki/ca/acme-ca">
