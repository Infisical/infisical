...
The profile form also has a separate **Certificate Details** tab where you can pre-configure certificate values that are applied when a requester does not specify them. See [Profile Defaults](#profile-defaults) below for more details.
