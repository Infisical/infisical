...
<Steps>
    ...
    <Step title="Configure SCIM in Azure">
        ...
        - Tenant URL: Input the **SCIM URL** from Step 1. When Microsoft Entra ID (Azure)
          SAML is configured for your organization, Infisical automatically appends the
          `?aadOptscim062020` feature flag to this URL.
        ...
        <Info>
            ...
            `active` attribute and using lowercase `op` values. See Microsoft's documentation on
