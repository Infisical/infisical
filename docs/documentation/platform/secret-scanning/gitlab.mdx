...
1. Navigate to your Secret Scanning Project's Dashboard and select the **Add Data Source** button.
...
3. Configure which workspace and repositories you would like to scan. Then select **Next**.
...
4. Give your data source a name and description (optional). Then select **Next**.
...
5. Review your data source, then select **Create Data Source**.
...
7. You can view repositories and scan results by selecting your data source.
