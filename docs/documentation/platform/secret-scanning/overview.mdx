...
- Detection Engine: Identify potential secrets using pattern matching and entropy analysis.
...
- Noise Reduction: [Skip known secrets](/documentation/platform/secret-scanning/usage#ignoring-known-secrets) with `infisical-scan:ignore` comments or a `.infisicalignore` file to reduce false positives.
