...
Resources from the root organization (users, groups, machine identities) can be inherited to sub-organizations, but resources never flow upward. Each sub-organization maintains its own isolated set of projects and app connections.
