...
Selecting a product on the organization overview opens the projects of that type. **My Projects** lists the ones you're a member of.
...
Audit logs are also viewable at the project level, where they're scoped to show only events relevant to that specific project. This allows project administrators to monitor activity and investigate changes without requiring organization-wide access.
