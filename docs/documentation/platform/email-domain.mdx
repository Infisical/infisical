...
<Steps>
  <Step title="Navigate to Email Domain Settings">
    Go to **Organization Settings** → **SSO** → scroll down to the **Email Domains** section.
  ...
  <Step title="Copy DNS Verification Details">
    After adding the domain, select the **eye icon** (View details & Verify) on the pending domain row.
  ...
  <Step title="Verify the Domain">
    Return to the Infisical Email Domains section and select **View details & Verify** on the pending domain.
