...
## How It Works
The system uses a pubsub broker to send messages between servers. 
When something changes on one server, a message is sent to all other connected servers and to keep them in sync.
