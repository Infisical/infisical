...
<Note>
  Event Subscriptions are designed for real-time communication and don't include persistence or replay
  capabilities—events are delivered once and aren't stored for future retrieval. Ensure your application
