...
<Tip>
  You can hold the `Cmd` (Mac) or `Ctrl` (Windows/Linux) key and select the secret reference to be redirected to it. 
</Tip>
...
1. Select the downward chevron next to **Add Secret** and select **Add Import**.
