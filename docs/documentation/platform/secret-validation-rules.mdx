...
Each constraint _(except Prevent Value Reuse)_ can be applied to either the secret key or the secret value. **Prevent Value Reuse** applies only to the secret value.
