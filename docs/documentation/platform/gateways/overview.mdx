  ...
  <Step title="Deploy the Gateway">
    ...
    <Tabs>
      ...
      <Tab title="Production (Helm)">
        ...
        The Gateway can be install via [Helm](https://helm.sh/). Helm is a package manager for Kubernetes that allows you to define, install, and upgrade Kubernetes applications.
