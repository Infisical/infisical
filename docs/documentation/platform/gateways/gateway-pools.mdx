...
2. Select the **Gateway Pools** tab.
...
1. In the **Gateway Pools** tab, select a pool to open its detail view.

![Select a pool](../../../images/platform/gateways/gateway-pools-click-pool.png)

2. Select **Add Gateway** and select a gateway from the dropdown.
