...
For systemd-based installations, the configuration is at `/etc/infisical/gateways/<name>.conf`. All config files are created with restricted permissions (0600).
</Accordion>
