...
A gateway can also run both, which is mainly how you switch an existing gateway between modes without an outage. See [Switching modes without an outage](/documentation/platform/gateways/gateway-deployment#switching-modes-without-an-outage).
