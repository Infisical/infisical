...
<Note>
  Rotation is supported for encrypt-decrypt keys with Infisical-managed key material. Sign-verify keys
  should be rotated manually by creating a new key and updating your applications to use it.
</Note>
