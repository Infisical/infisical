    ...
    <Tab title="Infisical UI">
        <Steps>
            <Step title="Creating a KMS key">
                Navigate to Project > Key Management and select the **Add Key** button.
    ...
    <Tab title="Infisical UI">
        <Steps>
            ...
            <Step title="Verifying a MAC with the KMS key">
                Select verify MAC, paste your MAC and data into the text areas, and select the Verify MAC button.
