    ...
    <Accordion title="Splunk">
        ...
        <Steps>
            ...
            <Step title="Create Audit Log Stream on Infisical">
                ...
                Input your **Splunk Hostname** and the **Token** obtained from step 1, then pick the **Port** your deployment serves the HTTP Event Collector on.
        ...
        <Note>
            **Splunk Cloud serves the HTTP Event Collector on port 443.** Port `8088` applies to Splunk Enterprise and to Splunk Cloud free trials. On every other Splunk Cloud Platform stack, select `443`.
            ...
            Replace `<stack>` with your stack name. **Port** defaults to `8088`.
        </Note>
    </Accordion>
