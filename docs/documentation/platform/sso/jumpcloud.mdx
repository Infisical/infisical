...
<Steps>
   <Step title="Prepare the SAML SSO configuration in Infisical">
      In Infisical, head to the **Single Sign-On (SSO)** page and select the **General** tab. Select **Connect** for **SAML** under the Connect to an Identity Provider section. Select **JumpCloud**, then select **Connect** again.
