...
<Steps>
   ...
   <Step title="Create an OIDC application in Okta">
      ...
      {/* SCREENSHOT PLACEHOLDER: Screenshot of Okta Admin Portal showing the Applications page with the "Create App Integration" button highlighted - save as images/sso/okta-oidc/create-app-integration.png */}
      ...
      {/* SCREENSHOT PLACEHOLDER: Screenshot of the "Create a new app integration" dialog with "OIDC - OpenID Connect" and "Web Application" options selected - save as images/sso/okta-oidc/create-oidc-app.png */}
      ...
      {/* SCREENSHOT PLACEHOLDER: Screenshot of the "New Web App Integration" configuration page showing the app name, grant type, and redirect URI fields - save as images/sso/okta-oidc/app-settings.png */}
   ...
   <Step title="Retrieve Identity Provider (IdP) Information from Okta">
      ...
      {/* SCREENSHOT PLACEHOLDER: Screenshot of the Okta application's General tab showing the Client ID and Client Secret fields - save as images/sso/okta-oidc/client-credentials.png */}
      ...
      {/* SCREENSHOT PLACEHOLDER: Screenshot highlighting the Okta domain in the browser address bar - save as images/sso/okta-oidc/okta-domain.png */}
   ...
   <Step title="Finish configuring OIDC in Infisical">
      ...
      {/* SCREENSHOT PLACEHOLDER: Screenshot of the Infisical OIDC configuration form with the Discovery URL, Client ID, Client Secret, and JWT Signature Algorithm fields filled in - save as images/sso/okta-oidc/infisical-oidc-config.png */}
   ...
   <Step title="Assign users in Okta to the application">
      ...
      {/* SCREENSHOT PLACEHOLDER: Screenshot of the Okta application's Assignments tab showing the Assign dropdown with "Assign to People" and "Assign to Groups" options - save as images/sso/okta-oidc/assignment.png */}
