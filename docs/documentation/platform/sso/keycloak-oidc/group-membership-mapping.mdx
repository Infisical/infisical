...
<Warning>
    ...
    user logs in via OIDC. For example, if you remove a user from a group in Keycloak, this change won't be reflected in Infisical until their next OIDC login. To ensure this behavior, Infisical recommends enabling Enforce OIDC
