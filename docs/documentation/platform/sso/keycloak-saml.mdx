...
<Steps>
   <Step title="Prepare the SAML SSO configuration in Infisical">
      In Infisical, head to the **Single Sign-On (SSO)** page and select the **General** tab. Select **Connect** for **SAML** under the Connect to an Identity Provider section. Select **Keycloak**, then select **Connect** again.
   ...
   <Step title="Create a SAML client application in Keycloak">
      2.1. In your realm, navigate to the **Clients** tab and select **Create client** to create a new client application.
      ...
      Set the **Name** field to **Username**, the **Property** field to **username**, and the **SAML Attribute Name** to **username**.
