...
description: "Why Infisical introduced non-E2EE projects and what upgrading one changes."
---
...
This won't only reduce confusion for end users, but will also make the Infisical API seamless to use.
