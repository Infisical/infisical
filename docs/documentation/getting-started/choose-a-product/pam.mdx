...
<Card title="PAM docs" icon="users" href="/documentation/platform/pam/overview">
...
<CardGroup cols={2}>
  ...
  <Card title="Give AI agents scoped access" icon="bot" href="/documentation/platform/pam/ai-agents/overview">
