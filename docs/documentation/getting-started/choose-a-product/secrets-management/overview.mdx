...
<Card title="Secrets Management docs" icon="key" href="/documentation/platform/secrets-mgmt/overview">
...
<CardGroup cols={2}>
  <Card title="Deliver secrets to running apps" icon="truck" href="/documentation/platform/secrets-mgmt/quick-starts/deliver-first-secret">
    Fetch secrets from Infisical at runtime through the CLI, SDKs, agents, Kubernetes, or CI/CD.
  </Card>
  <Card title="Replace .env in local development" icon="laptop" href="/documentation/guides/local-development">
...
<CardGroup cols={1}>
  <Card title="Sync secrets to third-party stores" icon="refresh-cw" href="/integrations/secret-syncs/overview">
...
<CardGroup cols={2}>
  <Card title="Rotate a long-lived credential" icon="refresh-cw" href="/documentation/platform/secret-rotation/overview">
...
<CardGroup cols={1}>
  <Card title="Broker credentials to AI agents" icon="bot" href="/documentation/platform/agent-proxy/overview">
