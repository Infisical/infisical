...
<Card title="KMS docs" icon="lock" href="/documentation/platform/kms/overview">
...
<CardGroup cols={2}>
  ...
  <Card title="Sign and verify with a KMS key" icon="pen-tool" href="/documentation/platform/kms/overview">
    Sign payloads with an asymmetric key managed centrally, and verify signatures without holding the key.
  </Card>
  <Card title="Back the root key with an HSM" icon="cpu" href="/self-hosting/guides/hsm-integration">
