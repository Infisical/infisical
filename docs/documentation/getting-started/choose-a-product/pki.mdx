...
<Card title="Certificate Management docs" icon="file-key" href="/documentation/platform/pki/overview">
...
<CardGroup cols={2}>
  <Card title="Issue TLS and mTLS certificates" icon="award" href="/documentation/platform/pki/applications/overview">
    Issue certificates for web servers, service-to-service authentication, and device identity.
  </Card>
  <Card title="Enroll devices with ACME, EST, or SCEP" icon="smartphone" href="/documentation/platform/pki/applications/enrollment-methods/overview">
    Issue certificates to devices using an enrollment protocol supported by the device or its management system.
  </Card>
  <Card title="Sync certificates to cloud destinations" icon="refresh-cw" href="/documentation/platform/pki/applications/certificate-syncs/overview">
  ...
  <Card title="Sign code with centralized keys" icon="file-pen" href="/documentation/platform/pki/code-signing/overview">
