...
<CardGroup cols={2}>
  ...
  <Card title="Manage certificates" icon="file-badge" href="/documentation/getting-started/choose-a-product/pki">
  ...
  <Card title="Manage privileged access" icon="shield-user" href="/documentation/getting-started/choose-a-product/pam">
