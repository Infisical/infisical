---
title: "Docker"
description: "Add the Infisical CLI to a Dockerfile so your container receives secrets as environment variables."
---
...
See the [Docker secrets delivery guide](/integrations/platforms/docker) for the recommended startup, Docker Run, and Docker Compose workflows.
