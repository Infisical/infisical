...
Infisical tracks hundreds of event types across the platform, including secret access, permission changes, certificate issuance, SSH session activity, and identity management.
