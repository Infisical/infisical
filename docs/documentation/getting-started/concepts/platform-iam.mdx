...
description: "How users, machine identities, roles, and permissions are managed."
---

<Card title="Identity and access docs" icon="id-card" href="/documentation/platform/identities/overview">
  User identities, machine identities, groups, SSO, SCIM, and access control.
</Card>
