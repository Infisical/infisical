...
sidebarTitle: "Account structure"
description: "How organizations and projects are structured in Infisical."
---

<Card title="Organizations docs" icon="building" href="/documentation/platform/organization">
  Organization settings, projects, audit logs, admin console, and organization planning.
</Card>
...
- An Agent Vault project brokers outbound API calls from AI agents through stored credentials.
