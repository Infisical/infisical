...
<Card title="Self-hosting docs" icon="server" href="/self-hosting/overview">
  Deployment options, configuration, upgrades, and reference architectures for running Infisical yourself.
</Card>
