...
<Note>
Infisical spans several products—[Secrets Management](/documentation/platform/secrets-mgmt/overview), [Certificate Manager](/documentation/platform/pki/overview), [KMS](/documentation/platform/kms/overview), [Secret Scanning](/documentation/platform/secret-scanning/overview), and [Privileged Access Manager](/documentation/platform/pam/overview). This guide focuses on Secrets Management, but the same governance foundations—organization structure, authentication and identity, access control, approval workflows, and audit—apply across all of them.
</Note>
