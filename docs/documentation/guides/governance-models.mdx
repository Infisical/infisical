...
<Note>
Infisical spans several products: [Secrets Management](/documentation/platform/secrets-mgmt/overview), [Certificate Manager](/documentation/platform/pki/overview), [KMS](/documentation/platform/kms/overview), [Secret Scanning](/documentation/platform/secret-scanning/overview), [Privileged Access Management](/documentation/platform/pam/overview), and [Agent Vault](/documentation/platform/agent-vault/overview). This guide focuses on Secrets Management, but the same governance foundations apply across all of them: organization structure, authentication and identity, access control, approval workflows, and audit.
</Note>
