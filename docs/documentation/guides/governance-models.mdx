...
[Secret referencing](/documentation/platform/secret-reference) and [imports](/documentation/platform/secret-reference) allow secrets to be shared across environments and folders within the same project. This helps reduce duplication when the same secret is needed in multiple environments.
...
- [Infisical Kubernetes Operator](/integrations/platforms/kubernetes) — Syncs secrets to Kubernetes Secrets resources
