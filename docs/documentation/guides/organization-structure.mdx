...
- **Definition**: Not everything in Infisical is a secret. Infisical is organized into several **products**, each purpose-built for a different security use case, with its own dashboard, workflows, and capabilities.
- **Supported Products**:
