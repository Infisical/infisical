...
- **Examples**:
    ...
    - **[App Connections](/integrations/app-connections/overview)**: reusable third-party credentials (AWS, GCP, GitHub, and more) used by features such as [secret syncs](/integrations/secret-syncs/overview) and [dynamic secrets](/documentation/platform/dynamic-secrets/overview).
