...
- **Supported Products**:
    ...
    - **[Agent Vault](/documentation/platform/agent-vault/overview)**: Broker outbound API calls from AI agents through a proxy so agents never hold real credentials.
- **How Products Are Structured**: Products differ in how they organize work, so not everything is project-based:
    ...
    - **Certificate Manager**, **Privileged Access Manager**, and **Agent Vault** operate at the organization level as a single workspace, rather than a list of separate projects.
