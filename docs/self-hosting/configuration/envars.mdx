...
>
  ...
  <ParamField query="SECRET_SCANNING_STUCK_SCAN_TIMEOUT" type="string" default="1h" optional>
    ...
    exceed the clone and scan timeouts plus the time a scan spends measuring the repository,
    enumerating its commits and writing its results; the server refuses to start otherwise.
  </ParamField>
</Accordion>
