...
>
  ...
  <ParamField query="SECRET_SCANNING_STUCK_SCAN_TIMEOUT" type="string" default="1h" optional>
    How long a scan may stay in progress before it is assumed dead — its worker was killed — and
    marked failed. Takes a duration string such as `90s`, `10m`, or `2h`. Defaults to `1h`. Must
