...
<Tabs>
  <Tab title="Required">
    ...
    <ParamField query="DB_CONNECTION_URI" type="string" default="none" required>
      Postgres connection url. For SSL connection pass the certificate as Base64 in `DB_ROOT_CERT`
    </ParamField>
...
<ParamField query="DB_ROOT_CERT" type="string" default="none" optional>
  SSL CA certificate for Postgres Database connection. Must be base64.
</ParamField>
