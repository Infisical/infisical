...
Before you start deployment, you will need to obtain document db connection string. This will be used for `DB_CONNECTION_URI` environment variable required during installation.
