---
title: "Docker"
sidebarTitle: "Standalone container"
...
This Docker image only includes the application code, meaning you must supply a connection to a PostgreSQL database and a Redis instance.
