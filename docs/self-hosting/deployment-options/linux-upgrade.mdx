...
Upgrades for PostgreSQL and Redis aren't covered in this guide as they depend on your specific database deployment method.
...
Restore your PostgreSQL/Redis database from backup.
</Step>
