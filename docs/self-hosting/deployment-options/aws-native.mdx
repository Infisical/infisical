...
<AccordionGroup>
  <Accordion title="Terraform Example">
    ...
    # See full Terraform module at: https://github.com/Infisical/infisical-terraform-aws
    ```

    <Note>
      For a complete, production-ready Terraform module, see the [Infisical AWS Terraform Module](https://github.com/Infisical/infisical-terraform-aws) (if available) or adapt the example above.
    </Note>
  </Accordion>
