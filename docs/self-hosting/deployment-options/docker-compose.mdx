...
<Tip>
  Want a one-click deployment instead of running Docker Compose yourself? [Easypanel](https://easypanel.io) is a self-hosted Docker deployment platform, and Infisical has a one-click deployment template there: https://easypanel.io/templates/infisical
</Tip>
