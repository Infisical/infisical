...
<Steps>
  <Step title="Generate a new key">
    In the [Server Console](/documentation/platform/admin-panel/server-admin), go to **Encryption** and select **Generate New Key** under **Root Encryption Keys**.
...
| ----------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| Before any instance restarts                                | Nothing has changed. The generated key is still waiting, so select the discard icon on its row if you are abandoning the rotation. |
