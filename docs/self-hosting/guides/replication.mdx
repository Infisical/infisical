...
title: "Replication"
sidebarTitle: "Multi-region replication"
...
<Tabs>
  ...
  <Tab title="Secondary region configuration">
   ...
   2. PostgreSQL primary instance connection details. View related [environment variables](/self-hosting/configuration/envars#postgresql).
   3. PostgreSQL read replica connection details. View related [environment variables](/self-hosting/configuration/envars#postgresql).
