...
request changed. Local and CI results therefore match. You can also run `vale <path>`
directly on a subset. A run fails only on errors; warnings and suggestions are printed but
do not block.
