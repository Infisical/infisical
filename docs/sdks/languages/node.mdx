...
description: "Fetch and manage secrets in a Node.js application with the official Infisical Node.js SDK."
...
```typescript
	const newSecret = await client.secrets().createSecret("SECRET_NAME", {
		...
		secretPath: "/prod/backend",                         // Optional
