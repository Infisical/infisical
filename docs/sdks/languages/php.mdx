...
sidebarTitle: "PHP"
description: "Fetch and manage secrets in a PHP application with the official Infisical PHP SDK."
...
<Warning>
  We don't recommend hardcoding your [Machine Identity Tokens](/documentation/platform/identities/overview). Setting them as environment variables would be best.
</Warning>
