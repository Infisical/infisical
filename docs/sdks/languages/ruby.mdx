...
<Note>
  Version 3.0.0 is a native Ruby rewrite of the SDK and replaces the deprecated `infisical-sdk` gem. It is not a drop-in replacement for versions prior to `3.0.0` — the client API has changed.
</Note>
