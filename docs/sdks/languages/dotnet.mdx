...
sidebarTitle: ".NET"
description: "Fetch and manage secrets in a .NET application with the official Infisical .NET SDK."
...
<Warning>
  PKI subscribers are being removed on December 15, 2026. Until the .NET SDK supports
  [certificate applications](/documentation/platform/pki/applications/overview), issue certificates
  by calling the [application API
  endpoints](/documentation/platform/pki/applications/enrollment-methods/api) directly. Certificates
  you've already issued stay valid.
</Warning>
