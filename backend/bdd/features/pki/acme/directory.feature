Feature: Directory
  ...
  Scenario: Get the directory of ACME service urls
    ...
    When I send a "GET" request to "/api/v1/cert-manager/acme/applications/{acme_profile.app_id}/profiles/{acme_profile.id}/directory"
    ...
    And the response body should match JSON value
      """
      {
        ...
        "newAccount": "{BASE_URL}/api/v1/cert-manager/acme/applications/{acme_profile.app_id}/profiles/{acme_profile.id}/new-account",
