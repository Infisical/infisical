...
import { openAIAdminApiKeyRotationFactory } from "./openai-admin-api-key/openai-admin-api-key-rotation-fns";
...
const SECRET_ROTATION_FACTORY_MAP: Record<SecretRotation, TRotationFactoryImplementation> = {
  ...
  [SecretRotation.OpenAIAdminApiKey]: openAIAdminApiKeyRotationFactory as TRotationFactoryImplementation,
