...
export const OCSP_GENERATION_TTL_SECONDS = 24 * 60 * 60;
export const STORED_SERIAL_HEX_LENGTH = 40;
export const OCSP_MAX_CERT_IDS_PER_CACHED_REQUEST = 8;
export const OCSP_MAX_CONCURRENT_SIGNATURES = 8;
export const OCSP_MAX_CONCURRENT_SIGNATURES_PER_CA = 4;
...
export const OCSP_LOG_THROTTLE_WINDOW_MS = 10_000;
export const OCSP_SATURATION_LOGS_PER_WINDOW = 1;
export const OCSP_REJECTION_LOGS_PER_WINDOW = 1;
export const OCSP_ERROR_LOGS_PER_WINDOW = 3;
export const OCSP_MAX_TRACKED_LOG_KEYS = 256;
