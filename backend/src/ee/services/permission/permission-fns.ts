...
const validatePrivilegeChangeOperation = (
  ...
  opAction: OrgPermissionSet[0] | NamespacePermissionSet[0] | ProjectPermissionSet[0],
  opSubject: OrgPermissionSet[1] | NamespacePermissionSet[1] | ProjectPermissionSet[1],
