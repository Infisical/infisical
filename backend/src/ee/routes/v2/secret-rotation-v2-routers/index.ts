...
import { registerOpenAIAdminApiKeyRotationRouter } from "./openai-admin-api-key-rotation-router";
...
> = {
  ...
  [SecretRotation.OpenAIAdminApiKey]: registerOpenAIAdminApiKeyRotationRouter,
