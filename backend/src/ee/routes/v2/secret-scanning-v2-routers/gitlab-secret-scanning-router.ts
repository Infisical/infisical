...
import {
  ...
  UpdateGitLabSecretScanningDataSourceSchema
...
export const registerGitLabSecretScanningRouter = async (server: FastifyZodProvider) =>
  registerSecretScanningEndpoints({
    ...
    server,
    responseSchema: GitLabSecretScanningDataSourceSchema,
    createSchema: CreateGitLabSecretScanningDataSourceSchema,
    updateSchema: UpdateGitLabSecretScanningDataSourceSchema
  });
