        ...
        200: z.object({
          ...
          services: z
            .object({
              ...
              allowedMethods: z.string().array().nullable(),
              allowedPathPrefixes: z.string().array().nullable(),
              credential: z.discriminatedUnion("type", [
                ...
                z.object({ type: z.literal("passthrough") }).describe(JSON.stringify({ title: "Pass-through" }))
              ]),
