...
export enum SmtpTemplates {
  ...
  NamespaceInvite = "namespaceInvitation",
...
const EmailTemplateMap: Record<SmtpTemplates, React.FC<any>> = {
  ...
  [SmtpTemplates.ProjectInvite]: ProjectInvitationTemplate,
  [SmtpTemplates.NamespaceInvite]: NamespaceInvitationTemplate,
