...
export const SecretSyncFns = {
  syncSecrets: (
    ...
    switch (secretSync.destination) {
      ...
      case SecretSync.GitHub:
        return GithubSyncFns.syncSecrets(secretSync, schemaSecretMap, gatewayV2Service, gatewayPoolService, {
          gitHubAppDAL,
          kmsService
        });
      ...
      case SecretSync.HCVault:
        return HCVaultSyncFns.syncSecrets(secretSync, schemaSecretMap, gatewayV2Service, gatewayPoolService);
  ...
  removeSecrets: (
    ...
    switch (secretSync.destination) {
      ...
      case SecretSync.GitHub:
        return GithubSyncFns.removeSecrets(secretSync, schemaSecretMap, gatewayV2Service, gatewayPoolService, {
          gitHubAppDAL,
          kmsService
        });
      case SecretSync.GCPSecretManager:
      ...
      case SecretSync.HCVault:
        return HCVaultSyncFns.removeSecrets(secretSync, schemaSecretMap, gatewayV2Service, gatewayPoolService);
      case SecretSync.TeamCity:
