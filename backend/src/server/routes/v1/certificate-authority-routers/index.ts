...
import { registerADCSCertificateAuthorityRouter } from "./adcs-certificate-authority-router";
...
import { registerGoDaddyCertificateAuthorityRouter } from "./godaddy-certificate-authority-router";
