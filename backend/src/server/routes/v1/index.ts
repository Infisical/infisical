...
import { registerUserSecretManagementRouter } from "./user-secret-management-router";
...
export const registerV1Routes = async (server: FastifyZodProvider) => {
  ...
  await server.register(registerUserSecretManagementRouter, { prefix: "/user-secrets" });
};
