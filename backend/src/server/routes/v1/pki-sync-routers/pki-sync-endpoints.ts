...
export const registerSyncPkiEndpoints = ({
  ...
  if (syncOptions.canImportCertificates) {
    server.route({
      ...
      schema: {
        hide: false,
        operationId: "importPkiSyncCertificates",
        tags: [ApiDocsTags.PkiSyncs],
  ...
  server.route({
    ...
    schema: {
      hide: false,
      operationId: "removePkiSyncCertificates",
      tags: [ApiDocsTags.PkiSyncs],
