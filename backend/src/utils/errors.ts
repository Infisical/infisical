...
//* ----->[GENERAL HTTP ERRORS]<-----
export const RouteNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
...
export const MethodNotAllowedError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.INFO,
...
export const UnauthorizedRequestError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.INFO,
...
export const ForbiddenRequestError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.INFO,
...
export const BadRequestError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.INFO,
...
export const ResourceNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.INFO,
    statusCode: error?.statusCode ?? 404,
...
export const InternalServerError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
...
export const ServiceUnavailableError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
...
export const ValidationError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 400,
...
export const IntegrationAuthNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 404,
...
//* ----->[INTEGRATION ERRORS]<-----
export const IntegrationNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 404,
...
//* ----->[WORKSPACE ERRORS]<-----
export const WorkspaceNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 404,
...
export const MembershipNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 404,
...
//* ----->[ORGANIZATION ERRORS]<-----
export const OrganizationNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 404,
...
export const MembershipOrgNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 404,
...
//* ----->[ACCOUNT ERRORS]<-----
export const AccountNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 404,
...
//* ----->[SECRET ERRORS]<-----
export const SecretNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 404,
...
export const SecretBlindIndexDataNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 404,
...
export const SecretSnapshotNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 404,
...
//* ----->[ACTION ERRORS]<-----
export const ActionNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 404,
...
export const ServiceTokenDataNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 404,
...
//* ----->[API KEY DATA ERRORS]<-----
export const APIKeyDataNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 404,
...
export const ServiceAccountNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 404,
...
export const ServiceAccountKeyNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 404,
...
export const BotNotFoundError = (error?: Partial<RequestErrorContext>) =>
  new RequestError({
    logLevel: error?.logLevel ?? LogLevel.ERROR,
    statusCode: error?.statusCode ?? 404,
