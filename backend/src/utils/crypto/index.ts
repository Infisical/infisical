...
} from "@app/interfaces/utils";
import { BadRequestError } from "../errors";
import { ALGORITHM_AES_256_GCM, BLOCK_SIZE_BYTES_16 } from "@app/variables";
 ...
 */
const encryptSymmetric128BitHexKeyUTF8 = ({ plaintext, key }: IEncryptSymmetricInput) => {
 ...
 */
const decryptSymmetric128BitHexKeyUTF8 = ({ ciphertext, iv, tag, key }: IDecryptSymmetricInput) => {
  const decipher = crypto.createDecipheriv(ALGORITHM_AES_256_GCM, key, Buffer.from(iv, "base64"));
