import { getEncryptionKey, getRootEncryptionKey } from "@app/config";
import { InternalServerError } from "@app/utils/errors";
...
export const validateEncryptionKeysConfig = async () => {
  ...
  if (
    ...
    throw InternalServerError({
      message:
        "Failed to find required root encryption key environment variable. Please make sure that you're passing in a ROOT_ENCRYPTION_KEY environment variable."
    });
