...
import { getLicenseKey, getLicenseServerKey, getLicenseServerUrl } from "./index";
...
licenseServerKeyRequest.interceptors.request.use(
  (config) => {
...
licenseServerKeyRequest.interceptors.response.use(
  (response) => {
    return response;
  },
  async function (err) {
...
licenseKeyRequest.interceptors.request.use(
  (config) => {
...
licenseKeyRequest.interceptors.response.use(
  (response) => {
    return response;
  },
  async function (err) {
