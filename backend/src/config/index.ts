...
export const getClientIdGCPSecretManager = () => infisical.get('CLIENT_ID_GCP_SECRET_MANAGER')!;
...
export const getClientSecretGCPSecretManager = () => infisical.get('CLIENT_SECRET_GCP_SECRET_MANAGER')!;
