...
export enum TableName {
  ...
  Alarm = "alarms",
  AlarmChannel = "alarm_channels",
  AlarmChannelRecipient = "alarm_channel_recipients",
  AlarmChannelMembership = "alarm_channel_memberships",
  AlarmHistory = "alarm_history",
  AlarmHistoryTarget = "alarm_history_target",
  Groups = "groups",
