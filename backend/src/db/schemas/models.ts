...
export enum TableName {
  ...
  InternalConsumerSecretsKmsKeyVersion = 'internal_consumer_secrets_kms_key_version',
  InternalConsumerSecretsKms = 'internal_consumer_secrets_kms',
  ExternalConsumerSecretsKms = 'external_consumer_secrets_kms',
  ConsumerSecretsKmsServerRootConfig = 'consumer_secrets_kms_root_config',
  PkiAlert = 'pki_alerts',
