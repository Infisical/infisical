...
type TCacheKeyStore = Pick<TKeyStoreFactory, "getItem" | "setItemWithExpiry" | "ttl">;
 ...
 */
export const getCacheTtl = async (keyStore: TCacheKeyStore, key: string): Promise<number> => {
  try {
