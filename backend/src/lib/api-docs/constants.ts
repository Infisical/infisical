...
export const PROJECT_IDENTITIES = {
  ...
  UPDATE_IDENTITY_MEMBERSHIP: {
    ...
    roles: {
      ...
      temporaryRange:
        'Expiry time for temporary access. In relative mode it could be 1s, 2m ,3h, etc.',
...
export const DASHBOARD = {
  SECRET_OVERVIEW_LIST: {
    ...
    offset:
      'The offset to start from. If you enter 10, it will start from the 10th secret/folder.',
    ...
    includeDynamicSecrets:
      'Whether to include dynamic project secrets in the response.',
  },
  SECRET_DETAILS_LIST: {
    projectId: 'The ID of the project to list secrets/folders from.',
    ...
    includeFolders: 'Whether to include project folders in the response.',
    includeImports:
      'Whether to include project secret imports in the response.',
    includeDynamicSecrets:
      'Whether to include dynamic project secrets in the response.',
  },
} as const;
...
`,
    ...
    isPackPermission:
      'Whether the server should pack(compact) the permission object.',
...
export const IDENTITY_ADDITIONAL_PRIVILEGE_V2 = {
  CREATE: {
    ...
    temporaryAccessStartTime:
      'The start time in ISO format when the temporary access should begin.',
  },
  UPDATE: {
...
export const NOTES = {
  CREATE_NOTE: {
    projectId: 'The ID of the project to create the note in.',
    name: 'The name of the note to be created. Must be slug-friendly.',
    content: 'The contents of the note.',
    encryptionAlgorithm:
      'The algorithm to use when performing cryptographic operations with the note.',
  },
  UPDATE_NOTE: {
    noteId: 'The ID of the note to be updated.',
    name: 'The updated name of this note. Must be slug-friendly.',
    content: 'The updated content of this note.',
    isDisabled: 'The flag to enable or disable this note.',
  },
  DELETE_NOTE: {
    noteId: 'The ID of the note to be deleted.',
  },
  LIST_NOTES: {
    projectId: 'The ID of the project to list notes from.',
    offset:
      'The offset to start from. If you enter 10, it will start from the 10th note.',
    limit: 'The number of notes to return.',
    orderBy: 'The column to order notes by.',
    orderDirection: 'The direction to order notes in.',
    search: 'The text string to filter note names by.',
  },
};
