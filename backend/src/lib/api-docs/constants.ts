...
export const OidcSSo = {
  GET_CONFIG: {
    orgSlug: "The slug of the organization to get the OIDC config for."
  },
  UPDATE_CONFIG: {
    orgSlug: "The slug of the organization to update the OIDC config for.",
    allowedEmailDomains:
    ...
    isActive: "Whether the OIDC configuration is active.",
    manageGroupMemberships:
      "Whether to manage group memberships for the OIDC configuration. If enabled, users will automatically be assigned groups when they sign in or are added to a group in the OIDC provider.",
    jwtSignatureAlgorithm: "The algorithm to use for JWT signature verification."
  },
  CREATE_CONFIG: {
    orgSlug: "The slug of the organization to create the OIDC config for.",
    allowedEmailDomains:
      "A list of allowed email domains that users can use to authenticate with. This field is comma separated.",
    discoveryURL: "The URL of the OIDC discovery endpoint.",
    configurationType: "The configuration type to use for the OIDC configuration.",
...
export const SamlSso = {
  ...
  UPDATE_CONFIG: {
    ...
    isActive: "Whether the SAML configuration is active.",
    entryPoint:
...
export const LdapSso = {
  ...
  CREATE_CONFIG: {
    ...
    isActive: "Whether the LDAP configuration is active.",
    ...
    searchFilter:
      "Template used to construct the LDAP user search filter such as `(uid={{username}})` uses literal `{{username}}` to have the given username used in the search. The default is `(uid={{username}})` which is compatible with several common directory schemas.",
    groupSearchBase: "LDAP search base to use for group membership search such as `ou=Groups,dc=acme,dc=com`",
    groupSearchFilter:
      " Template used when constructing the group membership query such as `(&(objectClass=posixGroup)(memberUid={{.Username}}))`. The template can access the following context variables: `[UserDN, UserName]`. The default is `(|(memberUid={{.Username}})(member={{.UserDN}})(uniqueMember={{.UserDN}}))` which is compatible with several common directory schemas.",
