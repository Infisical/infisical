...
export const ENVIRONMENTS = {
  ...
  DELETE: {
    ...
    hardDelete:
      "When true, permanently removes the environment. When false or omitted, the environment is soft-deleted (preserved with an expireAfter timestamp) and hidden from subsequent reads."
  },
  RESTORE: {
